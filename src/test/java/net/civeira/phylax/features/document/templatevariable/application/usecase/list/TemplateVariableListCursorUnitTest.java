...
class TemplateVariableListCursorUnitTest {
  ...
  void test_template_variable_list_cursor_builder() {
    TemplateVariableListCursor cursor = TemplateVariableListCursor.builder().build();
