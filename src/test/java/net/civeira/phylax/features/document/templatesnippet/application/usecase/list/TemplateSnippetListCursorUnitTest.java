...
class TemplateSnippetListCursorUnitTest {
  ...
  void test_template_snippet_list_cursor_builder() {
    TemplateSnippetListCursor cursor = TemplateSnippetListCursor.builder().build();
