...
class SnippetVersionListCursorUnitTest {
  ...
  void test_snippet_version_list_cursor_builder() {
    SnippetVersionListCursor cursor = SnippetVersionListCursor.builder().build();
