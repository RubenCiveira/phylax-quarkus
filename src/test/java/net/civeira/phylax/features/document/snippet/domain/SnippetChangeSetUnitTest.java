...
class SnippetChangeSetUnitTest {
  ...
  void test_snippet_change_set_builder() {
    SnippetChangeSet one = new SnippetChangeSet().uid("one").code("one")
        .tenant(TenantReference.of("one")).enabled(true).version(1).newUid();
    one.uid("two");
