...
class TemplateVisibilityFilterUnitTest {
  ...
  void test_template_visibility_filter_builder() {
    TemplateVisibilityFilter cursor = TemplateVisibilityFilter.builder().build();
