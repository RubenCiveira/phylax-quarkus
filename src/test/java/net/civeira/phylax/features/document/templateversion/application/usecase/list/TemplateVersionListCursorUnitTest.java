...
class TemplateVersionListCursorUnitTest {
  ...
  void test_template_version_list_cursor_builder() {
    TemplateVersionListCursor cursor = TemplateVersionListCursor.builder().build();
