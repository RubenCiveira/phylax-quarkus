...
class PlatformIdentityChangeSetUnitTest {
  ...
  void test_platform_identity_change_set_builder() {
    PlatformIdentityChangeSet one = new PlatformIdentityChangeSet().uid("one")
