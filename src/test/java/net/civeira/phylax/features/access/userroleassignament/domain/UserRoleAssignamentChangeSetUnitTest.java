...
class UserRoleAssignamentChangeSetUnitTest {
  ...
  void test_user_role_assignament_change_set_builder() {
    UserRoleAssignamentChangeSet one = new UserRoleAssignamentChangeSet().uid("one")
