...
class UserRoleAssignamentListCursorUnitTest {
  ...
  void test_user_role_assignament_list_cursor_builder() {
    UserRoleAssignamentListCursor cursor = UserRoleAssignamentListCursor.builder().build();
