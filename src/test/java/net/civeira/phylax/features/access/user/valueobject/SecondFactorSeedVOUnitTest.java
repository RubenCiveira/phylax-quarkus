...
class SecondFactorSeedVOUnitTest {
  ...
  void test_second_factor_seed_v_o_builder() {
    Assertions.assertFalse(SecondFactorSeedVO.nullValue().getCypheredValue(null).isPresent(),
        "A empty vo should have a null value");
    Assertions.assertFalse(SecondFactorSeedVO.tryFrom(null).getCypheredValue(null).isPresent(),
    ...
    Assertions.assertEquals("one",
        SecondFactorSeedVO.fromCyphered("one").getCypheredValue(null).orElse(null));
    Assertions.assertEquals("one",
        SecondFactorSeedVO.fromPlain("one").getPlainValue(null).orElse(null));
    Assertions.assertEquals("plain",
        SecondFactorSeedVO.fromCyphered("one").getPlainValue(cypher).orElse(null));
    Assertions.assertEquals("cyphered",
        SecondFactorSeedVO.fromPlain("one").getCypheredValue(cypher).orElse(null));
    Assertions.assertThrows(IllegalStateException.class,
        () -> SecondFactorSeedVO.fromCyphered("two").getPlainValue(cypher).orElse(null));
