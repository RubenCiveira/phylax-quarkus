...
class TempSecondFactorSeedExpirationVOUnitTest {
  ...
  void test_temp_second_factor_seed_expiration_v_o_builder() {
    Assertions.assertFalse(TempSecondFactorSeedExpirationVO.nullValue().getValue().isPresent(),
        "A empty vo should have a null value");
    Assertions.assertFalse(TempSecondFactorSeedExpirationVO.tryFrom(null).getValue().isPresent(),
