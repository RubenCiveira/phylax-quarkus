...
class RelyingPartyVOUnitTest {
  ...
  void test_relying_party_v_o_builder() {
    ...
    Assertions.assertEquals("10", RelyingPartyVO.fromReference("10").getRelyingPartyUid(),
        "The builder must store the reference value");
    Assertions.assertEquals("11", RelyingPartyVO.tryFromReference("11").getRelyingPartyUid(),
        "The builder must store the reference value");
    Assertions.assertEquals("12", RelyingPartyVO.tryFromReference("12", fails).getRelyingPartyUid(),
        "The builder must store the reference value");
    ...
    Assertions.assertEquals(RelyingPartyReference.of("one"),
        RelyingPartyVO.from(RelyingPartyReference.of("one")).getRelyingParty());
