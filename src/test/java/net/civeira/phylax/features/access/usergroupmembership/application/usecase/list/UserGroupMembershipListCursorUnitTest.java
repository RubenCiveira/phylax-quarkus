...
class UserGroupMembershipListCursorUnitTest {
  ...
  void test_user_group_membership_list_cursor_builder() {
    UserGroupMembershipListCursor cursor = UserGroupMembershipListCursor.builder().build();
