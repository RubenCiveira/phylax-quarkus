...
class PlatformIdentityListCursorUnitTest {
  ...
  void test_platform_identity_list_cursor_builder() {
    PlatformIdentityListCursor cursor = PlatformIdentityListCursor.builder().build();
