...
class ScopeAssignationVisibilityFilterUnitTest {
  ...
  void test_scope_assignation_visibility_filter_builder() {
    ScopeAssignationVisibilityFilter cursor = ScopeAssignationVisibilityFilter.builder().build();
