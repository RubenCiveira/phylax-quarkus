...
class TempSecondFactorSeedVOUnitTest {
  ...
  void test_temp_second_factor_seed_v_o_builder() {
    Assertions.assertFalse(TempSecondFactorSeedVO.nullValue().getCypheredValue(null).isPresent(),
        "A empty vo should have a null value");
    Assertions.assertFalse(TempSecondFactorSeedVO.tryFrom(null).getCypheredValue(null).isPresent(),
    ...
    Assertions.assertEquals("one",
        TempSecondFactorSeedVO.fromCyphered("one").getCypheredValue(null).orElse(null));
    Assertions.assertEquals("one",
        TempSecondFactorSeedVO.fromPlain("one").getPlainValue(null).orElse(null));
    Assertions.assertEquals("plain",
        TempSecondFactorSeedVO.fromCyphered("one").getPlainValue(cypher).orElse(null));
    Assertions.assertEquals("cyphered",
        TempSecondFactorSeedVO.fromPlain("one").getCypheredValue(cypher).orElse(null));
    Assertions.assertThrows(IllegalStateException.class,
        () -> TempSecondFactorSeedVO.fromCyphered("two").getPlainValue(cypher).orElse(null));
