...
class PasswordVOUnitTest {
  ...
  void test_password_v_o_builder() {
    ...
    Assertions.assertEquals("one", PasswordVO.fromCyphered("one").getCypheredPassword(null));
    Assertions.assertEquals("one", PasswordVO.fromPlain("one").getPlainPassword(null));
    Assertions.assertEquals("plain", PasswordVO.fromCyphered("one").getPlainPassword(cypher));
    Assertions.assertEquals("cyphered", PasswordVO.fromPlain("one").getCypheredPassword(cypher));
    Assertions.assertThrows(IllegalStateException.class,
        () -> PasswordVO.fromCyphered("two").getPlainPassword(cypher));
