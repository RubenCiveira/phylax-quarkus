...
class SecurityDomainDisableFilterUnitTest {
  ...
  void test_security_domain_disable_filter_builder() {
    SecurityDomainDisableFilter cursor = SecurityDomainDisableFilter.builder().build();
