...
class ScopeAssignationListCursorUnitTest {
  ...
  void test_scope_assignation_list_cursor_builder() {
    ScopeAssignationListCursor cursor = ScopeAssignationListCursor.builder().build();
