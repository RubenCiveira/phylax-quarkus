...
class UserPersonalApiKeyListCursorUnitTest {
  ...
  void test_user_personal_api_key_list_cursor_builder() {
    UserPersonalApiKeyListCursor cursor = UserPersonalApiKeyListCursor.builder().build();
