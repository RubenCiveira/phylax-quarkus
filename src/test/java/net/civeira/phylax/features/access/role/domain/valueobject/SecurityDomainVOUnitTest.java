...
class SecurityDomainVOUnitTest {
   ...
   */
  @Test
  @DisplayName("Test value object contruction for property security domain of role domain ")
  void test_security_domain_v_o_builder() {
    ConstraintFailList fails = new ConstraintFailList();
    Assertions.assertEquals("10", SecurityDomainVO.fromReference("10").getReferenceValue(),
        "The builder must store the reference value");
    Assertions.assertEquals("11", SecurityDomainVO.tryFromReference("11").getReferenceValue(),
        "The builder must store the reference value");
    Assertions.assertEquals("12",
        SecurityDomainVO.tryFromReference("12", fails).getReferenceValue(),
        "The builder must store the reference value");
    ...
    Assertions.assertEquals(SecurityDomainReference.of("one"),
        SecurityDomainVO.from(SecurityDomainReference.of("one")).getValue());
