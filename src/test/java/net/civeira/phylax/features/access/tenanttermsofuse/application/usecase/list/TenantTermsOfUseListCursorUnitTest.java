...
class TenantTermsOfUseListCursorUnitTest {
  ...
  void test_tenant_terms_of_use_list_cursor_builder() {
    TenantTermsOfUseListCursor cursor = TenantTermsOfUseListCursor.builder().build();
