...
class LoginProviderDisableFilterUnitTest {
  ...
  void test_login_provider_disable_filter_builder() {
    LoginProviderDisableFilter cursor = LoginProviderDisableFilter.builder().build();
