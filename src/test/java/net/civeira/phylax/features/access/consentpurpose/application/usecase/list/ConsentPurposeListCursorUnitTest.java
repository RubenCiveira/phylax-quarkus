...
class ConsentPurposeListCursorUnitTest {
  ...
  void test_consent_purpose_list_cursor_builder() {
    ConsentPurposeListCursor cursor = ConsentPurposeListCursor.builder().build();
