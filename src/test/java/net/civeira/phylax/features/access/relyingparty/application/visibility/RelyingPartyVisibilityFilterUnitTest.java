...
class RelyingPartyVisibilityFilterUnitTest {
  ...
  void test_relying_party_visibility_filter_builder() {
    RelyingPartyVisibilityFilter cursor = RelyingPartyVisibilityFilter.builder().build();
