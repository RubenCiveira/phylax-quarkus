...
class SecurityDomainEnableFilterUnitTest {
  ...
  void test_security_domain_enable_filter_builder() {
    SecurityDomainEnableFilter cursor = SecurityDomainEnableFilter.builder().build();
