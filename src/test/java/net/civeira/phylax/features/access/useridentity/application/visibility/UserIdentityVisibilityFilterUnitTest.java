...
class UserIdentityVisibilityFilterUnitTest {
  ...
  void test_user_identity_visibility_filter_builder() {
    UserIdentityVisibilityFilter cursor = UserIdentityVisibilityFilter.builder().build();
