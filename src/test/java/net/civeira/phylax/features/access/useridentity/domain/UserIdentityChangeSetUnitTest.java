...
class UserIdentityChangeSetUnitTest {
  ...
  void test_user_identity_change_set_builder() {
    UserIdentityChangeSet one = UserIdentityChangeSet.builder().uid("one")
    ...
    Assertions.assertEquals(TrustedClientReference.of("one"),
        one.getTrustedClient().get().getTrustedClient().get(),
        "Value must equals to the intial value");
    one.setTrustedClient(TrustedClientReference.of("two"));
    Assertions.assertEquals(TrustedClientReference.of("two"),
        one.getTrustedClient().get().getTrustedClient().get(),
        "Value must equals to the assigned value");
    ...
    Assertions.assertEquals(
        ...
        one.getRoles().get().getRoles(), "Value must equals to the intial value");
    one.setRoles(
        List.of(Roles.builder().uid("two").role(RoleReference.of("two")).version(2).build()));
    Assertions.assertEquals(
        List.of(Roles.builder().uid("two").role(RoleReference.of("two")).version(2).build()),
        one.getRoles().get().getRoles(), "Value must equals to the assigned value");
    one.unset("roles");
