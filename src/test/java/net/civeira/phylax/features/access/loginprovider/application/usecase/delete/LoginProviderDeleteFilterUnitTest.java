...
class LoginProviderDeleteFilterUnitTest {
  ...
  void test_login_provider_delete_filter_builder() {
    LoginProviderDeleteFilter cursor = LoginProviderDeleteFilter.builder().build();
