...
class ScopeAssignationDeleteFilterUnitTest {
  ...
  void test_scope_assignation_delete_filter_builder() {
    ScopeAssignationDeleteFilter cursor = ScopeAssignationDeleteFilter.builder().build();
