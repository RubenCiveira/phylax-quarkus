...
class UserIdentityDeleteFilterUnitTest {
  ...
  void test_user_identity_delete_filter_builder() {
    UserIdentityDeleteFilter cursor = UserIdentityDeleteFilter.builder().build();
