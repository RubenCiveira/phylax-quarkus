...
class SecondFactorSeedVOUnitTest {
  ...
  void test_second_factor_seed_v_o_builder() {
    Assertions.assertFalse(
        SecondFactorSeedVO.nullValue().getSecondFactorSeedCyphered(null).isPresent(),
        "A empty vo should have a null value");
    Assertions.assertFalse(
        SecondFactorSeedVO.tryFrom(null).getSecondFactorSeedCyphered(null).isPresent(),
    ...
    Assertions.assertEquals("one",
        SecondFactorSeedVO.fromCyphered("one").getSecondFactorSeedCyphered(null).orElse(null));
    Assertions.assertEquals("one",
        SecondFactorSeedVO.fromPlain("one").getSecondFactorSeedPlain(null).orElse(null));
    Assertions.assertEquals("plain",
        SecondFactorSeedVO.fromCyphered("one").getSecondFactorSeedPlain(cypher).orElse(null));
    Assertions.assertEquals("cyphered",
        SecondFactorSeedVO.fromPlain("one").getSecondFactorSeedCyphered(cypher).orElse(null));
    Assertions.assertThrows(IllegalStateException.class,
        () -> SecondFactorSeedVO.fromCyphered("two").getSecondFactorSeedPlain(cypher).orElse(null));
    Assertions.assertThrows(ConstraintException.class,
