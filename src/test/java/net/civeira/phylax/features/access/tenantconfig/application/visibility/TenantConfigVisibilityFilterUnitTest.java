...
class TenantConfigVisibilityFilterUnitTest {
  ...
  void test_tenant_config_visibility_filter_builder() {
    TenantConfigVisibilityFilter cursor = TenantConfigVisibilityFilter.builder().build();
