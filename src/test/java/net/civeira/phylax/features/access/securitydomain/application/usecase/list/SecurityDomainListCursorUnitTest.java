...
class SecurityDomainListCursorUnitTest {
  ...
  void test_security_domain_list_cursor_builder() {
    SecurityDomainListCursor cursor = SecurityDomainListCursor.builder().build();
