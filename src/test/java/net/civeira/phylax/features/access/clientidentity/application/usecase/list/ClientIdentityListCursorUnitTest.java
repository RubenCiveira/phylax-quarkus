...
class ClientIdentityListCursorUnitTest {
  ...
  void test_client_identity_list_cursor_builder() {
    ClientIdentityListCursor cursor = ClientIdentityListCursor.builder().build();
