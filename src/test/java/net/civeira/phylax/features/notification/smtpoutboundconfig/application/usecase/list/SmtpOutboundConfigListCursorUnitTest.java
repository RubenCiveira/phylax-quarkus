...
class SmtpOutboundConfigListCursorUnitTest {
  ...
  void test_smtp_outbound_config_list_cursor_builder() {
    SmtpOutboundConfigListCursor cursor = SmtpOutboundConfigListCursor.builder().build();
