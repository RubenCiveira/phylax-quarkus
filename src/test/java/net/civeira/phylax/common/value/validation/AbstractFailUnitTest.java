...
class AbstractFailUnitTest {
    ...
    void constructorShouldInitializeWithFieldAndValue() {
        ...
        assertEquals(value, fail.getWrongValues().get(0).getWrongValue(), "El valor erróneo debe coincidir");
    }
    ...
    void shouldLocalizeWithCorrectMessages() {
        setupMockMessages("ERR003", "email", "Invalid email format", "Localized Error Code", "Localized description");
    ...
    private void setupMockMessages(String code, String field, String fieldError, String localizedCode, String description) {
