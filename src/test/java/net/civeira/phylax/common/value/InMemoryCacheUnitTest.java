...
class InMemoryCacheUnitTest {
  ...
  /**
   * Returns a TTL {@link Duration} long enough for cache entries to remain valid throughout the
   * test. A one-minute window provides a comfortable margin against timing jitter during execution.
   */
  ...
  class TtlExpiration {
    ...
    @Test
    @DisplayName("Should not expire a freshly created entry with a long TTL")
    void shouldNotExpireEntryWithLongTtl() {
      ...
      assertEquals("original", result,
          "A freshly created entry with a long TTL should not be considered expired");
    }
  }
