...
class ConsentFlowTest extends OidcIntegrationTestBase {
  ...
  void consentRequired_showsConsentForm() {
    ...
    touConsentGateway
        .whenPending(() -> List.of(new TermsOfUseAcceptance("terms-1", "Texto de los terminos")));
  ...
  void consent_notAccepted_staysOnForm() {
    ...
    Response submit =
        client.submitConsent(OidcTestFixtures.TENANT, "off", "default-terms-id", preSession);
  ...
  void consent_accepted_completesFlow() {
    ...
    Response submit =
        client.submitConsent(OidcTestFixtures.TENANT, "on", "default-terms-id", preSession);
    ...
    Assertions.assertEquals(OidcTestFixtures.TENANT, touConsentGateway.getLastTenant());
    Assertions.assertEquals(OidcTestFixtures.USERNAME, touConsentGateway.getLastUsername());
    Assertions.assertEquals("default-terms-id", touConsentGateway.getLastConsentId());
  }
}
