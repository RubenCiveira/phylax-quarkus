...
CREATE TABLE _oauth_sessions (session VARCHAR(255) NOT NULL, jti VARCHAR(36) NULL, expiration timestamp NOT NULL, client_id VARCHAR(250) NOT NULL, grant_type VARCHAR(20) NOT NULL, auth_data TEXT NOT NULL, csid TEXT NOT NULL);
...
CREATE TABLE access_consent_purpose_audit (id CHAR(36) NOT NULL, operation VARCHAR(50) NOT NULL, usecase VARCHAR(100) NOT NULL, trace_id VARCHAR(100) NOT NULL, span_id VARCHAR(100) NOT NULL, entity_id VARCHAR(100) NOT NULL, old_values TEXT NULL, new_values TEXT NULL, performed_by VARCHAR(100) NOT NULL, tenant VARCHAR(100) NOT NULL, timestamp datetime NOT NULL, source_request TEXT NULL, remote_address VARCHAR(100) NULL, remote_application VARCHAR(100) NULL, remote_device VARCHAR(100) NULL, claims TEXT NULL, CONSTRAINT PK_ACCESS_CONSENT_PURPOSE_AUDIT PRIMARY KEY (id));
...
CREATE TABLE document_snippet_asset_audit (id CHAR(36) NOT NULL, operation VARCHAR(50) NOT NULL, usecase VARCHAR(100) NOT NULL, trace_id VARCHAR(100) NOT NULL, span_id VARCHAR(100) NOT NULL, entity_id VARCHAR(100) NOT NULL, old_values TEXT NULL, new_values TEXT NULL, performed_by VARCHAR(100) NOT NULL, tenant VARCHAR(100) NOT NULL, timestamp datetime NOT NULL, source_request TEXT NULL, remote_address VARCHAR(100) NULL, remote_application VARCHAR(100) NULL, remote_device VARCHAR(100) NULL, claims TEXT NULL, CONSTRAINT PK_DOCUMENT_SNIPPET_ASSET_AUDIT PRIMARY KEY (id));

-- changeset auto.generated:1825492372-45
CREATE TABLE document_snippet_audit (id CHAR(36) NOT NULL, operation VARCHAR(50) NOT NULL, usecase VARCHAR(100) NOT NULL, trace_id VARCHAR(100) NOT NULL, span_id VARCHAR(100) NOT NULL, entity_id VARCHAR(100) NOT NULL, old_values TEXT NULL, new_values TEXT NULL, performed_by VARCHAR(100) NOT NULL, tenant VARCHAR(100) NOT NULL, timestamp datetime NOT NULL, source_request TEXT NULL, remote_address VARCHAR(100) NULL, remote_application VARCHAR(100) NULL, remote_device VARCHAR(100) NULL, claims TEXT NULL, CONSTRAINT PK_DOCUMENT_SNIPPET_AUDIT PRIMARY KEY (id));
...
CREATE TABLE document_snippet_version_audit (id CHAR(36) NOT NULL, operation VARCHAR(50) NOT NULL, usecase VARCHAR(100) NOT NULL, trace_id VARCHAR(100) NOT NULL, span_id VARCHAR(100) NOT NULL, entity_id VARCHAR(100) NOT NULL, old_values TEXT NULL, new_values TEXT NULL, performed_by VARCHAR(100) NOT NULL, tenant VARCHAR(100) NOT NULL, timestamp datetime NOT NULL, source_request TEXT NULL, remote_address VARCHAR(100) NULL, remote_application VARCHAR(100) NULL, remote_device VARCHAR(100) NULL, claims TEXT NULL, CONSTRAINT PK_DOCUMENT_SNIPPET_VERSION_AUDIT PRIMARY KEY (id));
...
CREATE TABLE document_theme_asset_audit (id CHAR(36) NOT NULL, operation VARCHAR(50) NOT NULL, usecase VARCHAR(100) NOT NULL, trace_id VARCHAR(100) NOT NULL, span_id VARCHAR(100) NOT NULL, entity_id VARCHAR(100) NOT NULL, old_values TEXT NULL, new_values TEXT NULL, performed_by VARCHAR(100) NOT NULL, tenant VARCHAR(100) NOT NULL, timestamp datetime NOT NULL, source_request TEXT NULL, remote_address VARCHAR(100) NULL, remote_application VARCHAR(100) NULL, remote_device VARCHAR(100) NULL, claims TEXT NULL, CONSTRAINT PK_DOCUMENT_THEME_ASSET_AUDIT PRIMARY KEY (id));
...
CREATE TABLE document_theme_version_audit (id CHAR(36) NOT NULL, operation VARCHAR(50) NOT NULL, usecase VARCHAR(100) NOT NULL, trace_id VARCHAR(100) NOT NULL, span_id VARCHAR(100) NOT NULL, entity_id VARCHAR(100) NOT NULL, old_values TEXT NULL, new_values TEXT NULL, performed_by VARCHAR(100) NOT NULL, tenant VARCHAR(100) NOT NULL, timestamp datetime NOT NULL, source_request TEXT NULL, remote_address VARCHAR(100) NULL, remote_application VARCHAR(100) NULL, remote_device VARCHAR(100) NULL, claims TEXT NULL, CONSTRAINT PK_DOCUMENT_THEME_VERSION_AUDIT PRIMARY KEY (id));
...
CREATE INDEX idx_audit_entity_id ON access_consent_purpose_audit(entity_id);
...
CREATE INDEX idx_audit_entity_id ON document_snippet_asset_audit(entity_id);

-- changeset auto.generated:1825492372-155
CREATE INDEX idx_audit_entity_id ON document_snippet_audit(entity_id);

-- changeset auto.generated:1825492372-156
CREATE INDEX idx_audit_entity_id ON document_snippet_version_audit(entity_id);
...
CREATE INDEX idx_audit_entity_id ON document_theme_asset_audit(entity_id);
...
CREATE INDEX idx_audit_entity_id ON document_theme_version_audit(entity_id);
...
CREATE INDEX idx_audit_timestamp ON access_consent_purpose_audit(timestamp DESC);
...
CREATE INDEX idx_audit_timestamp ON document_snippet_asset_audit(timestamp DESC);

-- changeset auto.generated:1825492372-179
CREATE INDEX idx_audit_timestamp ON document_snippet_audit(timestamp DESC);

-- changeset auto.generated:1825492372-180
CREATE INDEX idx_audit_timestamp ON document_snippet_version_audit(timestamp DESC);
...
CREATE INDEX idx_audit_timestamp ON document_theme_asset_audit(timestamp DESC);
...
CREATE INDEX idx_audit_timestamp ON document_theme_version_audit(timestamp DESC);
...
CREATE INDEX idx_audit_user ON access_consent_purpose_audit(performed_by);
...
CREATE INDEX idx_audit_user ON document_snippet_asset_audit(performed_by);

-- changeset auto.generated:1825492372-203
CREATE INDEX idx_audit_user ON document_snippet_audit(performed_by);

-- changeset auto.generated:1825492372-204
CREATE INDEX idx_audit_user ON document_snippet_version_audit(performed_by);
...
CREATE INDEX idx_audit_user ON document_theme_asset_audit(performed_by);
...
CREATE INDEX idx_audit_user ON document_theme_version_audit(performed_by);
