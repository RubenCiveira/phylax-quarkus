...
import net.civeira.phylax.features.notification.message.application.usecase.delete.MessageCheckBatchDeleteStatus;
import net.civeira.phylax.features.notification.message.application.usecase.delete.MessageDeleteFilter;
...
public class MessageDeleteController {
   ...
   * @return
   */
  @ApiObserved("Api to delete on massive entity of message")
  public Response messageApiBatchDelete(final List<String> uids, final String search,
    ...
    MessageDeleteFilter.MessageDeleteFilterBuilder filterBuilder = MessageDeleteFilter.builder();
    filterBuilder =
    ...
    MessageDeleteFilter filter = filterBuilder.build();
   ...
   * @return
   */
  @ApiObserved("Api to check masive delete on entity of message")
  public Response messageApiBatchDeleteQuery(final String batchId) {
    BatchProgress task = delete.checkProgress(currentRequest.interaction(),
        MessageCheckBatchDeleteStatus.builder().taskId(batchId).build());
   ...
   */
  @Transactional
  @ApiObserved("Api to delete an entity of message")
  public Response messageApiDelete(final String uid) {
    Trace.setAttribute("ref", uid);
    delete.delete(currentRequest.interaction(), MessageReference.of(uid));
