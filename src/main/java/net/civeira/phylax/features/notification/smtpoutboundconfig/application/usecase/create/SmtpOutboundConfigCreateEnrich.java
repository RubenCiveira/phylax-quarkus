...
@Getter
@AllArgsConstructor
public class SmtpOutboundConfigCreateEnrich {
   ...
   */
  @NonNull
  private SmtpOutboundConfigCreateInput input;

  /**
   * @autogenerated CreateEnrichGenerator
   * @param mapper
   */
  public void map(UnaryOperator<SmtpOutboundConfigCreateInput> mapper) {
