...
public class TenantValueHolder<T> {
   ...
   * @return
   */
  public TenantVO readTenant(final Optional<SmtpOutboundConfig> original,
      final ConstraintFailList fails) {
    return value
        .orElse(original.map(SmtpOutboundConfig::getTenantValue).orElseGet(TenantVO::nullValue));
  }
