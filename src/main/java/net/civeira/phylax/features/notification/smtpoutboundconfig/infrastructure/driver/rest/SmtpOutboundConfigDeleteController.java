...
import net.civeira.phylax.features.notification.smtpoutboundconfig.application.usecase.delete.SmtpOutboundConfigCheckBatchDeleteStatus;
import net.civeira.phylax.features.notification.smtpoutboundconfig.application.usecase.delete.SmtpOutboundConfigDeleteFilter;
...
@ApplicationScoped
public class SmtpOutboundConfigDeleteController {
   ...
   * @return
   */
  @ApiObserved("Api to delete on massive entity of smtp outbound config")
  public Response smtpOutboundConfigApiBatchDelete(final List<String> uids, final String search,
    ...
    SmtpOutboundConfigDeleteFilter.SmtpOutboundConfigDeleteFilterBuilder filterBuilder =
        SmtpOutboundConfigDeleteFilter.builder();
    filterBuilder =
    ...
    SmtpOutboundConfigDeleteFilter filter = filterBuilder.build();
   ...
   * @return
   */
  @ApiObserved("Api to check masive delete on entity of smtp outbound config")
  public Response smtpOutboundConfigApiBatchDeleteQuery(final String batchId) {
    BatchProgress task = delete.checkProgress(currentRequest.interaction(),
        SmtpOutboundConfigCheckBatchDeleteStatus.builder().taskId(batchId).build());
   ...
   */
  @Transactional
  @ApiObserved("Api to delete an entity of smtp outbound config")
  public Response smtpOutboundConfigApiDelete(final String uid) {
    Trace.setAttribute("ref", uid);
    delete.delete(currentRequest.interaction(), SmtpOutboundConfigReference.of(uid));
