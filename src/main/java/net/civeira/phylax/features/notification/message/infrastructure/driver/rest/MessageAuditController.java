...
import net.civeira.phylax.generated.openapi.api.MessageAuditApi;
import net.civeira.phylax.generated.openapi.model.AuditEventDto;

@RequiredArgsConstructor
@ApplicationScoped
public class MessageAuditController implements MessageAuditApi {
  ...
  private AuditEventDto map(final AuditEvent event) {
    return new AuditEventDto().operation(event.getOperation()).usecase(event.getUsecase())
        .entityType("message").entityType(event.getEntityType()).entityId(event.getEntityId())
