...
import net.civeira.phylax.generated.openapi.api.SmtpOutboundConfigAuditApi;
import net.civeira.phylax.generated.openapi.model.AuditEventDto;

@RequiredArgsConstructor
@ApplicationScoped
public class SmtpOutboundConfigAuditController implements SmtpOutboundConfigAuditApi {
  ...
  private AuditEventDto map(final AuditEvent event) {
    return new AuditEventDto().operation(event.getOperation()).usecase(event.getUsecase())
        .entityType("smtpOutboundConfig").entityType(event.getEntityType())
