...
@Builder
@Data
public class SecurityScopeUpdateTransition {
   ...
   * @return
   */
  public SecurityScopeUpdateTransition map(final SecurityScopeChangeProposal newData) {
    SecurityScopeUpdateTransition transition =
        SecurityScopeUpdateTransition.builder().data(newData).build();
