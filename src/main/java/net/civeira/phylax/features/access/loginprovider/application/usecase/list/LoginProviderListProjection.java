...
@Getter
public class LoginProviderListProjection {
   ...
   * @return
   */
  public static LoginProviderListProjection from(final LoginProviderVisibleProjection visible) {
    LoginProviderListProjection instance = new LoginProviderListProjection();
   ...
   */
  public LoginProviderListProjection(final LoginProvider entity) {
