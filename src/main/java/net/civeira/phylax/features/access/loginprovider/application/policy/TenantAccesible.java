...
import net.civeira.phylax.features.access.loginprovider.application.visibility.LoginProviderVisibilityCheck;
...
public class TenantAccesible {
   ...
   * @param filter
   */
  public void filterVisibles(@Observes LoginProviderVisibilityCheck filter) {
