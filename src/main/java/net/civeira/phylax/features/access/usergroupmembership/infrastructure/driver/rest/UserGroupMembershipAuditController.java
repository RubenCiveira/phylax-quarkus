...
import net.civeira.phylax.generated.openapi.api.UserGroupMembershipAuditApi;
import net.civeira.phylax.generated.openapi.model.AuditEventDto;

@RequiredArgsConstructor
@ApplicationScoped
public class UserGroupMembershipAuditController implements UserGroupMembershipAuditApi {
  ...
  private AuditEventDto map(final AuditEvent event) {
    return new AuditEventDto().operation(event.getOperation()).usecase(event.getUsecase())
        .entityType("userGroupMembership").entityType(event.getEntityType())
