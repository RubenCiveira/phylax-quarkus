...
public class UserDeleteController {
  ...
  public Response userApiBatchDelete(final List<String> uids, final String search,
    ...
    Span span = tracer.spanBuilder("Api to delete masive entities of user")
  ...
  public Response userApiBatchDeleteQuery(final String batchId) {
    Span span = tracer.spanBuilder("Api to check the status of massive delete for entities of user")
        .setParent(Context.current().with(Span.current())).setSpanKind(SpanKind.SERVER).startSpan();
    try {
  ...
  public Response userApiDelete(final String uid) {
    Span span = tracer.spanBuilder("Api to delete an entity of user")
        .setParent(Context.current().with(Span.current())).setSpanKind(SpanKind.SERVER).startSpan();
    try {
