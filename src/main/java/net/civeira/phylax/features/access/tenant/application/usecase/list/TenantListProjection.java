...
public class TenantListProjection {
   ...
   * @return
   */
  public static TenantListProjection from(final TenantVisibleProjection visible) {
    TenantListProjection instance = new TenantListProjection();
   ...
   */
  public TenantListProjection(final Tenant entity) {
