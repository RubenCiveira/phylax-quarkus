...
public class TenantTermsOfUseAclController implements TenantTermsOfUseAclApi {
  ...
  public Response tenantTermsOfUseApiContextualAcl(final String uid) {
    Span span = tracer.spanBuilder("Api to check acl an entity of tenant terms of use")
  ...
  public Response tenantTermsOfUseApiGenericAcl() {
    Span span = tracer
        .spanBuilder("Api to check acl of a recorf on an entity of tenant terms of use")
        .setParent(Context.current().with(Span.current())).setSpanKind(SpanKind.SERVER).startSpan();
    try {
      Interaction interaction = currentRequest.interaction();
