...
import net.civeira.phylax.features.access.tenantconfig.application.service.visibility.TenantConfigFixedFieldsProposal;
...
public class NonEditableTenant {
   ...
   * @param fixed
   */
  public void fixedFields(@Observes TenantConfigFixedFieldsProposal fixed) {
