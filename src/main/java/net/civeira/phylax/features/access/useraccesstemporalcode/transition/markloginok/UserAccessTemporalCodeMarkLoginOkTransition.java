...
@Builder
@Data
public class UserAccessTemporalCodeMarkLoginOkTransition {
   ...
   * @return
   */
  public UserAccessTemporalCodeMarkLoginOkTransition map(
      final UserAccessTemporalCodeChangeProposal newData) {
    UserAccessTemporalCodeMarkLoginOkTransition transition =
        UserAccessTemporalCodeMarkLoginOkTransition.builder().data(newData).build();
