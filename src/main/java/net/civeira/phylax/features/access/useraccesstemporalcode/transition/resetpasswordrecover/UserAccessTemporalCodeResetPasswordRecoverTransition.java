...
@Builder
@Data
public class UserAccessTemporalCodeResetPasswordRecoverTransition {
   ...
   * @return
   */
  public UserAccessTemporalCodeResetPasswordRecoverTransition map(
      final UserAccessTemporalCodeChangeProposal newData) {
    UserAccessTemporalCodeResetPasswordRecoverTransition transition =
        UserAccessTemporalCodeResetPasswordRecoverTransition.builder().data(newData).build();
