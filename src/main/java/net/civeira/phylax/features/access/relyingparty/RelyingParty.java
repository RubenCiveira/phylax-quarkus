...
public class RelyingParty implements RelyingPartyRef {
  ...
  public static RelyingParty create(final RelyingPartyWriteAttributes attributes,
      final RelyingPartyCreatePipeline pipeline) {
    return pipeline.create(attributes, attr -> {
      RelyingParty instance = new RelyingParty(attr, Optional.empty());
   ...
   * @return
   */
  public RelyingParty delete(final RelyingPartyDeletePipeline pipeline) {
   ...
   * @return
   */
  public RelyingParty disable(final RelyingPartyDisablePipeline pipeline) {
   ...
   * @return
   */
  public RelyingParty enable(final RelyingPartyEnablePipeline pipeline) {
  ...
  public RelyingParty update(final RelyingPartyWriteAttributes attributes,
      final RelyingPartyUpdatePipeline pipeline) {
