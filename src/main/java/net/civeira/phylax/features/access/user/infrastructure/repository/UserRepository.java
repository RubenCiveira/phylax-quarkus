...
public class UserRepository {
   ...
   */
  private static final String ACCESS_USER_APPROVE = "access_user.approve";
   ...
   * @autogenerated RepositoryJdbcGenerator
   */
  private static final String ACCESS_USER_EMAIL_VERIFIED = "access_user.email_verified";
   ...
   * @autogenerated RepositoryJdbcGenerator
   */
  private static final String ACCESS_USER_WELLCOME_AT = "access_user.wellcome_at";
   ...
   * @autogenerated RepositoryJdbcGenerator
   */
  private static final String EMAIL_VERIFIED_SNAKE = "email_verified";
   ...
   * @autogenerated RepositoryJdbcGenerator
   */
  private static final String WELLCOME_AT = "wellcomeAt";

  /**
   * @autogenerated RepositoryJdbcGenerator
   */
  private static final String WELLCOME_AT_SNAKE = "wellcome_at";
  ...
  public User update(User entity) {
    try (SqlTemplate template = new SqlTemplate(datasource, tracer)) {
      SqlCommand sq = template.createSqlCommand(
          "update \"access_user\" set  \"tenant\" = :tenant, \"name\" = :name, \"password\" = :password, \"email\" = :email, \"wellcome_at\" = :wellcomeAt, \"email_verified\" = :emailVerified, \"enabled\" = :enabled, \"approve\" = :approve, \"temporal_password\" = :temporalPassword, \"use_second_factors\" = :useSecondFactors, \"second_factor_seed\" = :secondFactorSeed, \"blocked_until\" = :blockedUntil, \"provider\" = :provider, \"version\" = \"version\" + 1 where \"uid\" = :uid and \"version\" = :version");
      sq.with(UID, SqlParameterValue.of(entity.getUid()));
      ...
      sq.with(EMAIL_VERIFIED, SqlParameterValue.of(entity.isEmailVerified()));
      sq.with(ENABLED, SqlParameterValue.of(entity.isEnabled()));
      sq.with(APPROVE, entity.getApprove().map(UserApproveOptions::toString)
    ...
    return row -> {
      try {
        return Optional.of(User.builder().uidValue(UidVO.from(row.getString(UID)))
            ...
            .wellcomeAtValue(WellcomeAtVO.from(null == row.getTimestamp(WELLCOME_AT_SNAKE) ? null
                : OffsetDateTime.ofInstant(
                    Instant.ofEpochMilli(row.getTimestamp(WELLCOME_AT_SNAKE).getTime()),
                    ZoneId.systemDefault())))
            .emailVerifiedValue(EmailVerifiedVO.from(row.getBoolean(EMAIL_VERIFIED_SNAKE)))
            .enabledValue(EnabledVO.from(row.getBoolean(ENABLED)))
            .approveValue(ApproveVO.tryFrom(row.getString(APPROVE)))
  ...
  private <T> SqlSchematicQuery<T> filteredQuery(SqlTemplate template, UserFilter filter) {
    ...
    sq.selectFields(ACCESS_USER_UID, ACCESS_USER_TENANT, ACCESS_USER_NAME, ACCESS_USER_PASSWORD,
        ACCESS_USER_EMAIL, ACCESS_USER_WELLCOME_AT, ACCESS_USER_EMAIL_VERIFIED, ACCESS_USER_ENABLED,
        ACCESS_USER_APPROVE, ACCESS_USER_TEMPORAL_PASSWORD, ACCESS_USER_USE_SECOND_FACTORS,
        ACCESS_USER_SECOND_FACTOR_SEED, ACCESS_USER_BLOCKED_UNTIL, ACCESS_USER_PROVIDER,
        ACCESS_USER_VERSION);
    ...
    filter.getTenantAccesible().ifPresent(tenantAccesibleParam -> sq.where(ACCESS_USER_TENANT,
