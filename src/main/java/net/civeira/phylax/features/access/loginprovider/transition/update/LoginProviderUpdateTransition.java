...
@Builder
@Data
public class LoginProviderUpdateTransition {
   ...
   * @return
   */
  public LoginProviderUpdateTransition map(final LoginProviderChangeProposal newData) {
    LoginProviderUpdateTransition transition =
        LoginProviderUpdateTransition.builder().data(newData).build();
