...
@Getter
public class LoginProviderEnableProjection {
   ...
   * @return
   */
  public static LoginProviderEnableProjection from(final LoginProviderVisibleProjection visible) {
    LoginProviderEnableProjection instance = new LoginProviderEnableProjection();
   ...
   */
  public LoginProviderEnableProjection(final LoginProvider entity) {
