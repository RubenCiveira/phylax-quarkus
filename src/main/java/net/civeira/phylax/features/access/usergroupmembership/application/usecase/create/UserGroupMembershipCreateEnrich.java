...
@Getter
@AllArgsConstructor
public class UserGroupMembershipCreateEnrich {
   ...
   */
  @NonNull
  private UserGroupMembershipCreateInput input;

  /**
   * @autogenerated CreateEnrichGenerator
   * @param mapper
   */
  public void map(UnaryOperator<UserGroupMembershipCreateInput> mapper) {
