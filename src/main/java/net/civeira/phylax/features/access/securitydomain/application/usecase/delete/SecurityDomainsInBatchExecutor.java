...
class SecurityDomainsInBatchExecutor implements
    StepCounter<SecurityDomainDeleteAllInBatchCommand, SecurityDomainsInBatchExecutor.SecurityDomainPaginableBatch>,
    StepFinalizer<SecurityDomainDeleteAllInBatchCommand, SecurityDomainsInBatchExecutor.SecurityDomainPaginableBatch>,
    StepInitializer<SecurityDomainDeleteAllInBatchCommand, SecurityDomainsInBatchExecutor.SecurityDomainPaginableBatch>,
    ItemReader<SecurityDomain, SecurityDomainDeleteAllInBatchCommand, SecurityDomainsInBatchExecutor.SecurityDomainPaginableBatch>,
    ItemWriter<SecurityDomain, SecurityDomainDeleteAllInBatchCommand, SecurityDomainsInBatchExecutor.SecurityDomainPaginableBatch>,
    ItemProcessor<SecurityDomain, SecurityDomain, SecurityDomainDeleteAllInBatchCommand, SecurityDomainsInBatchExecutor.SecurityDomainPaginableBatch>,
    ItemDescriptor<SecurityDomain, SecurityDomainDeleteAllInBatchCommand, SecurityDomainsInBatchExecutor.SecurityDomainPaginableBatch> {
   ...
   * @autogenerated EntityGenerator
   */
  private final SecurityDomainDeleteUsecase usecase;
  ...
  public long approximatedItems(
      final StepContext<SecurityDomainDeleteAllInBatchCommand, SecurityDomainPaginableBatch> context) {
