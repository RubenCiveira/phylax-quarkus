...
@Getter
public class SecurityDomainUpdateProjection {
   ...
   * @return
   */
  public static SecurityDomainUpdateProjection from(final SecurityDomainVisibleProjection visible) {
    SecurityDomainUpdateProjection instance = new SecurityDomainUpdateProjection();
   ...
   */
  public SecurityDomainUpdateProjection(final SecurityDomain entity) {
