...
public class RelyingPartyValueHolder<T> {
   ...
   * @return
   */
  public RelyingPartyVO readRelyingParty(final Optional<PlatformIdentity> original,
      final ConstraintFailList fails) {
    return value.orElse(
        original.map(PlatformIdentity::getRelyingPartyValue).orElseGet(RelyingPartyVO::nullValue));
  }
