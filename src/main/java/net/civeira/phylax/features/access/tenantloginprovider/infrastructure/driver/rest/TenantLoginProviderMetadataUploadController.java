...
public class TenantLoginProviderMetadataUploadController {
   ...
   * @return
   */
  @ApiObserved("Api to retrieve upload metadata an entity of tenant login provider")
   ...
   * @return
   */
  @ApiObserved("Api to retrieve temporal uploaded metadata an entity of tenant login provider")
   ...
   * @return
   */
  @ApiObserved("Api to upload metadata an entity of tenant login provider")
