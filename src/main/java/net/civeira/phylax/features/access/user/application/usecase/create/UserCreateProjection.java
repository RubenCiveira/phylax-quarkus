...
@Getter
public class UserCreateProjection {
   ...
   * @return
   */
  public static UserCreateProjection from(final UserVisibleProjection visible) {
    UserCreateProjection instance = new UserCreateProjection();
   ...
   */
  public UserCreateProjection(final User entity) {
