...
@Builder
@Data
public class TenantUpdateTransition {

  /**
   * @autogenerated UpdateEntityRuleGenerator
   */
  private final TenantChangeProposal data;
   ...
   * @return
   */
  public TenantUpdateTransition map(final TenantChangeProposal newData) {
    TenantUpdateTransition transition = TenantUpdateTransition.builder().data(newData).build();
