...
import net.civeira.phylax.features.access.userroleassignament.application.usecase.list.UserRoleAssignamentListCursor;
import net.civeira.phylax.features.access.userroleassignament.application.usecase.list.UserRoleAssignamentListFilter;
import net.civeira.phylax.features.access.userroleassignament.application.usecase.list.UserRoleAssignamentListProjection;
...
import net.civeira.phylax.generated.openapi.model.UserRoleAssignamentApiDtoList;

@RequiredArgsConstructor
@ApplicationScoped
public class UserRoleAssignamentListController {
   ...
   * @return
   */
  @ApiObserved("Api to list an entity of user role assignament")
  public Response userRoleAssignamentApiList(final List<String> uids, final String search,
    ...
    UserRoleAssignamentListFilter.UserRoleAssignamentListFilterBuilder filterBuilder =
        UserRoleAssignamentListFilter.builder();
    UserRoleAssignamentListCursor.UserRoleAssignamentListCursorBuilder cursorBuilder =
        UserRoleAssignamentListCursor.builder();
    ...
    UserRoleAssignamentListFilter filter = filterBuilder.build();
    UserRoleAssignamentListCursor cursor = cursorBuilder.build();
    List<UserRoleAssignamentListProjection> listed =
    ...
    return currentRequest.cacheableResponse(listed, toListApiModel(listed, filter, cursor),
        "user-role-assignament-" + ("" + filter + cursor).hashCode());
  }
   ...
   * @return
   */
  private UserRoleAssignamentApiDto toApiModel(UserRoleAssignamentListProjection dto) {
   ...
   * @return
   */
  private UserRoleAssignamentApiDtoList toListApiModel(
      List<UserRoleAssignamentListProjection> userRoleAssignaments,
      UserRoleAssignamentListFilter filter, UserRoleAssignamentListCursor cursor) {
    Optional<UserRoleAssignamentListProjection> last =
        userRoleAssignaments.isEmpty() ? Optional.empty()
            : Optional.of(userRoleAssignaments.get(userRoleAssignaments.size() - 1));
    ...
    return new UserRoleAssignamentApiDtoList()
        .items(userRoleAssignaments.stream().map(this::toApiModel).toList())
