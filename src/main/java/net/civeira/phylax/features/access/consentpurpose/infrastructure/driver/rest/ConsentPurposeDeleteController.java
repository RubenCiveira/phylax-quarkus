...
import net.civeira.phylax.features.access.consentpurpose.application.usecase.delete.ConsentPurposeCheckBatchDeleteStatus;
import net.civeira.phylax.features.access.consentpurpose.application.usecase.delete.ConsentPurposeDeleteFilter;
...
@ApplicationScoped
public class ConsentPurposeDeleteController {
   ...
   * @return
   */
  @ApiObserved("Api to delete on massive entity of consent purpose")
  public Response consentPurposeApiBatchDelete(final List<String> uids, final String search,
    ...
    ConsentPurposeDeleteFilter.ConsentPurposeDeleteFilterBuilder filterBuilder =
        ConsentPurposeDeleteFilter.builder();
    filterBuilder =
    ...
    ConsentPurposeDeleteFilter filter = filterBuilder.build();
   ...
   * @return
   */
  @ApiObserved("Api to check masive delete on entity of consent purpose")
  public Response consentPurposeApiBatchDeleteQuery(final String batchId) {
    BatchProgress task = delete.checkProgress(currentRequest.interaction(),
        ConsentPurposeCheckBatchDeleteStatus.builder().taskId(batchId).build());
   ...
   */
  @Transactional
  @ApiObserved("Api to delete an entity of consent purpose")
  public Response consentPurposeApiDelete(final String uid) {
    Trace.setAttribute("ref", uid);
    delete.delete(currentRequest.interaction(), ConsentPurposeReference.of(uid));
