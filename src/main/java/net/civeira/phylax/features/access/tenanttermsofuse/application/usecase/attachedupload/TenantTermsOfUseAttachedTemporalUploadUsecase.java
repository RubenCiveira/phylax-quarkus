...
public class TenantTermsOfUseAttachedTemporalUploadUsecase {
   ...
   * @autogenerated ListUsecaseGenerator
   */
  private final Event<TenantTermsOfUseAllowAttachedTemporalUploadProposal> tempUploadAllowEmitter;
  ...
  public Allow allow(final Interaction query) {
    TenantTermsOfUseAllowAttachedTemporalUploadProposal base =
        TenantTermsOfUseAllowAttachedTemporalUploadProposal.builder()
