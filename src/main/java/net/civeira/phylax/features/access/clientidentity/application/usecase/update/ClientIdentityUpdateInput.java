...
@AllArgsConstructor
@Builder
public class ClientIdentityUpdateInput {

  /**
   * @autogenerated UpdateInputGenerator
   */
  public static class ClientIdentityUpdateInputBuilder {

    /**
     * @autogenerated UpdateInputGenerator
     * @return
     */
    public ClientIdentityUpdateInputBuilder newUid() {
     ...
     */
    public ClientIdentityUpdateInputBuilder relyingParty(final RelyingPartyRef relyingParty) {
     ...
     * @return Self instance to continue with a flow build
     */
    public ClientIdentityUpdateInputBuilder relyingParty(
     ...
     * @return Self instance to continue with a flow build
     */
    public ClientIdentityUpdateInputBuilder roles(final String roles) {
     ...
     * @return Self instance to continue with a flow build
     */
    public ClientIdentityUpdateInputBuilder roles(final Optional<RolesVO> roles) {
     ...
     * @return Self instance to continue with a flow build
     */
    public ClientIdentityUpdateInputBuilder trustedClient(final TrustedClientRef trustedClient) {
     ...
     * @return Self instance to continue with a flow build
     */
    public ClientIdentityUpdateInputBuilder trustedClient(
     ...
     * @return Self instance to continue with a flow build
     */
    public ClientIdentityUpdateInputBuilder uid(final String uid) {
     ...
     * @return Self instance to continue with a flow build
     */
    public ClientIdentityUpdateInputBuilder uid(final Optional<UidVO> uid) {
      this.uid$value = uid;
      this.uid$set = true;
      return this;
    }
     ...
     * @return Self instance to continue with a flow build
     */
    public ClientIdentityUpdateInputBuilder user(final UserRef user) {
     ...
     * @return Self instance to continue with a flow build
     */
    public ClientIdentityUpdateInputBuilder user(final Optional<UserVO> user) {
     ...
     * @return Self instance to continue with a flow build
     */
    public ClientIdentityUpdateInputBuilder version(final Integer version) {
     ...
     * @return Self instance to continue with a flow build
     */
    public ClientIdentityUpdateInputBuilder version(final Optional<VersionVO> version) {
   ...
   * @return
   */
  static ClientIdentityUpdateInput fromChangeSet(final ClientIdentityChangeSet input) {
    return ClientIdentityUpdateInput.builder().uid(input.getUidValue()).user(input.getUserValue())
   ...
   *
   * @autogenerated UpdateInputGenerator
   * @param value The proposal value for ClientIdentityUpdateInput
   * @return self instance to enable a flow code
   */
  public ClientIdentityUpdateInput setRelyingParty(final RelyingPartyRef value) {
   ...
   * @return self instance to enable a flow code
   */
  public ClientIdentityUpdateInput setRoles(final String value) {
   ...
   * @return self instance to enable a flow code
   */
  public ClientIdentityUpdateInput setTrustedClient(final TrustedClientRef value) {
   ...
   * @return self instance to enable a flow code
   */
  public ClientIdentityUpdateInput setUid(final String value) {
   ...
   * @return self instance to enable a flow code
   */
  public ClientIdentityUpdateInput setUser(final UserRef value) {
   ...
   * @return self instance to enable a flow code
   */
  public ClientIdentityUpdateInput setVersion(final Integer value) {
