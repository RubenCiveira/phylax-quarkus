...
@Getter
public class SecurityScopeDisableProjection {
   ...
   * @return
   */
  public static SecurityScopeDisableProjection from(final SecurityScopeVisibleProjection visible) {
    SecurityScopeDisableProjection instance = new SecurityScopeDisableProjection();
   ...
   */
  public SecurityScopeDisableProjection(final SecurityScope entity) {
