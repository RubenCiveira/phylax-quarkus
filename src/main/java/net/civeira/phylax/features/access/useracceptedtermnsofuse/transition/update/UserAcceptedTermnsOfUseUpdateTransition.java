...
@Builder
@Data
public class UserAcceptedTermnsOfUseUpdateTransition {
   ...
   * @autogenerated UpdateEntityRuleGenerator
   */
  private final UserAcceptedTermnsOfUse original;
   ...
   * @return
   */
  public UserAcceptedTermnsOfUseUpdateTransition map(
      final UserAcceptedTermnsOfUseChangeProposal newData) {
    UserAcceptedTermnsOfUseUpdateTransition transition =
        UserAcceptedTermnsOfUseUpdateTransition.builder().data(newData).build();
