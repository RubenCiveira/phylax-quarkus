...
@Builder
@Data
public class TenantCreateTransition {
   ...
   * @return
   */
  public TenantCreateTransition map(final TenantChangeProposal newData) {
    TenantCreateTransition transition = TenantCreateTransition.builder().data(newData).build();
