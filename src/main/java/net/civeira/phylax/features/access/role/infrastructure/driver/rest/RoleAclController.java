...
public class RoleAclController implements RoleAclApi {
    ...
    private void createAllows(final RoleGenericAcl response, final Interaction query) {
        ...
        response.getAllows().setCreate(new CommonAllow().allowed(detail.isAllowed()).reason(detail.getDescription()));
    }
    ...
    private void deleteAllows(final RoleGenericAcl response, final Interaction query) {
        ...
        response.getAllows().setDelete(new CommonAllow().allowed(detail.isAllowed()).reason(detail.getDescription()));
    }
    ...
    private void listAllows(final RoleGenericAcl response, final Interaction query) {
        ...
        response.getAllows().setList(new CommonAllow().allowed(detail.isAllowed()).reason(detail.getDescription()));
    }
    ...
    private void retrieveAllows(final RoleGenericAcl response, final Interaction query) {
        ...
        response.getAllows().setRetrieve(new CommonAllow().allowed(detail.isAllowed()).reason(detail.getDescription()));
    }
    ...
    private void updateAllows(final RoleGenericAcl response, final Interaction query) {
        ...
        response.getAllows().setUpdate(new CommonAllow().allowed(detail.isAllowed()).reason(detail.getDescription()));
    }
