...
public class RoleAclController implements RoleAclApi {
   ...
   */
  @Override
  @ApiObserved("Api to check acl for an entity of role")
   ...
   */
  @Override
  @ApiObserved("Api to check acl of a recorf on an entity of role")
   ...
   * @param context
   */
  private void createAllows(final RoleGenericAcl response, final OperationContext context) {
   ...
   * @param context
   */
  private void deleteAllows(final RoleGenericAcl response, final OperationContext context) {
   ...
   * @param context
   */
  private void deleteAllows(final RoleSpecificAcl response, final OperationContext context) {
    Permission detail = delete.allow(context);
    response.getAllows()
        .setDelete(new CommonAllow().allowed(detail.isAllowed()).reason(detail.getDescription()));
  }
   ...
   * @param context
   */
  private void fixedFields(final RoleAclFields response, final OperationContext context) {
   ...
   * @param context
   */
  private void hiddenFields(final RoleAclFields response, final OperationContext context) {
   ...
   * @param context
   */
  private void listAllows(final RoleGenericAcl response, final OperationContext context) {
   ...
   * @param context
   */
  private void retrieveAllows(final RoleGenericAcl response, final OperationContext context) {
   ...
   * @param context
   */
  private void retrieveAllows(final RoleSpecificAcl response, final OperationContext context) {
    Permission detail = retrieve.allow(context);
    response.getAllows()
        .setRetrieve(new CommonAllow().allowed(detail.isAllowed()).reason(detail.getDescription()));
  }
   ...
   * @param context
   */
  private void updateAllows(final RoleGenericAcl response, final OperationContext context) {
   ...
   * @param context
   */
  private void updateAllows(final RoleSpecificAcl response, final OperationContext context) {
    Permission detail = update.allow(context);
    response.getAllows()
        .setUpdate(new CommonAllow().allowed(detail.isAllowed()).reason(detail.getDescription()));
  }
