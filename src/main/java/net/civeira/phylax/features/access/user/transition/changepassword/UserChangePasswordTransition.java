...
@Builder
@Data
public class UserChangePasswordTransition {
   ...
   * @return
   */
  public UserChangePasswordTransition map(final UserChangeProposal newData) {
    UserChangePasswordTransition transition =
        UserChangePasswordTransition.builder().data(newData).build();
