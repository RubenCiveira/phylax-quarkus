...
public class TenantLoginProviderRepository {
   ...
   * @autogenerated RepositoryJdbcGenerator
   */
  private static final String ACCESS_TENANT_LOGIN_PROVIDER_OIDC_DISCOVERY_URL =
      "access_tenant_login_provider.oidc_discovery_url";
   ...
   * @autogenerated RepositoryJdbcGenerator
   */
  private static final String ACCESS_TENANT_LOGIN_PROVIDER_SAML_IDP_ENTITY_ID =
      "access_tenant_login_provider.saml_idp_entity_id";

  /**
   * @autogenerated RepositoryJdbcGenerator
   */
  private static final String ACCESS_TENANT_LOGIN_PROVIDER_SAML_IDP_IDP_CERT =
      "access_tenant_login_provider.saml_idp_idp_cert";

  /**
   * @autogenerated RepositoryJdbcGenerator
   */
  private static final String ACCESS_TENANT_LOGIN_PROVIDER_SAML_IDP_METADATA_URL =
      "access_tenant_login_provider.saml_idp_metadata_url";

  /**
   * @autogenerated RepositoryJdbcGenerator
   */
  private static final String ACCESS_TENANT_LOGIN_PROVIDER_SAML_IDP_SSO_URL =
      "access_tenant_login_provider.saml_idp_sso_url";
   ...
   * @autogenerated RepositoryJdbcGenerator
   */
  private static final String OIDC_DISCOVERY_URL_SNAKE = "oidc_discovery_url";
   ...
   * @autogenerated RepositoryJdbcGenerator
   */
  private static final String SAML_IDP_ENTITY_ID = "samlIdpEntityId";

  /**
   * @autogenerated RepositoryJdbcGenerator
   */
  private static final String SAML_IDP_ENTITY_ID_SNAKE = "saml_idp_entity_id";

  /**
   * @autogenerated RepositoryJdbcGenerator
   */
  private static final String SAML_IDP_IDP_CERT = "samlIdpIdpCert";

  /**
   * @autogenerated RepositoryJdbcGenerator
   */
  private static final String SAML_IDP_IDP_CERT_SNAKE = "saml_idp_idp_cert";

  /**
   * @autogenerated RepositoryJdbcGenerator
   */
  private static final String SAML_IDP_METADATA_URL = "samlIdpMetadataUrl";

  /**
   * @autogenerated RepositoryJdbcGenerator
   */
  private static final String SAML_IDP_METADATA_URL_SNAKE = "saml_idp_metadata_url";

  /**
   * @autogenerated RepositoryJdbcGenerator
   */
  private static final String SAML_IDP_SSO_URL = "samlIdpSsoUrl";

  /**
   * @autogenerated RepositoryJdbcGenerator
   */
  private static final String SAML_IDP_SSO_URL_SNAKE = "saml_idp_sso_url";
  ...
  public TenantLoginProvider update(TenantLoginProvider entity) {
    try (SqlTemplate template = new SqlTemplate(datasource, tracer)) {
      SqlCommand sq = template.createSqlCommand(
          "update \"access_tenant_login_provider\" set  \"tenant\" = :tenant, \"name\" = :name, \"source\" = :source, \"disabled\" = :disabled, \"direct_access\" = :directAccess, \"public_key\" = :publicKey, \"private_key\" = :privateKey, \"certificate\" = :certificate, \"metadata\" = :metadata, \"oidc_discovery_url\" = :oidcDiscoveryUrl, \"saml_idp_metadata_url\" = :samlIdpMetadataUrl, \"saml_idp_entity_id\" = :samlIdpEntityId, \"saml_idp_sso_url\" = :samlIdpSsoUrl, \"saml_idp_idp_cert\" = :samlIdpIdpCert, \"users_enabled_by_default\" = :usersEnabledByDefault, \"version\" = \"version\" + 1 where \"uid\" = :uid and \"version\" = :version");
      sq.with(UID, SqlParameterValue.of(entity.getUid()));
      ...
      sq.with(METADATA, entity.getMetadata().map(SqlParameterValue::of)
          .orElseGet(SqlParameterValue::ofNullString));
      sq.with(OIDC_DISCOVERY_URL, entity.getOidcDiscoveryUrl().map(SqlParameterValue::of)
          .orElseGet(SqlParameterValue::ofNullString));
      sq.with(SAML_IDP_METADATA_URL, entity.getSamlIdpMetadataUrl().map(SqlParameterValue::of)
          .orElseGet(SqlParameterValue::ofNullString));
      sq.with(SAML_IDP_ENTITY_ID, entity.getSamlIdpEntityId().map(SqlParameterValue::of)
          .orElseGet(SqlParameterValue::ofNullString));
      sq.with(SAML_IDP_SSO_URL, entity.getSamlIdpSsoUrl().map(SqlParameterValue::of)
          .orElseGet(SqlParameterValue::ofNullString));
      sq.with(SAML_IDP_IDP_CERT, entity.getSamlIdpIdpCert().map(SqlParameterValue::of)
          .orElseGet(SqlParameterValue::ofNullString));
    ...
    return row -> {
      try {
        return Optional.of(TenantLoginProvider.builder().uidValue(UidVO.from(row.getString(UID)))
            ...
            .oidcDiscoveryUrlValue(OidcDiscoveryUrlVO.from(row.getString(OIDC_DISCOVERY_URL_SNAKE)))
            .samlIdpMetadataUrlValue(
                SamlIdpMetadataUrlVO.from(row.getString(SAML_IDP_METADATA_URL_SNAKE)))
            .samlIdpEntityIdValue(SamlIdpEntityIdVO.from(row.getString(SAML_IDP_ENTITY_ID_SNAKE)))
            .samlIdpSsoUrlValue(SamlIdpSsoUrlVO.from(row.getString(SAML_IDP_SSO_URL_SNAKE)))
            .samlIdpIdpCertValue(SamlIdpIdpCertVO.from(row.getString(SAML_IDP_IDP_CERT_SNAKE)))
  ...
  private <T> SqlSchematicQuery<T> filteredQuery(SqlTemplate template,
    ...
    sq.selectFields(ACCESS_TENANT_LOGIN_PROVIDER_UID, ACCESS_TENANT_LOGIN_PROVIDER_TENANT,
        ...
        ACCESS_TENANT_LOGIN_PROVIDER_OIDC_DISCOVERY_URL,
        ACCESS_TENANT_LOGIN_PROVIDER_SAML_IDP_METADATA_URL,
        ACCESS_TENANT_LOGIN_PROVIDER_SAML_IDP_ENTITY_ID,
        ACCESS_TENANT_LOGIN_PROVIDER_SAML_IDP_SSO_URL,
        ACCESS_TENANT_LOGIN_PROVIDER_SAML_IDP_IDP_CERT,
    ...
    filter.getTenantAccesible()
        .ifPresent(tenantAccesibleParam -> sq.where(ACCESS_TENANT_LOGIN_PROVIDER_TENANT,
