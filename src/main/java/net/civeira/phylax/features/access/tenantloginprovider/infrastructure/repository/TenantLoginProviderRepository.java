...
public class TenantLoginProviderRepository {
  ...
  public TenantLoginProvider update(TenantLoginProvider entity) {
    try (SqlTemplate template = new SqlTemplate(datasource, tracer)) {
      SqlCommand sq = template.createSqlCommand(
          "update \"access_tenant_login_provider\" set  \"tenant\" = :tenant, \"name\" = :name, \"source\" = :source, \"disabled\" = :disabled, \"direct_access\" = :directAccess, \"public_key\" = :publicKey, \"private_key\" = :privateKey, \"certificate\" = :certificate, \"metadata\" = :metadata, \"saml_idp_metadata_url\" = :samlIdpMetadataUrl, \"saml_idp_entity_id\" = :samlIdpEntityId, \"saml_idp_sso_url\" = :samlIdpSsoUrl, \"saml_idp_idp_cert\" = :samlIdpIdpCert, \"users_enabled_by_default\" = :usersEnabledByDefault, \"version\" = \"version\" + 1 where \"uid\" = :uid and \"version\" = :version");
      sq.with(UID, SqlParameterValue.of(entity.getUid()));
  ...
  private TenantLoginProvider runCreate(TenantLoginProvider entity,
    ...
    try (SqlTemplate template = new SqlTemplate(datasource, tracer)) {
      SqlCommand sq = template.createSqlCommand(
          "insert into \"access_tenant_login_provider\" ( \"uid\", \"tenant\", \"name\", \"source\", \"disabled\", \"direct_access\", \"public_key\", \"private_key\", \"certificate\", \"metadata\", \"saml_idp_metadata_url\", \"saml_idp_entity_id\", \"saml_idp_sso_url\", \"saml_idp_idp_cert\", \"users_enabled_by_default\", \"version\") values ( :uid, :tenant, :name, :source, :disabled, :directAccess, :publicKey, :privateKey, :certificate, :metadata, :samlIdpMetadataUrl, :samlIdpEntityId, :samlIdpSsoUrl, :samlIdpIdpCert, :usersEnabledByDefault, :version)");
      sq.with(UID, SqlParameterValue.of(entity.getUid()));
      sq.with(TENANT, SqlParameterValue.of(entity.getTenantUid()));
      sq.with(NAME, SqlParameterValue.of(entity.getName()));
      sq.with(SOURCE, SqlParameterValue.of(entity.getSource().toString()));
