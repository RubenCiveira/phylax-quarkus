...
public class PublicAllowVO {
   ...
   * @return An empty instance
   */
  public static <T extends AbstractFailList> PublicAllowVO tryFromString(final String publicAllow,
      final T fails) {
    return BooleanLoad.toBoolean("publicAllow", publicAllow, fails)
   ...
   * @param map
   */
  public void publicAllowToMap(final Map<String, String> map) {
    if (null != value) {
      map.put("publicAllow", Boolean.TRUE.equals(value) ? "true" : "false");
    }
  }
