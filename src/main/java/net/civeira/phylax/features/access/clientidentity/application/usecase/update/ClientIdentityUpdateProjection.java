...
@Getter
public class ClientIdentityUpdateProjection {
   ...
   * @return
   */
  public static ClientIdentityUpdateProjection from(final ClientIdentityVisibleProjection visible) {
    ClientIdentityUpdateProjection instance = new ClientIdentityUpdateProjection();
   ...
   */
  public ClientIdentityUpdateProjection(final ClientIdentity entity) {
