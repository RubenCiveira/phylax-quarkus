...
@Getter
public class ApiKeyClientEnableProjection {
   ...
   * @return
   */
  public static ApiKeyClientEnableProjection from(final ApiKeyClientVisibleProjection visible) {
    ApiKeyClientEnableProjection instance = new ApiKeyClientEnableProjection();
   ...
   */
  public ApiKeyClientEnableProjection(final ApiKeyClient entity) {
