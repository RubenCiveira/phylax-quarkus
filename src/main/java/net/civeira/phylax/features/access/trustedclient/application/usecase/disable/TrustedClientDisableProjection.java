...
@Getter
public class TrustedClientDisableProjection {
   ...
   * @return
   */
  public static TrustedClientDisableProjection from(final TrustedClientVisibleProjection visible) {
    TrustedClientDisableProjection instance = new TrustedClientDisableProjection();
   ...
   */
  public TrustedClientDisableProjection(final TrustedClient entity) {
