...
public class TrustedClientListUsecase {
  ...
  public Allow allow(final Interaction query) {
    Span span = tracer.spanBuilder("Checking if is allowed to list entities of trusted client")
  ...
  public List<TrustedClientListProjection> list(final Interaction query,
    ...
    Span span = tracer.spanBuilder("Listing an entity of trusted client")
        .setParent(Context.current().with(Span.current())).setSpanKind(SpanKind.INTERNAL)
        .startSpan();
    try {
      ...
      if (!detail.isAllowed()) {
        span.addEvent(
            "The policies for trusted client dont allow to list: " + detail.getDescription());
