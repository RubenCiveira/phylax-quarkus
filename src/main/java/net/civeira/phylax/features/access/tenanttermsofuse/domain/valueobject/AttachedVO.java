...
/**
 * Value Object representing el attached de tenant terms of use of tenantTermsOfUse.
 * <p>
...
public class AttachedVO {
   ...
   * @param map
   */
  public void attachedToMap(final Map<String, String> map) {
    if (null != value) {
      map.put("attached", String.valueOf(value));
    }
  }
   ...
   * @return
   */
  public boolean isAttachedTemporal() {
    return temporal;
  }
