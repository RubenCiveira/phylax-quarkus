...
@AllArgsConstructor
@Builder
public class PlatformIdentityCreateInput {

  /**
   * @autogenerated CreateInputGenerator
   */
  public static class PlatformIdentityCreateInputBuilder {

    /**
     * @autogenerated CreateInputGenerator
     * @return
     */
    public PlatformIdentityCreateInputBuilder newUid() {
     ...
     */
    public PlatformIdentityCreateInputBuilder relyingParty(final RelyingPartyRef relyingParty) {
     ...
     * @return Self instance to continue with a flow build
     */
    public PlatformIdentityCreateInputBuilder relyingParty(
     ...
     * @return Self instance to continue with a flow build
     */
    public PlatformIdentityCreateInputBuilder roles(final List<Roles> roles) {
     ...
     * @return Self instance to continue with a flow build
     */
    public PlatformIdentityCreateInputBuilder roles(final Optional<RolesVO> roles) {
     ...
     * @return Self instance to continue with a flow build
     */
    public PlatformIdentityCreateInputBuilder trustedClient(final TrustedClientRef trustedClient) {
     ...
     * @return Self instance to continue with a flow build
     */
    public PlatformIdentityCreateInputBuilder trustedClient(
     ...
     * @return Self instance to continue with a flow build
     */
    public PlatformIdentityCreateInputBuilder uid(final String uid) {
     ...
     * @return Self instance to continue with a flow build
     */
    public PlatformIdentityCreateInputBuilder uid(final Optional<UidVO> uid) {
      this.uid$value = uid;
      this.uid$set = true;
      return this;
    }
     ...
     * @return Self instance to continue with a flow build
     */
    public PlatformIdentityCreateInputBuilder user(final UserRef user) {
     ...
     * @return Self instance to continue with a flow build
     */
    public PlatformIdentityCreateInputBuilder user(final Optional<UserVO> user) {
     ...
     * @return Self instance to continue with a flow build
     */
    public PlatformIdentityCreateInputBuilder version(final Integer version) {
     ...
     * @return Self instance to continue with a flow build
     */
    public PlatformIdentityCreateInputBuilder version(final Optional<VersionVO> version) {
   ...
   * @return
   */
  static PlatformIdentityCreateInput fromChangeSet(final PlatformIdentityChangeSet input) {
    return PlatformIdentityCreateInput.builder().uid(input.getUidValue()).user(input.getUserValue())
   ...
   *
   * @autogenerated CreateInputGenerator
   * @param value The proposal value for PlatformIdentityCreateInput
   * @return self instance to enable a flow code
   */
  public PlatformIdentityCreateInput setRelyingParty(final RelyingPartyRef value) {
   ...
   * @return self instance to enable a flow code
   */
  public PlatformIdentityCreateInput setRoles(final List<Roles> value) {
   ...
   * @return self instance to enable a flow code
   */
  public PlatformIdentityCreateInput setTrustedClient(final TrustedClientRef value) {
   ...
   * @return self instance to enable a flow code
   */
  public PlatformIdentityCreateInput setUid(final String value) {
   ...
   * @return self instance to enable a flow code
   */
  public PlatformIdentityCreateInput setUser(final UserRef value) {
   ...
   * @return self instance to enable a flow code
   */
  public PlatformIdentityCreateInput setVersion(final Integer value) {
