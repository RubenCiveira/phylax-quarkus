...
@Builder
@Data
public class RelyingPartyDisableTransition {
   ...
   * @return
   */
  public RelyingPartyDisableTransition map(final RelyingPartyChangeProposal newData) {
    RelyingPartyDisableTransition transition =
        RelyingPartyDisableTransition.builder().data(newData).build();
