...
import net.civeira.phylax.features.access.platformidentity.application.usecase.delete.PlatformIdentityCheckBatchDeleteStatus;
import net.civeira.phylax.features.access.platformidentity.application.usecase.delete.PlatformIdentityDeleteFilter;
...
@ApplicationScoped
public class PlatformIdentityDeleteController {
   ...
   * @return
   */
  @ApiObserved("Api to delete on massive entity of platform identity")
  public Response platformIdentityApiBatchDelete(final List<String> uids, final String search,
    ...
    PlatformIdentityDeleteFilter.PlatformIdentityDeleteFilterBuilder filterBuilder =
        PlatformIdentityDeleteFilter.builder();
    filterBuilder =
    ...
    PlatformIdentityDeleteFilter filter = filterBuilder.build();
   ...
   */
  @Transactional
  @ApiObserved("Api to delete an entity of platform identity")
  public Response platformIdentityApiDelete(final String uid) {
    Trace.setAttribute("ref", uid);
    delete.delete(currentRequest.interaction(), PlatformIdentityReference.of(uid));
