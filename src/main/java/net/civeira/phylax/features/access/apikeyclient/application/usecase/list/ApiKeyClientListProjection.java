...
@Getter
public class ApiKeyClientListProjection {
   ...
   * @return
   */
  public static ApiKeyClientListProjection from(final ApiKeyClientVisibleProjection visible) {
    ApiKeyClientListProjection instance = new ApiKeyClientListProjection();
   ...
   */
  public ApiKeyClientListProjection(final ApiKeyClient entity) {
