...
import net.civeira.phylax.features.access.tenanttermsofuse.application.service.visibility.TenantTermsOfUseFilterProposal;
...
public class TenantAccesible {
   ...
   * @param filter
   */
  public void filterVisibles(@Observes TenantTermsOfUseFilterProposal filter) {
