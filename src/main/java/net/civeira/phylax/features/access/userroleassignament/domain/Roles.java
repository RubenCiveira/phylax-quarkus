...
import net.civeira.phylax.features.access.userroleassignament.domain.valueobject.RoleVO;
...
public class Roles {
  ...
  /**
   * Campo con el número de version de user role assignament role para controlar bloqueos optimistas
   *
   * @autogenerated UnionGenerator
   */
  @Delegate
