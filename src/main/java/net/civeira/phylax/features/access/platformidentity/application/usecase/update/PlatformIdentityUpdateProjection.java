...
@Getter
public class PlatformIdentityUpdateProjection {
   ...
   * @return
   */
  public static PlatformIdentityUpdateProjection from(
      final PlatformIdentityVisibleProjection visible) {
    PlatformIdentityUpdateProjection instance = new PlatformIdentityUpdateProjection();
   ...
   */
  public PlatformIdentityUpdateProjection(final PlatformIdentity entity) {
