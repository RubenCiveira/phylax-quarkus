...
/**
 * Value Object representing el trusted client de user consented scopes of userConsentedScopes.
 * <p>
...
public class TrustedClientVO {
   ...
   * @param map
   */
  public void trustedClientToMap(final Map<String, String> map) {
    if (null != value) {
      String uid = value.getUid();
      if (null != uid) {
        map.put("trustedClient", String.valueOf(uid));
      }
    }
  }
}
