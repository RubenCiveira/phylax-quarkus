...
import net.civeira.phylax.features.access.userpersonalapikey.application.usecase.delete.UserPersonalApiKeyCheckBatchDeleteStatus;
import net.civeira.phylax.features.access.userpersonalapikey.application.usecase.delete.UserPersonalApiKeyDeleteFilter;
...
@ApplicationScoped
public class UserPersonalApiKeyDeleteController {
   ...
   * @return
   */
  @ApiObserved("Api to delete on massive entity of user personal api key")
  public Response userPersonalApiKeyApiBatchDelete(final List<String> uids, final String search,
    ...
    UserPersonalApiKeyDeleteFilter.UserPersonalApiKeyDeleteFilterBuilder filterBuilder =
        UserPersonalApiKeyDeleteFilter.builder();
    filterBuilder =
    ...
    UserPersonalApiKeyDeleteFilter filter = filterBuilder.build();
   ...
   * @return
   */
  @ApiObserved("Api to check masive delete on entity of user personal api key")
  public Response userPersonalApiKeyApiBatchDeleteQuery(final String batchId) {
    BatchProgress task = delete.checkProgress(currentRequest.interaction(),
        UserPersonalApiKeyCheckBatchDeleteStatus.builder().taskId(batchId).build());
   ...
   */
  @Transactional
  @ApiObserved("Api to delete an entity of user personal api key")
  public Response userPersonalApiKeyApiDelete(final String uid) {
    Trace.setAttribute("ref", uid);
    delete.delete(currentRequest.interaction(), UserPersonalApiKeyReference.of(uid));
