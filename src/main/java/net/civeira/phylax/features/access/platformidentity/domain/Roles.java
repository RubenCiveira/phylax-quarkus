...
import net.civeira.phylax.features.access.platformidentity.domain.valueobject.RoleVO;
...
public class Roles {
  ...
  /**
   * Campo con el número de version de platform identity role para controlar bloqueos optimistas
   *
   * @autogenerated UnionGenerator
   */
  @Delegate
