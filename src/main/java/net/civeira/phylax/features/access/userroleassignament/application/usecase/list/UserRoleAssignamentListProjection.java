...
@Getter
public class UserRoleAssignamentListProjection {
   ...
   * @return
   */
  public static UserRoleAssignamentListProjection from(
      final UserRoleAssignamentVisibleProjection visible) {
    UserRoleAssignamentListProjection instance = new UserRoleAssignamentListProjection();
   ...
   */
  public UserRoleAssignamentListProjection(final UserRoleAssignament entity) {
