...
@Builder
@Data
public class UserCreateTransition {
   ...
   * @return
   */
  public UserCreateTransition map(final UserChangeProposal newData) {
    UserCreateTransition transition = UserCreateTransition.builder().data(newData).build();
