...
@Builder
@Data
public class UserAccessTemporalCodeMarkLoginFailTransition {
   ...
   * @return
   */
  public UserAccessTemporalCodeMarkLoginFailTransition map(
      final UserAccessTemporalCodeChangeProposal newData) {
    UserAccessTemporalCodeMarkLoginFailTransition transition =
        UserAccessTemporalCodeMarkLoginFailTransition.builder().data(newData).build();
