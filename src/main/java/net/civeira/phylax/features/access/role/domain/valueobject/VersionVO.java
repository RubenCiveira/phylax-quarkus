...
/**
 * Value Object representing campo con el número de version de role para controlar bloqueos optimistas of role.
 * <p>
 *  This class ensures that the version is a {@code String} and encapsulates
...
public class VersionVO {
     ...
     * @return An empty instance
     */
    public static <T extends AbstractFailList> VersionVO tryFrom(final Object version, final T fails) {
        if (null == version) {
            return new VersionVO(null);
     ...
     * @return An empty instance
     */
    public static <T extends AbstractFailList> VersionVO tryFromString(final String version, final T fails) {
        return NumericLoad.toInt("version", version, fails).map(value -> tryFrom(value, fails)).orElse(null);
    }
     ...
     * @param map
     */
    public void versionToMap(final Map<String, String> map) {
        if (null != value) {
            map.put("version", String.valueOf(value));
        }
    }
}
