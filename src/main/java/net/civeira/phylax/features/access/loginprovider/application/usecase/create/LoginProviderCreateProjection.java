...
@Getter
public class LoginProviderCreateProjection {
   ...
   * @return
   */
  public static LoginProviderCreateProjection from(final LoginProviderVisibleProjection visible) {
    LoginProviderCreateProjection instance = new LoginProviderCreateProjection();
   ...
   */
  public LoginProviderCreateProjection(final LoginProvider entity) {
