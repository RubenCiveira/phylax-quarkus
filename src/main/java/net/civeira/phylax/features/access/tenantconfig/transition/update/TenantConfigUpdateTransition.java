...
@Builder
@Data
public class TenantConfigUpdateTransition {

  /**
   * @autogenerated UpdateEntityRuleGenerator
   */
  private final TenantConfigChangeProposal data;
   ...
   * @return
   */
  public TenantConfigUpdateTransition map(final TenantConfigChangeProposal newData) {
    TenantConfigUpdateTransition transition =
        TenantConfigUpdateTransition.builder().data(newData).build();
