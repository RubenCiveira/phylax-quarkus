...
@Builder
@Data
public class UserAccessTemporalCodeUpdateTransition {
   ...
   * @return
   */
  public UserAccessTemporalCodeUpdateTransition map(
      final UserAccessTemporalCodeChangeProposal newData) {
    UserAccessTemporalCodeUpdateTransition transition =
        UserAccessTemporalCodeUpdateTransition.builder().data(newData).build();
