...
@Builder
@Data
public class TenantConfigCreateTransition {
   ...
   * @return
   */
  public TenantConfigCreateTransition map(final TenantConfigChangeProposal newData) {
    TenantConfigCreateTransition transition =
        TenantConfigCreateTransition.builder().data(newData).build();
