package net.civeira.phylax.features.access.role.domain.valueholder;
...
public class RelyingPartyValueHolder<T> {
   ...
   * @return
   */
  public RelyingPartyVO readRelyingParty(final Optional<Role> original,
      final ConstraintFailList fails) {
    return value
        .orElse(original.map(Role::getRelyingPartyValue).orElseGet(RelyingPartyVO::nullValue));
  }
