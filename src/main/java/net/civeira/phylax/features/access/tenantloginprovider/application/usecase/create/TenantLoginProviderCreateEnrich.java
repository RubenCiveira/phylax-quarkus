...
public class TenantLoginProviderCreateEnrich {
   ...
   */
  @NonNull
  private TenantLoginProviderCreateInput input;

  /**
   * @autogenerated CreateEnrichGenerator
   * @param mapper
   */
  public void map(UnaryOperator<TenantLoginProviderCreateInput> mapper) {
