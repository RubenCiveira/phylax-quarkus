...
@Builder
@Data
public class RelyingPartyCreateTransition {
   ...
   * @return
   */
  public RelyingPartyCreateTransition map(final RelyingPartyChangeProposal newData) {
    RelyingPartyCreateTransition transition =
        RelyingPartyCreateTransition.builder().data(newData).build();
