...
@Getter
public class UserRoleAssignamentRetrieveProjection {
   ...
   * @return
   */
  public static UserRoleAssignamentRetrieveProjection from(
      final UserRoleAssignamentVisibleProjection visible) {
    UserRoleAssignamentRetrieveProjection instance = new UserRoleAssignamentRetrieveProjection();
   ...
   */
  public UserRoleAssignamentRetrieveProjection(final UserRoleAssignament entity) {
