...
@Getter
public class ScopeAssignationListProjection {
   ...
   * @return
   */
  public static ScopeAssignationListProjection from(
      final ScopeAssignationVisibleProjection visible) {
    ScopeAssignationListProjection instance = new ScopeAssignationListProjection();
   ...
   */
  public ScopeAssignationListProjection(final ScopeAssignation entity) {
