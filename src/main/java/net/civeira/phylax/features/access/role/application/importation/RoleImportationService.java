...
public class RoleImportationService {
     ...
     * @return
     */
    public RoleImportationResult load(final Map<String, String> row, final RoleImportationRelatedResolver resolver) {
        ...
        return fails.isEmpty() ? new RoleImportationResult(entity, exists) : new RoleImportationResult(fails);
    }
     ...
     * @return
     */
    public RoleChangeSet toChangeSet(final Map<String, String> row, final ConstraintFailList fails, final RoleImportationRelatedResolver resolver) {
     ...
     * @return
     */
    private RoleChangeSet readName(final RoleChangeSet change, final Map<String, String> row, final ConstraintFailList fails, final RoleImportationRelatedResolver resolver) {
        String name = row.get("name");
        if (name != null) {
     ...
     * @return
     */
    private RoleChangeSet readRelyingParty(final RoleChangeSet change, final Map<String, String> row, final ConstraintFailList fails, final RoleImportationRelatedResolver resolver) {
        String relyingParty = row.get("relyingParty");
        if (relyingParty != null) {
            Optional<RelyingParty> existing = relyingPartyReadRepository.find(RelyingPartyFilter.builder().code(relyingParty).build());
            if (existing.isPresent()) {
                ...
                RelyingParty entity = (null == resolver.getMissingRelyingPartyFactory()) ? RelyingParty.create(childChanges) : resolver.getMissingRelyingPartyFactory().apply(childChanges);
