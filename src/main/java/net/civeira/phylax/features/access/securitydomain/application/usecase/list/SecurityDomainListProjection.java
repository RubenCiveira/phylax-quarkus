...
@Getter
public class SecurityDomainListProjection {
   ...
   * @return
   */
  public static SecurityDomainListProjection from(final SecurityDomainVisibleProjection visible) {
    SecurityDomainListProjection instance = new SecurityDomainListProjection();
   ...
   */
  public SecurityDomainListProjection(final SecurityDomain entity) {
