...
@Getter
public class UserIdentityUpdateProjection {
   ...
   * @return
   */
  public static UserIdentityUpdateProjection from(final UserIdentityVisibleProjection visible) {
    UserIdentityUpdateProjection instance = new UserIdentityUpdateProjection();
   ...
   */
  public UserIdentityUpdateProjection(final UserIdentity entity) {
