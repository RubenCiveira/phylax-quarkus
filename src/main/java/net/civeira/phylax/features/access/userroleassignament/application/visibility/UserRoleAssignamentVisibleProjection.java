...
@AllArgsConstructor
@Builder
public class UserRoleAssignamentVisibleProjection {
   ...
   */
  public UserRoleAssignamentVisibleProjection(final UserRoleAssignament entity) {
  ...
  /**
   * Create a reference for user role assignament with his inner assigned value.
   *
   * @autogenerated VisibleProjectionGenerator
   ...
   *         will be thrown.
   */
  public UserRoleAssignamentReference asReference() throws NoSuchElementException {
    return uid.map(UidVO::getUid).map(UserRoleAssignamentReference::of).orElseThrow();
  }
   ...
   *
   * @autogenerated VisibleProjectionGenerator
   * @param value The proposal value for UserRoleAssignamentVisibleProjection
   * @return self instance to enable a flow code
   */
  public UserRoleAssignamentVisibleProjection setRelyingParty(final RelyingPartyRef value) {
   ...
   * @return self instance to enable a flow code
   */
  public UserRoleAssignamentVisibleProjection setRoles(final List<Roles> value) {
   ...
   * @return self instance to enable a flow code
   */
  public UserRoleAssignamentVisibleProjection setTrustedClient(final TrustedClientRef value) {
   ...
   * @return self instance to enable a flow code
   */
  public UserRoleAssignamentVisibleProjection setUid(final String value) {
   ...
   * @return self instance to enable a flow code
   */
  public UserRoleAssignamentVisibleProjection setUser(final UserRef value) {
   ...
   * @return self instance to enable a flow code
   */
  public UserRoleAssignamentVisibleProjection setVersion(final Integer value) {
   ...
   * @return self instance to enable a flow code.
   */
  public UserRoleAssignamentVisibleProjection unsetRelyingParty() {
   ...
   * @return self instance to enable a flow code.
   */
  public UserRoleAssignamentVisibleProjection unsetRoles() {
   ...
   * @return self instance to enable a flow code.
   */
  public UserRoleAssignamentVisibleProjection unsetTrustedClient() {
   ...
   * @return self instance to enable a flow code.
   */
  public UserRoleAssignamentVisibleProjection unsetUid() {
   ...
   * @return self instance to enable a flow code.
   */
  public UserRoleAssignamentVisibleProjection unsetUser() {
   ...
   * @return self instance to enable a flow code.
   */
  public UserRoleAssignamentVisibleProjection unsetVersion() {
