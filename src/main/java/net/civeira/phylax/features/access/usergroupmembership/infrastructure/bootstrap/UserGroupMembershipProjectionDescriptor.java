package net.civeira.phylax.features.access.usergroupmembership.infrastructure.bootstrap;
...
@ApplicationScoped
public class UserGroupMembershipProjectionDescriptor implements ProjectionDescriptor {

  /**
   * @autogenerated ProjectionDescriptorGeneratorGenerator
   */
  public static class UserGroupMembershipExecutionPlanner {
     ...
     * @autogenerated ProjectionDescriptorGeneratorGenerator
     */
    public UserGroupMembershipExecutionPlanner() {
      this.prefix = "";
    }
     ...
     * @param prefix
     */
    public UserGroupMembershipExecutionPlanner(final String prefix) {
      this.prefix = prefix + ".";
    }
     ...
     * @return
     */
    public UserGroupMembershipExecutionPlanner withGroups() {
      return withGroups(prefix + "groups");
    }
     ...
     * @return
     */
    public UserGroupMembershipExecutionPlanner withGroups(final String alias) {
      aggregation.add(
          ExecutionAggregation.builder().name("groups").alias(alias).selection(List.of()).build());
      return this;
    }
     ...
     * @return
     */
    public UserGroupMembershipExecutionPlanner withRelyingParty() {
     ...
     * @return
     */
    public UserGroupMembershipExecutionPlanner withRelyingParty(final String alias) {
     ...
     * @return
     */
    public UserGroupMembershipExecutionPlanner withTrustedClient() {
     ...
     * @return
     */
    public UserGroupMembershipExecutionPlanner withTrustedClient(final String alias) {
     ...
     * @return
     */
    public UserGroupMembershipExecutionPlanner withUid() {
     ...
     * @return
     */
    public UserGroupMembershipExecutionPlanner withUid(final String alias) {
      aggregation.add(
     ...
     * @return
     */
    public UserGroupMembershipExecutionPlanner withUser() {
     ...
     * @return
     */
    public UserGroupMembershipExecutionPlanner withUser(final String alias) {
     ...
     * @return
     */
    public UserGroupMembershipExecutionPlanner withVersion() {
     ...
     * @return
     */
    public UserGroupMembershipExecutionPlanner withVersion(final String alias) {
      aggregation.add(
  ...
  public List<ExecutionNode> baseNodes(final String baseServer) {
    ...
    return List.of(
        ExecutionNode.builder().server(baseServer).endpoint("/api/access/user-group-membership")
            .method("GET").list(true).params(Map.of()).relations(relations).build(),
        ExecutionNode.builder().server(baseServer)
            .endpoint("/api/access/user-group-membership/{uid}").method("GET").list(false)
