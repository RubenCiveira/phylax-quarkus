...
public class UserValueHolder<T> {
   ...
   * @return
   */
  public UserVO readUser(final Optional<UserAccessTemporalCode> original,
      final ConstraintFailList fails) {
    UserVO result = value.orElse(original.map(UserAccessTemporalCode::getUserValue).orElse(null));
    if (null == result) {
