...
@Builder
@Data
public class RelyingPartyEnableTransition {
   ...
   * @return
   */
  public RelyingPartyEnableTransition map(final RelyingPartyChangeProposal newData) {
    RelyingPartyEnableTransition transition =
        RelyingPartyEnableTransition.builder().data(newData).build();
