...
@Builder
@Data
public class SecurityDomainUpdateTransition {
   ...
   * @return
   */
  public SecurityDomainUpdateTransition map(final SecurityDomainChangeProposal newData) {
    SecurityDomainUpdateTransition transition =
        SecurityDomainUpdateTransition.builder().data(newData).build();
