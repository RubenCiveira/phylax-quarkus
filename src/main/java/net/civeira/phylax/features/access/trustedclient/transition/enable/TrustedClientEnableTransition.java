...
@Builder
@Data
public class TrustedClientEnableTransition {
   ...
   * @return
   */
  public TrustedClientEnableTransition map(final TrustedClientChangeProposal newData) {
    TrustedClientEnableTransition transition =
        TrustedClientEnableTransition.builder().data(newData).build();
