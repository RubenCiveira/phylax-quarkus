...
@Getter
public class RelyingPartyCreateProjection {
   ...
   * @return
   */
  public static RelyingPartyCreateProjection from(final RelyingPartyVisibleProjection visible) {
    RelyingPartyCreateProjection instance = new RelyingPartyCreateProjection();
   ...
   */
  public RelyingPartyCreateProjection(final RelyingParty entity) {
