...
public class TenantConfigProjectionDescriptor implements ProjectionDescriptor {
  ...
  public static class TenantConfigExecutionPlanner {
     ...
     * @return
     */
    public TenantConfigExecutionPlanner withDynamicRegistrationPolicy() {
      return withDynamicRegistrationPolicy(prefix + "dynamicRegistrationPolicy");
    }
     ...
     * @return
     */
    public TenantConfigExecutionPlanner withDynamicRegistrationPolicy(final String alias) {
      aggregation.add(ExecutionAggregation.builder().name("dynamicRegistrationPolicy").alias(alias)
          .selection(List.of()).build());
      return this;
    }
     ...
     * @return
     */
    public TenantConfigExecutionPlanner withInvitationExpiryDays() {
      return withInvitationExpiryDays(prefix + "invitationExpiryDays");
    }
     ...
     * @return
     */
    public TenantConfigExecutionPlanner withInvitationExpiryDays(final String alias) {
      aggregation.add(ExecutionAggregation.builder().name("invitationExpiryDays").alias(alias)
          .selection(List.of()).build());
      return this;
    }
     ...
     * @return
     */
    public TenantConfigExecutionPlanner withMagicLinkEnabled() {
      return withMagicLinkEnabled(prefix + "magicLinkEnabled");
    }
     ...
     * @return
     */
    public TenantConfigExecutionPlanner withMagicLinkEnabled(final String alias) {
      aggregation.add(ExecutionAggregation.builder().name("magicLinkEnabled").alias(alias)
          .selection(List.of()).build());
      return this;
    }
     ...
     * @return
     */
    public TenantConfigExecutionPlanner withMagicLinkExpiryMinutes() {
      return withMagicLinkExpiryMinutes(prefix + "magicLinkExpiryMinutes");
    }
     ...
     * @return
     */
    public TenantConfigExecutionPlanner withMagicLinkExpiryMinutes(final String alias) {
      aggregation.add(ExecutionAggregation.builder().name("magicLinkExpiryMinutes").alias(alias)
          .selection(List.of()).build());
      return this;
    }
     ...
     * @return
     */
    public TenantConfigExecutionPlanner withRefreshTokenTtlSeconds() {
      return withRefreshTokenTtlSeconds(prefix + "refreshTokenTtlSeconds");
    }
     ...
     * @return
     */
    public TenantConfigExecutionPlanner withRefreshTokenTtlSeconds(final String alias) {
      aggregation.add(ExecutionAggregation.builder().name("refreshTokenTtlSeconds").alias(alias)
          .selection(List.of()).build());
      return this;
    }
     ...
     * @return
     */
    public TenantConfigExecutionPlanner withRequireEmailVerification() {
      return withRequireEmailVerification(prefix + "requireEmailVerification");
    }
     ...
     * @return
     */
    public TenantConfigExecutionPlanner withRequireEmailVerification(final String alias) {
      aggregation.add(ExecutionAggregation.builder().name("requireEmailVerification").alias(alias)
          .selection(List.of()).build());
      return this;
    }
     ...
     * @return
     */
    public TenantConfigExecutionPlanner withSessionSsoTtlSeconds() {
      return withSessionSsoTtlSeconds(prefix + "sessionSsoTtlSeconds");
    }
     ...
     * @return
     */
    public TenantConfigExecutionPlanner withSessionSsoTtlSeconds(final String alias) {
      aggregation.add(ExecutionAggregation.builder().name("sessionSsoTtlSeconds").alias(alias)
          .selection(List.of()).build());
      return this;
    }
     ...
     * @return
     */
    public TenantConfigExecutionPlanner withWebauthnEnabled() {
      return withWebauthnEnabled(prefix + "webauthnEnabled");
    }
     ...
     * @return
     */
    public TenantConfigExecutionPlanner withWebauthnEnabled(final String alias) {
      aggregation.add(ExecutionAggregation.builder().name("webauthnEnabled").alias(alias)
          .selection(List.of()).build());
      return this;
    }
     ...
     * @return
     */
    public TenantConfigExecutionPlanner withWebauthnRpId() {
      return withWebauthnRpId(prefix + "webauthnRpId");
    }
     ...
     * @return
     */
    public TenantConfigExecutionPlanner withWebauthnRpId(final String alias) {
      aggregation.add(ExecutionAggregation.builder().name("webauthnRpId").alias(alias)
          .selection(List.of()).build());
      return this;
    }
     ...
     * @return
     */
    public TenantConfigExecutionPlanner withWebauthnRpName() {
      return withWebauthnRpName(prefix + "webauthnRpName");
    }
     ...
     * @return
     */
    public TenantConfigExecutionPlanner withWebauthnRpName(final String alias) {
      aggregation.add(ExecutionAggregation.builder().name("webauthnRpName").alias(alias)
          .selection(List.of()).build());
      return this;
    }
