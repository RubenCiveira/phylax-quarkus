...
@Builder
@Data
public class UserDisableTransition {
   ...
   * @return
   */
  public UserDisableTransition map(final UserChangeProposal newData) {
    UserDisableTransition transition = UserDisableTransition.builder().data(newData).build();
