...
@Getter
public class SecurityDomainEnableProjection {
   ...
   * @return
   */
  public static SecurityDomainEnableProjection from(final SecurityDomainVisibleProjection visible) {
    SecurityDomainEnableProjection instance = new SecurityDomainEnableProjection();
   ...
   */
  public SecurityDomainEnableProjection(final SecurityDomain entity) {
