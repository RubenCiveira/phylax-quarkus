...
@Builder
@Data
public class LoginProviderDisableTransition {

  /**
   * @autogenerated UpdateEntityRuleGenerator
   */
  private final LoginProviderChangeProposal data;
   ...
   * @autogenerated UpdateEntityRuleGenerator
   */
  private final LoginProvider original;
   ...
   * @return
   */
  public LoginProviderDisableTransition map(final LoginProviderChangeProposal newData) {
    LoginProviderDisableTransition transition =
        LoginProviderDisableTransition.builder().data(newData).build();
