...
@Builder
@Data
public class UserIdentityUpdateTransition {

  /**
   * @autogenerated UpdateEntityRuleGenerator
   */
  private final UserIdentityChangeProposal data;
   ...
   * @autogenerated UpdateEntityRuleGenerator
   */
  private final UserIdentity original;
   ...
   * @return
   */
  public UserIdentityUpdateTransition map(final UserIdentityChangeProposal newData) {
    UserIdentityUpdateTransition transition =
        UserIdentityUpdateTransition.builder().data(newData).build();
