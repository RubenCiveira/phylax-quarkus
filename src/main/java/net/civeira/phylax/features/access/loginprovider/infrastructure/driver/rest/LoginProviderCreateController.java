...
import net.civeira.phylax.features.access.loginprovider.application.usecase.create.LoginProviderCreateInput;
import net.civeira.phylax.features.access.loginprovider.application.usecase.create.LoginProviderCreateProjection;
...
public class LoginProviderCreateController {
  ...
  public Response loginProviderApiCreate(LoginProviderApiDto loginProvider) {
    LoginProviderCreateProjection created =
   ...
   * @return
   */
  private LoginProviderApiDto toApiModel(LoginProviderCreateProjection dto) {
   ...
   * @return
   */
  private LoginProviderCreateInput toDomainModel(LoginProviderApiDto loginProviderApiDto) {
    LoginProviderCreateInput dto = new LoginProviderCreateInput();
