...
public class UserUpdateUsecase {
  ...
  public UserUpdateProjection update(final Interaction query, final UserRef reference,
    ...
    try {
      ...
      if (!detail.isAllowed()) {
        span.addEvent("The policies for user dont allow to update: " + detail.getDescription());
      ...
      span.addEvent("The input value is checked with the policies for the update of user");
      ...
      span.addEvent("The update of entity for user is ready");
      User saved = gateway.update(original, original.update(dto));
      span.addEvent("The updated entity of user was saved");
      cache.update(saved);
