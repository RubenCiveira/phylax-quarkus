...
import net.civeira.phylax.generated.openapi.api.RelyingPartyAuditApi;
import net.civeira.phylax.generated.openapi.model.AuditEventDto;

@RequiredArgsConstructor
@ApplicationScoped
public class RelyingPartyAuditController implements RelyingPartyAuditApi {
  ...
  public Response relyingPartyApiActorAudit(final String actor, final LocalDate from,
    ...
    List<AuditEvent> events =
        reader.findByFilters(AuditQueryFilter.builder().entityType("relyingParty")
  ...
  public Response relyingPartyApiEntityAudit(final String uid) {
    List<AuditEvent> events = reader.findByFilters(
        AuditQueryFilter.builder().entityType("relyingParty").entityId(uid).build(), tenant(), 0,
        1000);
    return Response.ok(events.stream().map(this::map).toList()).build();
  }
