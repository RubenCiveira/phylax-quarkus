...
import net.civeira.phylax.features.access.userroleassignament.application.usecase.delete.UserRoleAssignamentCheckBatchDeleteStatus;
import net.civeira.phylax.features.access.userroleassignament.application.usecase.delete.UserRoleAssignamentDeleteFilter;
...
@ApplicationScoped
public class UserRoleAssignamentDeleteController {
   ...
   * @return
   */
  @ApiObserved("Api to delete on massive entity of user role assignament")
  public Response userRoleAssignamentApiBatchDelete(final List<String> uids, final String search,
    ...
    UserRoleAssignamentDeleteFilter.UserRoleAssignamentDeleteFilterBuilder filterBuilder =
        UserRoleAssignamentDeleteFilter.builder();
    filterBuilder =
    ...
    UserRoleAssignamentDeleteFilter filter = filterBuilder.build();
   ...
   * @return
   */
  @ApiObserved("Api to check masive delete on entity of user role assignament")
  public Response userRoleAssignamentApiBatchDeleteQuery(final String batchId) {
    BatchProgress task = delete.checkProgress(currentRequest.interaction(),
        UserRoleAssignamentCheckBatchDeleteStatus.builder().taskId(batchId).build());
   ...
   */
  @Transactional
  @ApiObserved("Api to delete an entity of user role assignament")
  public Response userRoleAssignamentApiDelete(final String uid) {
    Trace.setAttribute("ref", uid);
    delete.delete(currentRequest.interaction(), UserRoleAssignamentReference.of(uid));
