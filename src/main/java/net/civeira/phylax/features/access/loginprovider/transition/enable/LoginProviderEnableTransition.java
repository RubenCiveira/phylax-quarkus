...
@Builder
@Data
public class LoginProviderEnableTransition {
   ...
   * @return
   */
  public LoginProviderEnableTransition map(final LoginProviderChangeProposal newData) {
    LoginProviderEnableTransition transition =
        LoginProviderEnableTransition.builder().data(newData).build();
