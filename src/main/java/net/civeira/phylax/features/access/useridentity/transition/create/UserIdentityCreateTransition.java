...
@Builder
@Data
public class UserIdentityCreateTransition {
   ...
   * @return
   */
  public UserIdentityCreateTransition map(final UserIdentityChangeProposal newData) {
    UserIdentityCreateTransition transition =
        UserIdentityCreateTransition.builder().data(newData).build();
