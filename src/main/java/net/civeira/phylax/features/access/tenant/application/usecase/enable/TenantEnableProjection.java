...
@Getter
public class TenantEnableProjection {
   ...
   * @return
   */
  public static TenantEnableProjection from(final TenantVisibleProjection visible) {
    TenantEnableProjection instance = new TenantEnableProjection();
   ...
   */
  public TenantEnableProjection(final Tenant entity) {
