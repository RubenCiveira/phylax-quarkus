package net.civeira.phylax.features.access.clientidentity.infrastructure.bootstrap;
...
@ApplicationScoped
public class ClientIdentityProjectionDescriptor implements ProjectionDescriptor {

  /**
   * @autogenerated ProjectionDescriptorGeneratorGenerator
   */
  public static class ClientIdentityExecutionPlanner {
     ...
     * @autogenerated ProjectionDescriptorGeneratorGenerator
     */
    public ClientIdentityExecutionPlanner() {
      this.prefix = "";
    }
     ...
     * @param prefix
     */
    public ClientIdentityExecutionPlanner(final String prefix) {
      this.prefix = prefix + ".";
    }
     ...
     * @return
     */
    public ClientIdentityExecutionPlanner withRelyingParty() {
     ...
     * @return
     */
    public ClientIdentityExecutionPlanner withRelyingParty(final String alias) {
     ...
     * @return
     */
    public ClientIdentityExecutionPlanner withRoles() {
     ...
     * @return
     */
    public ClientIdentityExecutionPlanner withRoles(final String alias) {
      aggregation.add(
     ...
     * @return
     */
    public ClientIdentityExecutionPlanner withTrustedClient() {
     ...
     * @return
     */
    public ClientIdentityExecutionPlanner withTrustedClient(final String alias) {
     ...
     * @return
     */
    public ClientIdentityExecutionPlanner withUid() {
     ...
     * @return
     */
    public ClientIdentityExecutionPlanner withUid(final String alias) {
      aggregation.add(
     ...
     * @return
     */
    public ClientIdentityExecutionPlanner withUser() {
     ...
     * @return
     */
    public ClientIdentityExecutionPlanner withUser(final String alias) {
     ...
     * @return
     */
    public ClientIdentityExecutionPlanner withVersion() {
     ...
     * @return
     */
    public ClientIdentityExecutionPlanner withVersion(final String alias) {
      aggregation.add(
  ...
  public List<ExecutionNode> baseNodes(final String baseServer) {
    ...
    return List.of(
        ExecutionNode.builder().server(baseServer).endpoint("/api/access/client-identity")
            .method("GET").list(true).params(Map.of()).relations(relations).build(),
        ExecutionNode.builder().server(baseServer).endpoint("/api/access/client-identity/{uid}")
