...
@Getter
public class PlatformIdentityCreateProjection {
   ...
   * @return
   */
  public static PlatformIdentityCreateProjection from(
      final PlatformIdentityVisibleProjection visible) {
    PlatformIdentityCreateProjection instance = new PlatformIdentityCreateProjection();
   ...
   */
  public PlatformIdentityCreateProjection(final PlatformIdentity entity) {
