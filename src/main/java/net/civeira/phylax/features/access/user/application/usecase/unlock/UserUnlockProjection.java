...
@Getter
public class UserUnlockProjection {
   ...
   * @return
   */
  public static UserUnlockProjection from(final UserVisibleProjection visible) {
    UserUnlockProjection instance = new UserUnlockProjection();
   ...
   */
  public UserUnlockProjection(final User entity) {
