...
public class TempSecondFactorSeedVO {
   ...
   * @return
   */
  public Optional<String> getTempSecondFactorSeedCyphered(final AesCipherService cypher) {
   ...
   * @return
   */
  public Optional<String> getTempSecondFactorSeedPlain(final AesCipherService cypher) {
    return cyphered
   ...
   * @param map
   */
  public void tempSecondFactorSeedToMap(final Map<String, String> map) {
    /* cyphered fields are not mapped */
  }
