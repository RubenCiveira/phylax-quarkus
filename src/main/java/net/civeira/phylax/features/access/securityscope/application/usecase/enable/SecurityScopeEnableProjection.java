...
@Getter
public class SecurityScopeEnableProjection {
   ...
   * @return
   */
  public static SecurityScopeEnableProjection from(final SecurityScopeVisibleProjection visible) {
    SecurityScopeEnableProjection instance = new SecurityScopeEnableProjection();
   ...
   */
  public SecurityScopeEnableProjection(final SecurityScope entity) {
