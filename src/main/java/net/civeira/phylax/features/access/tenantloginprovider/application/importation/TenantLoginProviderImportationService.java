...
public class TenantLoginProviderImportationService {
  ...
  public TenantLoginProviderChangeSet toChangeSet(final Map<String, String> row,
    ...
    change = readOidcDiscoveryUrl(change, row, fails, resolver);
    change = readSamlIdpMetadataUrl(change, row, fails, resolver);
    change = readSamlIdpEntityId(change, row, fails, resolver);
    change = readSamlIdpSsoUrl(change, row, fails, resolver);
   ...
   * @return
   */
  private TenantLoginProviderChangeSet readOidcDiscoveryUrl(
      final TenantLoginProviderChangeSet change, final Map<String, String> row,
      final ConstraintFailList fails,
      final TenantLoginProviderImportationRelatedResolver resolver) {
    String oidcDiscoveryUrl = row.get("oidcDiscoveryUrl");
    if (oidcDiscoveryUrl != null) {
      return change.oidcDiscoveryUrl(oidcDiscoveryUrl);
    } else {
      return change.unsetOidcDiscoveryUrl();
    }
  }
   ...
   * @return
   */
  private TenantLoginProviderChangeSet readSamlIdpEntityId(
      final TenantLoginProviderChangeSet change, final Map<String, String> row,
      final ConstraintFailList fails,
      final TenantLoginProviderImportationRelatedResolver resolver) {
    String samlIdpEntityId = row.get("samlIdpEntityId");
    if (samlIdpEntityId != null) {
      return change.samlIdpEntityId(samlIdpEntityId);
    } else {
      return change.unsetSamlIdpEntityId();
    }
  }
   ...
   * @return
   */
  private TenantLoginProviderChangeSet readSamlIdpMetadataUrl(
      final TenantLoginProviderChangeSet change, final Map<String, String> row,
      final ConstraintFailList fails,
      final TenantLoginProviderImportationRelatedResolver resolver) {
    String samlIdpMetadataUrl = row.get("samlIdpMetadataUrl");
    if (samlIdpMetadataUrl != null) {
      return change.samlIdpMetadataUrl(samlIdpMetadataUrl);
    } else {
      return change.unsetSamlIdpMetadataUrl();
    }
  }
   ...
   * @return
   */
  private TenantLoginProviderChangeSet readSamlIdpSsoUrl(final TenantLoginProviderChangeSet change,
      final Map<String, String> row, final ConstraintFailList fails,
      final TenantLoginProviderImportationRelatedResolver resolver) {
    String samlIdpSsoUrl = row.get("samlIdpSsoUrl");
    if (samlIdpSsoUrl != null) {
      return change.samlIdpSsoUrl(samlIdpSsoUrl);
    } else {
      return change.unsetSamlIdpSsoUrl();
    }
  }
