...
public class TrustedClientValueHolder<T> {
   ...
   * @return
   */
  public TrustedClientVO readTrustedClient(final Optional<ClientIdentity> original,
      final ConstraintFailList fails) {
    return value.orElse(
        original.map(ClientIdentity::getTrustedClientValue).orElseGet(TrustedClientVO::nullValue));
  }
