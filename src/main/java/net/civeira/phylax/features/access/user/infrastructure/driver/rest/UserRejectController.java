...
public class UserRejectController {
  ...
  public Response userApiBatchReject(final List<String> uids, final String search,
    ...
    Span span = tracer.spanBuilder("Api to reject on massive entitites of user")
  ...
  public Response userApiBatchRejectQuery(final String batchId) {
    Span span = tracer.spanBuilder("Api to check masive reject on entity of user")
        .setParent(Context.current().with(Span.current())).setSpanKind(SpanKind.SERVER).startSpan();
    try {
  ...
  public Response userApiReject(final String uid) {
    Span span = tracer.spanBuilder("Api to reject an entity of user")
        .setParent(Context.current().with(Span.current())).setSpanKind(SpanKind.SERVER).startSpan();
    try {
