...
import net.civeira.phylax.features.access.user.application.service.visibility.UserPresetProposal;
...
public class HeritageTenant {
   ...
   * @param builder
   */
  public void calculate(@Observes UserPresetProposal builder) {
