...
import net.civeira.phylax.generated.openapi.api.UserRoleAssignamentAuditApi;
import net.civeira.phylax.generated.openapi.model.AuditEventDto;

@RequiredArgsConstructor
@ApplicationScoped
public class UserRoleAssignamentAuditController implements UserRoleAssignamentAuditApi {
  ...
  private AuditEventDto map(final AuditEvent event) {
    return new AuditEventDto().operation(event.getOperation()).usecase(event.getUsecase())
        .entityType("userRoleAssignament").entityType(event.getEntityType())
