...
@Builder
@Data
public class LoginProviderCreateTransition {
   ...
   * @return
   */
  public LoginProviderCreateTransition map(final LoginProviderChangeProposal newData) {
    LoginProviderCreateTransition transition =
        LoginProviderCreateTransition.builder().data(newData).build();
