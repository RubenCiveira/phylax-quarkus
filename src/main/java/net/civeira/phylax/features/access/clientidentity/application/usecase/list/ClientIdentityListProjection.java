...
@Getter
public class ClientIdentityListProjection {
   ...
   * @return
   */
  public static ClientIdentityListProjection from(final ClientIdentityVisibleProjection visible) {
    ClientIdentityListProjection instance = new ClientIdentityListProjection();
   ...
   */
  public ClientIdentityListProjection(final ClientIdentity entity) {
