...
public class PlatformIdentityRepository {
   ...
   */
  private static final String ACCESS_PLATFORM_IDENTITY_RELYING_PARTY =
      "access_platform_identity.relying_party";

  /**
   * @autogenerated RepositoryJdbcGenerator
   */
  private static final String ACCESS_PLATFORM_IDENTITY_SNAKE = "access_platform_identity";

  /**
   * @autogenerated RepositoryJdbcGenerator
   */
  private static final String ACCESS_PLATFORM_IDENTITY_TRUSTED_CLIENT =
      "access_platform_identity.trusted_client";

  /**
   * @autogenerated RepositoryJdbcGenerator
   */
  private static final String ACCESS_PLATFORM_IDENTITY_UID = "access_platform_identity.uid";

  /**
   * @autogenerated RepositoryJdbcGenerator
   */
  private static final String ACCESS_PLATFORM_IDENTITY_USER = "access_platform_identity.user";

  /**
   * @autogenerated RepositoryJdbcGenerator
   */
  private static final String ACCESS_PLATFORM_IDENTITY_USER_TENANT =
      "access_platform_identity_user.tenant";

  /**
   * @autogenerated RepositoryJdbcGenerator
   */
  private static final String ACCESS_PLATFORM_IDENTITY_VERSION = "access_platform_identity.version";

  /**
   * @autogenerated RepositoryJdbcGenerator
   */
  private static final String PLATFORM_IDENTITY = "platformIdentity";

  /**
   * @autogenerated RepositoryJdbcGenerator
   */
  private static final String PLATFORM_IDENTITY_KEBAB = "platform-identity";
  ...
  public void delete(PlatformIdentity entity) {
    try (SqlTemplate template = new SqlTemplate(datasource, tracer)) {
      ...
      SqlCommand sq = template
          .createSqlCommand("delete from \"access_platform_identity\" where \"uid\" = :uid");
  ...
  public Optional<PlatformIdentity> find(PlatformIdentityFilter filter) {
    PlatformIdentityCursor cursor = PlatformIdentityCursor.builder().build();
    return new PlatformIdentitySlider(runList(filter, cursor), cursor.getLimit().orElse(0),
   ...
   */
  public Optional<PlatformIdentity> find(final String sql,
      final Map<String, SqlParameterValue> params) {
    try (SqlTemplate template = new SqlTemplate(datasource, tracer)) {
      SqlQuery<PlatformIdentity> createSqlQuery = template.createSqlQuery(sql);
  ...
  public Optional<PlatformIdentity> findForUpdate(PlatformIdentityFilter filter) {
    PlatformIdentityCursor cursor = PlatformIdentityCursor.builder().build();
    return new PlatformIdentitySlider(runListForUpdate(filter, cursor), cursor.getLimit().orElse(0),
        this::runList, filter, cursor).one();
  }
   ...
   * @return sq.where("uid", SqlOperator.LIKE, SqlParameterValue.of("%" + search + "%"))
   */
  public Optional<PlatformIdentity> findForUpdate(final String sql,
      final Map<String, SqlParameterValue> params) {
    try (SqlTemplate template = new SqlTemplate(datasource, tracer)) {
      SqlQuery<PlatformIdentity> createSqlQuery = template.createSqlQuery(sql);
      withChilds(createSqlQuery);
   ...
   * @return sq.where("uid", SqlOperator.LIKE, SqlParameterValue.of("%" + search + "%"))
   */
  public List<PlatformIdentity> list(final String sql,
      final Map<String, SqlParameterValue> params) {
   ...
   * @return sq.where("uid", SqlOperator.LIKE, SqlParameterValue.of("%" + search + "%"))
   */
  public List<PlatformIdentity> list(final String sql, final Map<String, SqlParameterValue> params,
      final int limit) {
   ...
   * @return sq.where("uid", SqlOperator.LIKE, SqlParameterValue.of("%" + search + "%"))
   */
  public List<PlatformIdentity> listForUpdate(final String sql,
      final Map<String, SqlParameterValue> params) {
  ...
  public PlatformIdentity resolve(PlatformIdentityRef reference) {
    return reference instanceof PlatformIdentity platformIdentity ? platformIdentity
        : retrieve(reference.getUid(), Optional.empty()).orElseThrow(() -> new NotFoundException(
            "Trying to resolve inexistent PlatformIdentity: " + reference.getUid()));
  }
  ...
  public List<Role> resolveRoles(final List<Roles> childs) {
    return roleRepository.list(
        "select \"access_role\".* from \"access_role\" join \"access_platform_identity_role\" on \"access_role\".\"uid\" = \"access_platform_identity_role\".\"role\" "
            + " where \"access_platform_identity_role\".\"uid\" in ( :availables )",
        Map.of("availables",
  ...
  public Optional<PlatformIdentity> retrieve(String uid, Optional<PlatformIdentityFilter> filter) {
    try (SqlTemplate template = new SqlTemplate(datasource, tracer)) {
      PlatformIdentityFilter readyFilter = filter.map(val -> val.withUid(uid))
          .orElseGet(() -> PlatformIdentityFilter.builder().uid(uid).build());
      SqlSchematicQuery<PlatformIdentity> sq = filteredQuery(template, readyFilter);
   ...
   * @return
   */
  public PlatformIdentity update(PlatformIdentity entity) {
    try (SqlTemplate template = new SqlTemplate(datasource, tracer)) {
      SqlCommand sq = template.createSqlCommand(
          "update \"access_platform_identity\" set  \"user\" = :user, \"relying_party\" = :relyingParty, \"trusted_client\" = :trustedClient, \"version\" = \"version\" + 1 where \"uid\" = :uid and \"version\" = :version");
      sq.with(UID, SqlParameterValue.of(entity.getUid()));
      ...
      PlatformIdentity result = entity.withNextVersion();
   ...
   * @return
   */
  private SqlConverter<PlatformIdentity> converter() {
    return row -> {
      try {
        ...
        return Optional.of(PlatformIdentity.builder().uidValue(UidVO.from(row.getString(UID)))
   ...
   * @param template
   */
  private void deleteRoles(PlatformIdentity entity, SqlTemplate template) {
    SqlCommand sq = template.createSqlCommand(
        "delete from \"access_platform_identity_role\" where \"platform-identity\" = :platform-identity");
    sq.with(PLATFORM_IDENTITY_KEBAB, SqlParameterValue.of(entity.getUid()));
    sq.execute();
  }
  ...
  private <T> SqlSchematicQuery<T> filteredQuery(SqlTemplate template,
    ...
    SqlSchematicQuery<T> sq = template.createSqlSchematicQuery(ACCESS_PLATFORM_IDENTITY_SNAKE);
    sq.selectFields(ACCESS_PLATFORM_IDENTITY_UID, ACCESS_PLATFORM_IDENTITY_USER,
        ACCESS_PLATFORM_IDENTITY_RELYING_PARTY, ACCESS_PLATFORM_IDENTITY_TRUSTED_CLIENT,
        ACCESS_PLATFORM_IDENTITY_VERSION);
    withChilds(sq);
    ...
    filter.getUserTenantTenantAccesible().ifPresent(userTenantTenantAccesible -> {
      sq.join("access_user", "access_platform_identity_user", "access_platform_identity.user",
          "access_platform_identity_user.uid");
      sq.where(ACCESS_PLATFORM_IDENTITY_USER_TENANT, SqlOperator.EQ,
   ...
   * @return sq.where("uid", SqlOperator.LIKE, SqlParameterValue.of("%" + search + "%"))
   */
  private List<PlatformIdentity> list(final String sql, final Map<String, SqlParameterValue> params,
    ...
    try (SqlTemplate template = new SqlTemplate(datasource, tracer)) {
      ...
      SqlResult<PlatformIdentity> query = createSqlQuery.query(converter());
   ...
   * @return
   */
  private PlatformIdentity runCreate(PlatformIdentity entity,
      Predicate<PlatformIdentity> verifier) {
    try (SqlTemplate template = new SqlTemplate(datasource, tracer)) {
      SqlCommand sq = template.createSqlCommand(
          "insert into \"access_platform_identity\" ( \"uid\", \"user\", \"relying_party\", \"trusted_client\", \"version\") values ( :uid, :user, :relyingParty, :trustedClient, :version)");
      sq.with(UID, SqlParameterValue.of(entity.getUid()));
      sq.with(USER, SqlParameterValue.of(entity.getUserUid()));
      sq.with(RELYING_PARTY, entity.getRelyingPartyUid().map(SqlParameterValue::of)
          .orElseGet(SqlParameterValue::ofNullString));
   ...
   * @return
   */
  private Iterator<PlatformIdentity> runList(PlatformIdentityFilter filter,
      PlatformIdentityCursor cursor) {
    try (SqlTemplate template = new SqlTemplate(datasource, tracer)) {
      SqlSchematicQuery<PlatformIdentity> sq = filteredQuery(template, filter);
      cursor.getSinceUid()
   ...
   * @return
   */
  private Iterator<PlatformIdentity> runListForUpdate(PlatformIdentityFilter filter,
      PlatformIdentityCursor cursor) {
    try (SqlTemplate template = new SqlTemplate(datasource, tracer)) {
      SqlSchematicQuery<PlatformIdentity> sq = filteredQuery(template, filter);
      cursor.getSinceUid()
   ...
   * @return
   */
  private PlatformIdentity saveRoles(PlatformIdentity entity, List<Roles> childs) {
    try (SqlTemplate template = new SqlTemplate(datasource, tracer)) {
      SqlQuery<Object[]> sq = template.createSqlQuery(
          "select \"uid\", \"platform_identity\" from \"access_platform_identity_role\" where (\"platform_identity\" = :platformIdentity)"
              + " or ( \"uid\" in (:tomap) and \"platform_identity\" != :platformIdentity )");
      sq.with(PLATFORM_IDENTITY, SqlParameterValue.of(entity.getUid()));
      ...
      if (!codes.isEmpty()) {
        SqlCommand deleted = template.createSqlCommand(
            "delete from\"access_platform_identity_role\" where \"uid\" in (:codes)");
      ...
      childs.forEach(child -> {
        SqlCommand command = template.createSqlCommand(codes.contains(child.getUid())
            ? "update \"access_platform_identity_role\" set \"verify\" = :verify, \"medal\" = :medal, \"version\" = \"version\" + 1 where \"uid\" = :uid and \"version\" = :version"
            : "insert into \"access_platform_identity_role\" ( \"uid\", \"platform_identity\", \"role\", \"version\") values ( :uid, :platformIdentity, :role, :version)");
        command.with(UID, SqlParameterValue.of(child.getUid()));
        command.with(PLATFORM_IDENTITY, SqlParameterValue.of(entity.getUid()));
   ...
   * @return
   */
  private PlatformIdentity verified(boolean exists, PlatformIdentity entity, SqlTemplate template) {
    if (exists) {
      return entity;
    } else {
      template.createSqlCommand("delete from \"access_platform_identity\" where \"uid\" = :uid")
  ...
  private void withChilds(AbstractSqlParametrized<?> sq) {
    sq.child(100, "roles",
        "select \"platform_identity\",\"uid\",\"role\",\"version\" from \"access_platform_identity_role\"  where \"platform_identity\" in (:platformIdentity)",
        "uid", "platform_identity", row -> {
          try {
