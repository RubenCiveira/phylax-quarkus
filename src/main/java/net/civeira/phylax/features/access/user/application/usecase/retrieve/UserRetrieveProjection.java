...
@Getter
public class UserRetrieveProjection {
   ...
   * @return
   */
  public static UserRetrieveProjection from(final UserVisibleProjection visible) {
    UserRetrieveProjection instance = new UserRetrieveProjection();
    ...
    instance.emailVerifiedValue = visible.getEmailVerified();
   ...
   * @autogenerated RetrieveProjectionGenerator
   */
  private Optional<EmailVerifiedVO> emailVerifiedValue;
   ...
   */
  public UserRetrieveProjection(final User entity) {
    ...
    emailVerifiedValue = Optional.of(entity.getEmailVerifiedValue());
  ...
  public Boolean getEmailVerified() {
    return getEmailVerifiedOrDefault(null);
  }
   ...
   *         EmailVerified
   */
  public Boolean getEmailVerifiedOrDefault(final Boolean orDefault) {
    return emailVerifiedValue.map(EmailVerifiedVO::isEmailVerified).orElse(orDefault);
  }
