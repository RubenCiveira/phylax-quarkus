...
@Getter
public class SecurityScopeRetrieveProjection {
   ...
   * @return
   */
  public static SecurityScopeRetrieveProjection from(final SecurityScopeVisibleProjection visible) {
    SecurityScopeRetrieveProjection instance = new SecurityScopeRetrieveProjection();
   ...
   */
  public SecurityScopeRetrieveProjection(final SecurityScope entity) {
