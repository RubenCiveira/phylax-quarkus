...
@Getter
public class SecurityScopeUpdateProjection {
   ...
   * @return
   */
  public static SecurityScopeUpdateProjection from(final SecurityScopeVisibleProjection visible) {
    SecurityScopeUpdateProjection instance = new SecurityScopeUpdateProjection();
   ...
   */
  public SecurityScopeUpdateProjection(final SecurityScope entity) {
