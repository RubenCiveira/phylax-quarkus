...
@Getter
public class TrustedClientListProjection {
   ...
   * @return
   */
  public static TrustedClientListProjection from(final TrustedClientVisibleProjection visible) {
    TrustedClientListProjection instance = new TrustedClientListProjection();
   ...
   */
  public TrustedClientListProjection(final TrustedClient entity) {
