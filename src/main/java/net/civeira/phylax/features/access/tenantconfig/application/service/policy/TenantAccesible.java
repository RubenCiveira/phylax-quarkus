...
import net.civeira.phylax.features.access.tenantconfig.application.service.visibility.TenantConfigFilterProposal;
...
public class TenantAccesible {
   ...
   * @param filter
   */
  public void filterVisibles(@Observes TenantConfigFilterProposal filter) {
