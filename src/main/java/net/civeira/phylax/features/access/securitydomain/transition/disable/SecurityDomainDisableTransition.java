...
@Builder
@Data
public class SecurityDomainDisableTransition {

  /**
   * @autogenerated UpdateEntityRuleGenerator
   */
  private final SecurityDomainChangeProposal data;
   ...
   * @autogenerated UpdateEntityRuleGenerator
   */
  private final SecurityDomain original;
   ...
   * @return
   */
  public SecurityDomainDisableTransition map(final SecurityDomainChangeProposal newData) {
    SecurityDomainDisableTransition transition =
        SecurityDomainDisableTransition.builder().data(newData).build();
