...
/**
 * Value Object representing el código identificativo de la aplicación of apiKeyClient.
 * <p>
...
public class CodeVO {
   ...
   * @param map
   */
  public void codeToMap(final Map<String, String> map) {
    if (null != value) {
      map.put("code", String.valueOf(value));
    }
  }
