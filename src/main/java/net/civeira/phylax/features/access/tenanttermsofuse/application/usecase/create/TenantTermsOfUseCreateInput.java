...
public class TenantTermsOfUseCreateInput {
  ...
  public static class TenantTermsOfUseCreateInputBuilder {
     ...
     * @return Self instance to continue with a flow build
     */
    public TenantTermsOfUseCreateInputBuilder enabled(final Boolean enabled) {
     ...
     * @return Self instance to continue with a flow build
     */
    public TenantTermsOfUseCreateInputBuilder enabled(final Optional<EnabledVO> enabled) {
     ...
     * @return Self instance to continue with a flow build
     */
    public TenantTermsOfUseCreateInputBuilder relyingParty(final RelyingPartyRef relyingParty) {
     ...
     * @return Self instance to continue with a flow build
     */
    public TenantTermsOfUseCreateInputBuilder relyingParty(
  ...
  static TenantTermsOfUseCreateInput fromChangeSet(final TenantTermsOfUseChangeSet input) {
    return TenantTermsOfUseCreateInput.builder().uid(input.getUidValue())
        .tenant(input.getTenantValue()).relyingParty(input.getRelyingPartyValue())
        .text(input.getTextValue()).enabled(input.getEnabledValue())
  ...
  /**
   * La applicación a tener en cuenta
   *
   * @autogenerated CreateInputGenerator
   */
  @Builder.Default
   ...
   * @return self instance to enable a flow code
   */
  public TenantTermsOfUseCreateInput setEnabled(final Boolean value) {
   ...
   * @return self instance to enable a flow code
   */
  public TenantTermsOfUseCreateInput setRelyingParty(final RelyingPartyRef value) {
  ...
  TenantTermsOfUseChangeSet toChangeSet() {
    return new TenantTermsOfUseChangeSet().uid(uid).tenant(tenant).relyingParty(relyingParty)
        .text(text).enabled(enabled).attached(attached).activationDate(activationDate)
        .version(version);
  }
}
