...
@Getter
public class SecurityScopeCreateProjection {
   ...
   * @return
   */
  public static SecurityScopeCreateProjection from(final SecurityScopeVisibleProjection visible) {
    SecurityScopeCreateProjection instance = new SecurityScopeCreateProjection();
   ...
   */
  public SecurityScopeCreateProjection(final SecurityScope entity) {
