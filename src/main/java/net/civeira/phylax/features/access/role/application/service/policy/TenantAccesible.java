...
import net.civeira.phylax.features.access.role.application.service.visibility.RoleFilterProposal;
...
public class TenantAccesible {
   ...
   * @param filter
   */
  public void filterVisibles(@Observes RoleFilterProposal filter) {
