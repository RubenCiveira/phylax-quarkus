...
public class SecurityScope implements SecurityScopeRef {
  ...
  public static SecurityScope create(final SecurityScopeWriteAttributes attributes,
      final SecurityScopeCreatePipeline pipeline) {
    return pipeline.create(attributes, attr -> {
      SecurityScope instance = new SecurityScope(attr, Optional.empty());
   ...
   * @return
   */
  public SecurityScope delete(final SecurityScopeDeletePipeline pipeline) {
   ...
   * @return
   */
  public SecurityScope disable(final SecurityScopeDisablePipeline pipeline) {
   ...
   * @return
   */
  public SecurityScope enable(final SecurityScopeEnablePipeline pipeline) {
  ...
  public SecurityScope update(final SecurityScopeWriteAttributes attributes,
      final SecurityScopeUpdatePipeline pipeline) {
