...
@Getter
public class ScopeAssignationRetrieveProjection {
   ...
   * @return
   */
  public static ScopeAssignationRetrieveProjection from(
      final ScopeAssignationVisibleProjection visible) {
    ScopeAssignationRetrieveProjection instance = new ScopeAssignationRetrieveProjection();
   ...
   */
  public ScopeAssignationRetrieveProjection(final ScopeAssignation entity) {
