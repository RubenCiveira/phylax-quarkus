...
@Builder
@Data
public class UserSetMfaSeedTransition {
   ...
   */
  @NonNull
  private final String secondFactorSeed;
   ...
   * @return
   */
  public UserSetMfaSeedTransition map(final UserChangeProposal newData) {
    UserSetMfaSeedTransition transition = UserSetMfaSeedTransition.builder().data(newData).build();
