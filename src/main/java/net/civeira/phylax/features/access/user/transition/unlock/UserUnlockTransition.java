...
@Builder
@Data
public class UserUnlockTransition {
   ...
   * @return
   */
  public UserUnlockTransition map(final UserChangeProposal newData) {
    UserUnlockTransition transition = UserUnlockTransition.builder().data(newData).build();
