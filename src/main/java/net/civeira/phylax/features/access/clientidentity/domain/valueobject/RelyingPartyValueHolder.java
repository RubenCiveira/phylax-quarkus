...
public class RelyingPartyValueHolder<T> {
   ...
   * @return
   */
  public RelyingPartyVO readRelyingParty(final Optional<ClientIdentity> original,
      final ConstraintFailList fails) {
    return value.orElse(
        original.map(ClientIdentity::getRelyingPartyValue).orElseGet(RelyingPartyVO::nullValue));
  }
