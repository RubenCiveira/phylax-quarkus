...
@Getter
public class UserUpdateProjection {
   ...
   * @return
   */
  public static UserUpdateProjection from(final UserVisibleProjection visible) {
    UserUpdateProjection instance = new UserUpdateProjection();
   ...
   */
  public UserUpdateProjection(final User entity) {
