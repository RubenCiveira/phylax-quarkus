...
@Getter
public class TenantLoginProviderDisableProjection {
   ...
   * @return
   */
  public static TenantLoginProviderDisableProjection from(
      final TenantLoginProviderVisibleProjection visible) {
    TenantLoginProviderDisableProjection instance = new TenantLoginProviderDisableProjection();
   ...
   */
  public TenantLoginProviderDisableProjection(final TenantLoginProvider entity) {
