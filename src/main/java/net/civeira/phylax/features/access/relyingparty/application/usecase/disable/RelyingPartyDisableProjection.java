...
@Getter
public class RelyingPartyDisableProjection {
   ...
   * @return
   */
  public static RelyingPartyDisableProjection from(final RelyingPartyVisibleProjection visible) {
    RelyingPartyDisableProjection instance = new RelyingPartyDisableProjection();
   ...
   */
  public RelyingPartyDisableProjection(final RelyingParty entity) {
