...
public class TenantAuditAdapter implements TenantAuditGateway {
  ...
  public void created(final String usecase, final Tenant tenant, final Interaction interaction) {
    writer.record(AuditEvent.builder().operation("create").usecase(usecase).entityType("tenant")
  ...
  public void deleted(final String usecase, final Tenant tenant, final Interaction interaction) {
    writer.record(AuditEvent.builder().operation("delete").usecase(usecase).entityType("tenant")
  ...
  public void updated(final String usecase, final Tenant tenant, final Tenant tenantOriginal,
    ...
    writer.record(AuditEvent.builder().operation("update").usecase(usecase).entityType("tenant")
