...
public class ClientIdentityRbacRegister {

  /**
   * @autogenerated RegisterGeneratorGenerator
   */
  private static final ResourceDescription RESOURCE =
      ResourceDescription.builder().name("client-identity").description("client-identity").build();
  ...
  void registerResource(@Observes @Priority(10) final StartupEvent ev) {
    ...
    rbac.registerResourceField(RESOURCE,
        FieldDescription.builder().name("user").description("El user de client identity").build());
    rbac.registerResourceField(RESOURCE, FieldDescription.builder().name("relyingParty")
        .description("El relying party de client identity").build());
    rbac.registerResourceField(RESOURCE, FieldDescription.builder().name("trustedClient")
        .description("El trusted client de client identity").build());
    rbac.registerResourceField(RESOURCE, FieldDescription.builder().name("roles")
        .description("El roles de client identity").build());
    rbac.registerResourceField(RESOURCE,
