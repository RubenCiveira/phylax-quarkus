...
@Getter
public class UserIdentityListProjection {
   ...
   * @return
   */
  public static UserIdentityListProjection from(final UserIdentityVisibleProjection visible) {
    UserIdentityListProjection instance = new UserIdentityListProjection();
   ...
   */
  public UserIdentityListProjection(final UserIdentity entity) {
