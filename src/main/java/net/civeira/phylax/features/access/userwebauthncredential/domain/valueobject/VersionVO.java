...
/**
 * Value Object representing campo con el número de version de user webauthn credential para
 * controlar bloqueos optimistas of userWebauthnCredential.
 * <p>
...
public class VersionVO {
   ...
   * @return An empty instance
   */
  public static <T extends AbstractFailList> VersionVO tryFromString(final String version,
      final T fails) {
    return NumericLoad.toInt("version", version, fails).map(value -> tryFrom(value, fails))
        .orElse(null);
  }
