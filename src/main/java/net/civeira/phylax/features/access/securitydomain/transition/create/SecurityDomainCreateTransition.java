...
@Builder
@Data
public class SecurityDomainCreateTransition {
   ...
   * @return
   */
  public SecurityDomainCreateTransition map(final SecurityDomainChangeProposal newData) {
    SecurityDomainCreateTransition transition =
        SecurityDomainCreateTransition.builder().data(newData).build();
