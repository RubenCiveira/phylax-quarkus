...
@Getter
public class RoleListProjection {
     ...
     * @return
     */
    public static RoleListProjection from(final RoleVisibleProjection visible) {
        RoleListProjection instance = new RoleListProjection();
     ...
     */
    public RoleListProjection(final Role entity) {
