...
@Getter
public class TenantLoginProviderEnableProjection {
   ...
   * @return
   */
  public static TenantLoginProviderEnableProjection from(
      final TenantLoginProviderVisibleProjection visible) {
    TenantLoginProviderEnableProjection instance = new TenantLoginProviderEnableProjection();
   ...
   */
  public TenantLoginProviderEnableProjection(final TenantLoginProvider entity) {
