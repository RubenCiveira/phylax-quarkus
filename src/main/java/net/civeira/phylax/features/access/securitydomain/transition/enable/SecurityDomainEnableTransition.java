...
@Builder
@Data
public class SecurityDomainEnableTransition {
   ...
   * @return
   */
  public SecurityDomainEnableTransition map(final SecurityDomainChangeProposal newData) {
    SecurityDomainEnableTransition transition =
        SecurityDomainEnableTransition.builder().data(newData).build();
