...
import net.civeira.phylax.features.access.role.application.service.visibility.RoleFixedFieldsProposal;
...
public class NonEditableTenant {
   ...
   * @param fixed
   */
  public void fixedFields(@Observes RoleFixedFieldsProposal fixed) {
