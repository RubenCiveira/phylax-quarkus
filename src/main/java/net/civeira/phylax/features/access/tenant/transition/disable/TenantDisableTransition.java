...
@Builder
@Data
public class TenantDisableTransition {
   ...
   * @return
   */
  public TenantDisableTransition map(final TenantChangeProposal newData) {
    TenantDisableTransition transition = TenantDisableTransition.builder().data(newData).build();
