...
@Getter
public class UserGroupMembershipUpdateProjection {
   ...
   * @return
   */
  public static UserGroupMembershipUpdateProjection from(
      final UserGroupMembershipVisibleProjection visible) {
    UserGroupMembershipUpdateProjection instance = new UserGroupMembershipUpdateProjection();
   ...
   */
  public UserGroupMembershipUpdateProjection(final UserGroupMembership entity) {
