...
public class RoleCreateInput {
    ...
    static RoleCreateInput fromChangeSet(final RoleChangeSet input) {
        return RoleCreateInput.builder().uid(input.getUidValue()).name(input.getNameValue()).relyingParty(input.getRelyingPartyValue()).version(input.getVersionValue()).build();
    }
