...
public class RoleCreateUsecase {
    ...
    public RoleCreateProjection create(final Interaction query, final RoleCreateInput input) {
        ...
        RoleCreateInput filled = RoleCreateInput.fromChangeSet(visibility.copyWithFixed(query, input.toChangeSet()));
        ...
        Role created = gateway.create(entity, attempt -> visibility.checkVisibility(query, attempt.getUid()));
    ...
    private Allow checkAllow(final Interaction query) {
        RoleCreateAllowDecision proposal = RoleCreateAllowDecision.builder().detail(Allow.builder().allowed(true).description("Allow by default").build()).query(query).build();
