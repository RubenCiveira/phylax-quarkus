...
@Builder
@Data
public class UserAccessTemporalCodeMarkLoginBlockTransition {
   ...
   * @return
   */
  public UserAccessTemporalCodeMarkLoginBlockTransition map(
      final UserAccessTemporalCodeChangeProposal newData) {
    UserAccessTemporalCodeMarkLoginBlockTransition transition =
        UserAccessTemporalCodeMarkLoginBlockTransition.builder().data(newData).build();
