...
@Getter
@AllArgsConstructor
public class UserRoleAssignamentCreateEnrich {
   ...
   */
  @NonNull
  private UserRoleAssignamentCreateInput input;

  /**
   * @autogenerated CreateEnrichGenerator
   * @param mapper
   */
  public void map(UnaryOperator<UserRoleAssignamentCreateInput> mapper) {
