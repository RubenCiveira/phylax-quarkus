...
/**
 * Visible projection events happen when a dto is filled throught an existint entity when the visibility service is preparing to send at user.The programmers could add policies to fill dto values to show to user at the application level.
 */
@NoArgsConstructor
@AllArgsConstructor
@Builder
public class RoleVisibleProjection {
     ...
     * @return A reference if the direct reference build from stored value, otherwise an exception will be thrown.
     */
    ...
    /**
     * Unset a value by the property name. Unset values will no provide command change neither provide information to the output context (hidden or readonly fields, or policy restrictions).
     *
     * @autogenerated VisibleProjectionGenerator
