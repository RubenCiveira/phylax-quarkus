...
@Getter
public class PlatformIdentityListProjection {
   ...
   * @return
   */
  public static PlatformIdentityListProjection from(
      final PlatformIdentityVisibleProjection visible) {
    PlatformIdentityListProjection instance = new PlatformIdentityListProjection();
   ...
   */
  public PlatformIdentityListProjection(final PlatformIdentity entity) {
