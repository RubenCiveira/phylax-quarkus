...
public class UserAcceptedTermnsOfUseRepository {
   ...
   * @autogenerated RepositoryJdbcGenerator
   */
  private static final String ACCESS_USER_ACCEPTED_TERMNS_OF_USE_IP_ADDRESS =
      "access_user_accepted_termns_of_use.ip_address";
   ...
   * @autogenerated RepositoryJdbcGenerator
   */
  private static final String ACCESS_USER_ACCEPTED_TERMNS_OF_USE_USER_AGENT =
      "access_user_accepted_termns_of_use.user_agent";

  /**
   * @autogenerated RepositoryJdbcGenerator
   */
  private static final String ACCESS_USER_ACCEPTED_TERMNS_OF_USE_USER_TENANT =
      "access_user_accepted_termns_of_use_user.tenant";
  ...
  public UserAcceptedTermnsOfUse update(UserAcceptedTermnsOfUse entity) {
    try (SqlTemplate template = new SqlTemplate(datasource, tracer)) {
      SqlCommand sq = template.createSqlCommand(
          "update \"access_user_accepted_termns_of_use\" set  \"user\" = :user, \"conditions\" = :conditions, \"accept_date\" = :acceptDate, \"ip_address\" = :ipAddress, \"user_agent\" = :userAgent, \"version\" = \"version\" + 1 where \"uid\" = :uid and \"version\" = :version");
      sq.with(UID, SqlParameterValue.of(entity.getUid()));
  ...
  private <T> SqlSchematicQuery<T> filteredQuery(SqlTemplate template,
    ...
    sq.selectFields(ACCESS_USER_ACCEPTED_TERMNS_OF_USE_UID, ACCESS_USER_ACCEPTED_TERMNS_OF_USE_USER,
        ...
        ACCESS_USER_ACCEPTED_TERMNS_OF_USE_ACCEPT_DATE,
        ACCESS_USER_ACCEPTED_TERMNS_OF_USE_IP_ADDRESS,
        ACCESS_USER_ACCEPTED_TERMNS_OF_USE_USER_AGENT, ACCESS_USER_ACCEPTED_TERMNS_OF_USE_VERSION);
  ...
  private UserAcceptedTermnsOfUse runCreate(UserAcceptedTermnsOfUse entity,
    ...
    try (SqlTemplate template = new SqlTemplate(datasource, tracer)) {
      SqlCommand sq = template.createSqlCommand(
          "insert into \"access_user_accepted_termns_of_use\" ( \"uid\", \"user\", \"conditions\", \"accept_date\", \"ip_address\", \"user_agent\", \"version\") values ( :uid, :user, :conditions, :acceptDate, :ipAddress, :userAgent, :version)");
      sq.with(UID, SqlParameterValue.of(entity.getUid()));
      sq.with(USER, SqlParameterValue.of(entity.getUserUid()));
      sq.with(CONDITIONS, SqlParameterValue.of(entity.getConditionsUid()));
      sq.with(ACCEPT_DATE, entity.getAcceptDate().map(SqlParameterValue::of)
