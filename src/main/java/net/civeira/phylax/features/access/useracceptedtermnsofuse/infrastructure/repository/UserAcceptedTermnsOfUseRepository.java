...
public class UserAcceptedTermnsOfUseRepository {
   ...
   * @autogenerated RepositoryJdbcGenerator
   */
  private static final String USER_ACCEPTED_TERMNS_OF_USE_ACCEPT_DATE =
      "user_accepted_termns_of_use.accept_date";

  /**
   * @autogenerated RepositoryJdbcGenerator
   */
  private static final String USER_ACCEPTED_TERMNS_OF_USE_CONDITIONS =
      "user_accepted_termns_of_use.conditions";

  /**
   * @autogenerated RepositoryJdbcGenerator
   */
  private static final String USER_ACCEPTED_TERMNS_OF_USE_CONDITIONS_TENANT =
      "user_accepted_termns_of_use_conditions.tenant";

  /**
   * @autogenerated RepositoryJdbcGenerator
   */
  private static final String USER_ACCEPTED_TERMNS_OF_USE_SNAKE = "user_accepted_termns_of_use";

  /**
   * @autogenerated RepositoryJdbcGenerator
   */
  private static final String USER_ACCEPTED_TERMNS_OF_USE_UID = "user_accepted_termns_of_use.uid";

  /**
   * @autogenerated RepositoryJdbcGenerator
   */
  private static final String USER_ACCEPTED_TERMNS_OF_USE_USER = "user_accepted_termns_of_use.user";

  /**
   * @autogenerated RepositoryJdbcGenerator
   */
  private static final String USER_ACCEPTED_TERMNS_OF_USE_VERSION =
      "user_accepted_termns_of_use.version";
  ...
  public void delete(UserAcceptedTermnsOfUse entity) {
    try (SqlTemplate template = new SqlTemplate(datasource, tracer)) {
      SqlCommand sq = template
          .createSqlCommand("delete from \"user_accepted_termns_of_use\" where \"uid\" = :uid");
    ...
    return reference instanceof UserAcceptedTermnsOfUse userAcceptedTermnsOfUse
        ...
        : retrieve(reference.getUidValue(), Optional.empty())
            .orElseThrow(() -> new NotFoundException(
                "Trying to enrich inexistent UserAcceptedTermnsOfUse: " + reference.getUidValue()));
  }
   ...
   * @return
   */
  public UserAcceptedTermnsOfUse enrichForUpdate(UserAcceptedTermnsOfUseRef reference) {
    return reference instanceof UserAcceptedTermnsOfUse userAcceptedTermnsOfUse
        ? userAcceptedTermnsOfUse
  ...
  public UserAcceptedTermnsOfUse update(UserAcceptedTermnsOfUse entity) {
    try (SqlTemplate template = new SqlTemplate(datasource, tracer)) {
      SqlCommand sq = template.createSqlCommand(
          "update \"user_accepted_termns_of_use\" set  \"user\" = :user, \"conditions\" = :conditions, \"accept_date\" = :acceptDate, \"version\" = \"version\" + 1 where \"uid\" = :uid and \"version\" = :version");
      ...
      sq.with(CONDITIONS, SqlParameterValue.of(entity.getConditions().getReferenceValue()));
      sq.with(ACCEPT_DATE, entity.getAcceptDate().getValue().map(SqlParameterValue::of)
  ...
  private SqlConverter<UserAcceptedTermnsOfUse> converter() {
    return row -> {
      try {
        return Optional.of(UserAcceptedTermnsOfUse.builder().uid(UidVO.from(row.getString(UID)))
            .user(UserVO.fromReference(row.getString(USER)))
            .conditions(ConditionsVO.fromReference(row.getString(CONDITIONS)))
            .acceptDate(AcceptDateVO.from(null == row.getTimestamp(ACCEPT_DATE_SNAKE) ? null
  ...
  private <T> SqlSchematicQuery<T> filteredQuery(SqlTemplate template,
    ...
    SqlSchematicQuery<T> sq = template.createSqlSchematicQuery(USER_ACCEPTED_TERMNS_OF_USE_SNAKE);
    sq.selectFields(USER_ACCEPTED_TERMNS_OF_USE_UID, USER_ACCEPTED_TERMNS_OF_USE_USER,
        USER_ACCEPTED_TERMNS_OF_USE_CONDITIONS, USER_ACCEPTED_TERMNS_OF_USE_ACCEPT_DATE,
        USER_ACCEPTED_TERMNS_OF_USE_VERSION);
    ...
    filter.getConditions().ifPresent(conditions -> sq.where(CONDITIONS, SqlOperator.EQ,
        SqlParameterValue.of(conditions.getUidValue())));
    ...
    filter.getConditionsTenantTenantAccesible().ifPresent(conditionsTenantTenantAccesible -> {
      sq.join("tenant_terms_of_use", "user_accepted_termns_of_use_conditions",
          "user_accepted_termns_of_use.tenant-terms-of-use",
          "user_accepted_termns_of_use_conditions.uid");
      sq.where(USER_ACCEPTED_TERMNS_OF_USE_CONDITIONS_TENANT, SqlOperator.EQ,
  ...
  private UserAcceptedTermnsOfUse runCreate(UserAcceptedTermnsOfUse entity,
    ...
    try (SqlTemplate template = new SqlTemplate(datasource, tracer)) {
      SqlCommand sq = template.createSqlCommand(
          "insert into \"user_accepted_termns_of_use\" ( \"uid\", \"user\", \"conditions\", \"accept_date\", \"version\") values ( :uid, :user, :conditions, :acceptDate, :version)");
      sq.with(UID, SqlParameterValue.of(entity.getUid().getValue()));
      sq.with(USER, SqlParameterValue.of(entity.getUser().getReferenceValue()));
      sq.with(CONDITIONS, SqlParameterValue.of(entity.getConditions().getReferenceValue()));
      sq.with(ACCEPT_DATE, entity.getAcceptDate().getValue().map(SqlParameterValue::of)
  ...
  private UserAcceptedTermnsOfUse verified(boolean exists, UserAcceptedTermnsOfUse entity,
    ...
    if (exists) {
      ...
      template.createSqlCommand("delete from \"user_accepted_termns_of_use\" where \"uid\" = :uid")
