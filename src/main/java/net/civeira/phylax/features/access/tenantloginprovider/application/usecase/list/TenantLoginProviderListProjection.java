...
@Getter
public class TenantLoginProviderListProjection {
   ...
   * @return
   */
  public static TenantLoginProviderListProjection from(
      final TenantLoginProviderVisibleProjection visible) {
    TenantLoginProviderListProjection instance = new TenantLoginProviderListProjection();
   ...
   */
  public TenantLoginProviderListProjection(final TenantLoginProvider entity) {
