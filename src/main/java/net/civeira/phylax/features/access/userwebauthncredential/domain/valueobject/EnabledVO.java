...
/**
 * Value Object representing el enabled de user webauthn credential of userWebauthnCredential.
 * <p>
...
public class EnabledVO {
   ...
   * @param map
   */
  public void enabledToMap(final Map<String, String> map) {
    if (null != value) {
      map.put("enabled", Boolean.TRUE.equals(value) ? "true" : "false");
    }
  }
