...
public class TenantConfigRepository {
  ...
  private <T> SqlSchematicQuery<T> filteredQuery(SqlTemplate template, TenantConfigFilter filter) {
    ...
    sq.selectFields(ACCESS_TENANT_CONFIG_UID, ACCESS_TENANT_CONFIG_TENANT,
        ...
        ACCESS_TENANT_CONFIG_WEBAUTHN_ENABLED, ACCESS_TENANT_CONFIG_WEBAUTHN_RP_ID,
        ACCESS_TENANT_CONFIG_WEBAUTHN_RP_NAME, ACCESS_TENANT_CONFIG_WELLCOME_EMAIL,
        ACCESS_TENANT_CONFIG_REGISTERD_EMAIL, ACCESS_TENANT_CONFIG_DISABLED_USER_EMAIL,
        ACCESS_TENANT_CONFIG_ENABLED_USER_EMAIL, ACCESS_TENANT_CONFIG_ALLOW_RECOVER_PASS,
        ACCESS_TENANT_CONFIG_RECOVER_PASS_EMAIL, ACCESS_TENANT_CONFIG_VERSION);
