...
@Getter
public class UserEnableProjection {
   ...
   * @return
   */
  public static UserEnableProjection from(final UserVisibleProjection visible) {
    UserEnableProjection instance = new UserEnableProjection();
   ...
   */
  public UserEnableProjection(final User entity) {
