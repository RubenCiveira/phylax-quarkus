...
@Builder
@Data
public class TrustedClientUpdateTransition {
   ...
   * @return
   */
  public TrustedClientUpdateTransition map(final TrustedClientChangeProposal newData) {
    TrustedClientUpdateTransition transition =
        TrustedClientUpdateTransition.builder().data(newData).build();
