...
@Builder
@Data
public class ScopeAssignationCreateTransition {
   ...
   * @return
   */
  public ScopeAssignationCreateTransition map(final ScopeAssignationChangeProposal newData) {
    ScopeAssignationCreateTransition transition =
        ScopeAssignationCreateTransition.builder().data(newData).build();
