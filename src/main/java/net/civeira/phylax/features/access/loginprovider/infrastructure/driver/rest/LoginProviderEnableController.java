...
import net.civeira.phylax.features.access.loginprovider.application.usecase.enable.LoginProviderEnableFilter;
import net.civeira.phylax.features.access.loginprovider.application.usecase.enable.LoginProviderEnableProjection;
...
public class LoginProviderEnableController {
  ...
  public Response loginProviderApiBatchEnable(final List<String> uids, final String search,
    ...
    LoginProviderEnableFilter.LoginProviderEnableFilterBuilder filterBuilder =
        LoginProviderEnableFilter.builder();
    filterBuilder =
    ...
    LoginProviderEnableFilter filter = filterBuilder.build();
  ...
  public Response loginProviderApiEnable(final String uid) {
    LoginProviderEnableProjection updated =
   ...
   * @return
   */
  private LoginProviderApiDto toApiModel(LoginProviderEnableProjection dto) {
