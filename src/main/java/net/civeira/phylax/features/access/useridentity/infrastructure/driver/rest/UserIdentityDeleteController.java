...
public class UserIdentityDeleteController {
   ...
   * @return
   */
  @ApiObserved("Api to delete on massive entity of user identity")
   ...
   * @return
   */
  @ApiObserved("Api to check masive delete on entity of user identity")
   ...
   */
  @Transactional
  @ApiObserved("Api to delete an entity of user identity")
