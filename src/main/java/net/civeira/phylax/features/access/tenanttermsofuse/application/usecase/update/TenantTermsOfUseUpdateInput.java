...
public class TenantTermsOfUseUpdateInput {
  ...
  public static class TenantTermsOfUseUpdateInputBuilder {
     ...
     * @return Self instance to continue with a flow build
     */
    public TenantTermsOfUseUpdateInputBuilder enabled(final Boolean enabled) {
     ...
     * @return Self instance to continue with a flow build
     */
    public TenantTermsOfUseUpdateInputBuilder enabled(final Optional<EnabledVO> enabled) {
     ...
     * @return Self instance to continue with a flow build
     */
    public TenantTermsOfUseUpdateInputBuilder relyingParty(final RelyingPartyRef relyingParty) {
     ...
     * @return Self instance to continue with a flow build
     */
    public TenantTermsOfUseUpdateInputBuilder relyingParty(
  ...
  static TenantTermsOfUseUpdateInput fromChangeSet(final TenantTermsOfUseChangeSet input) {
    return TenantTermsOfUseUpdateInput.builder().uid(input.getUidValue())
   ...
   * @return self instance to enable a flow code
   */
  public TenantTermsOfUseUpdateInput setEnabled(final Boolean value) {
   ...
   * @return self instance to enable a flow code
   */
  public TenantTermsOfUseUpdateInput setRelyingParty(final RelyingPartyRef value) {
