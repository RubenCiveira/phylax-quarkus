...
public class TenantTermsOfUse implements TenantTermsOfUseRef {
  ...
  public static TenantTermsOfUse create(final TenantTermsOfUseWriteAttributes attributes,
      final TenantTermsOfUseCreatePipeline pipeline) {
    return pipeline.create(attributes, attr -> {
      TenantTermsOfUse instance = new TenantTermsOfUse(attr, Optional.empty());
   ...
   * @return
   */
  public TenantTermsOfUse delete(final TenantTermsOfUseDeletePipeline pipeline) {
  ...
  public TenantTermsOfUse update(final TenantTermsOfUseWriteAttributes attributes,
      final TenantTermsOfUseUpdatePipeline pipeline) {
