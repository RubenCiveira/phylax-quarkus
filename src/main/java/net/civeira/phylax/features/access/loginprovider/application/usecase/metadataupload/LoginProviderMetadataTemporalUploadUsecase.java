...
public class LoginProviderMetadataTemporalUploadUsecase {
   ...
   * @autogenerated ListUsecaseGenerator
   */
  private final Event<LoginProviderAllowMetadataTemporalUploadProposal> tempUploadAllowEmitter;
  ...
  public Allow allow(final Interaction query) {
    LoginProviderAllowMetadataTemporalUploadProposal base =
        LoginProviderAllowMetadataTemporalUploadProposal.builder()
