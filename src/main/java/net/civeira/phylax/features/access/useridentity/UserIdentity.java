...
public class UserIdentity implements UserIdentityRef {
  ...
  public static UserIdentity create(final UserIdentityWriteAttributes attributes,
      final UserIdentityCreatePipeline pipeline) {
    return pipeline.create(attributes, attr -> {
      UserIdentity instance = new UserIdentity(attr, Optional.empty());
   ...
   * @return
   */
  public UserIdentity delete(final UserIdentityDeletePipeline pipeline) {
  ...
  public UserIdentity update(final UserIdentityWriteAttributes attributes,
      final UserIdentityUpdatePipeline pipeline) {
    return pipeline.update(attributes, this, attr -> {
      UserIdentity instance = new UserIdentity(attr, Optional.of(this));
