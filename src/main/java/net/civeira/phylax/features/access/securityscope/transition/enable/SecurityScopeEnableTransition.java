...
@Builder
@Data
public class SecurityScopeEnableTransition {
   ...
   * @return
   */
  public SecurityScopeEnableTransition map(final SecurityScopeChangeProposal newData) {
    SecurityScopeEnableTransition transition =
        SecurityScopeEnableTransition.builder().data(newData).build();
