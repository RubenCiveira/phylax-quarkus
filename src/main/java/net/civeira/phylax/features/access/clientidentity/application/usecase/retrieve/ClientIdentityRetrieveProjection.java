...
@Getter
public class ClientIdentityRetrieveProjection {
   ...
   * @return
   */
  public static ClientIdentityRetrieveProjection from(
      final ClientIdentityVisibleProjection visible) {
    ClientIdentityRetrieveProjection instance = new ClientIdentityRetrieveProjection();
   ...
   */
  public ClientIdentityRetrieveProjection(final ClientIdentity entity) {
