...
public class RoleUpdateInput {
    ...
    static RoleUpdateInput fromChangeSet(final RoleChangeSet input) {
        return RoleUpdateInput.builder().uid(input.getUidValue()).name(input.getNameValue()).relyingParty(input.getRelyingPartyValue()).version(input.getVersionValue()).build();
    }
     ...
     *
     * @autogenerated UpdateInputGenerator
     * @return empty if there is no change proposal for RelyingParty, otherwise the value for RelyingParty
     */
