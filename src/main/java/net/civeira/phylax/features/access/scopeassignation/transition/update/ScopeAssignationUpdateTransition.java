...
@Builder
@Data
public class ScopeAssignationUpdateTransition {

  /**
   * @autogenerated UpdateEntityRuleGenerator
   */
  private final ScopeAssignationChangeProposal data;
   ...
   * @autogenerated UpdateEntityRuleGenerator
   */
  private final ScopeAssignation original;
   ...
   * @return
   */
  public ScopeAssignationUpdateTransition map(final ScopeAssignationChangeProposal newData) {
    ScopeAssignationUpdateTransition transition =
        ScopeAssignationUpdateTransition.builder().data(newData).build();
