...
@Getter
public class TenantLoginProviderUpdateProjection {
   ...
   * @return
   */
  public static TenantLoginProviderUpdateProjection from(
      final TenantLoginProviderVisibleProjection visible) {
    TenantLoginProviderUpdateProjection instance = new TenantLoginProviderUpdateProjection();
   ...
   */
  public TenantLoginProviderUpdateProjection(final TenantLoginProvider entity) {
