...
@AllArgsConstructor
@Builder
public class UserRoleAssignamentUpdateInput {

  /**
   * @autogenerated UpdateInputGenerator
   */
  public static class UserRoleAssignamentUpdateInputBuilder {

    /**
     * @autogenerated UpdateInputGenerator
     * @return
     */
    public UserRoleAssignamentUpdateInputBuilder newUid() {
     ...
     */
    public UserRoleAssignamentUpdateInputBuilder relyingParty(final RelyingPartyRef relyingParty) {
     ...
     * @return Self instance to continue with a flow build
     */
    public UserRoleAssignamentUpdateInputBuilder relyingParty(
     ...
     * @return Self instance to continue with a flow build
     */
    public UserRoleAssignamentUpdateInputBuilder roles(final List<Roles> roles) {
     ...
     * @return Self instance to continue with a flow build
     */
    public UserRoleAssignamentUpdateInputBuilder roles(final Optional<RolesVO> roles) {
     ...
     * @return Self instance to continue with a flow build
     */
    public UserRoleAssignamentUpdateInputBuilder trustedClient(
     ...
     * @return Self instance to continue with a flow build
     */
    public UserRoleAssignamentUpdateInputBuilder uid(final String uid) {
     ...
     * @return Self instance to continue with a flow build
     */
    public UserRoleAssignamentUpdateInputBuilder uid(final Optional<UidVO> uid) {
      this.uid$value = uid;
      this.uid$set = true;
      return this;
    }
     ...
     * @return Self instance to continue with a flow build
     */
    public UserRoleAssignamentUpdateInputBuilder user(final UserRef user) {
     ...
     * @return Self instance to continue with a flow build
     */
    public UserRoleAssignamentUpdateInputBuilder user(final Optional<UserVO> user) {
     ...
     * @return Self instance to continue with a flow build
     */
    public UserRoleAssignamentUpdateInputBuilder version(final Integer version) {
     ...
     * @return Self instance to continue with a flow build
     */
    public UserRoleAssignamentUpdateInputBuilder version(final Optional<VersionVO> version) {
   ...
   * @return
   */
  static UserRoleAssignamentUpdateInput fromChangeSet(final UserRoleAssignamentChangeSet input) {
    return UserRoleAssignamentUpdateInput.builder().uid(input.getUidValue())
        .user(input.getUserValue()).relyingParty(input.getRelyingPartyValue())
        .trustedClient(input.getTrustedClientValue()).roles(input.getRolesValue())
   ...
   *
   * @autogenerated UpdateInputGenerator
   * @param value The proposal value for UserRoleAssignamentUpdateInput
   * @return self instance to enable a flow code
   */
  public UserRoleAssignamentUpdateInput setRelyingParty(final RelyingPartyRef value) {
   ...
   * @return self instance to enable a flow code
   */
  public UserRoleAssignamentUpdateInput setRoles(final List<Roles> value) {
   ...
   * @return self instance to enable a flow code
   */
  public UserRoleAssignamentUpdateInput setTrustedClient(final TrustedClientRef value) {
   ...
   * @return self instance to enable a flow code
   */
  public UserRoleAssignamentUpdateInput setUid(final String value) {
   ...
   * @return self instance to enable a flow code
   */
  public UserRoleAssignamentUpdateInput setUser(final UserRef value) {
   ...
   * @return self instance to enable a flow code
   */
  public UserRoleAssignamentUpdateInput setVersion(final Integer value) {
   ...
   * @return
   */
  UserRoleAssignamentChangeSet toChangeSet() {
    return new UserRoleAssignamentChangeSet().uid(uid).user(user).relyingParty(relyingParty)
