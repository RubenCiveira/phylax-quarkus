...
@Getter
public class UserGroupMembershipListProjection {
   ...
   * @return
   */
  public static UserGroupMembershipListProjection from(
      final UserGroupMembershipVisibleProjection visible) {
    UserGroupMembershipListProjection instance = new UserGroupMembershipListProjection();
   ...
   */
  public UserGroupMembershipListProjection(final UserGroupMembership entity) {
