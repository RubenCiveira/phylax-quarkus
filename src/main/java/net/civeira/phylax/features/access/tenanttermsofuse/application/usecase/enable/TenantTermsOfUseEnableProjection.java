...
@Getter
public class TenantTermsOfUseEnableProjection {
   ...
   * @return
   */
  public static TenantTermsOfUseEnableProjection from(
      final TenantTermsOfUseVisibleProjection visible) {
    TenantTermsOfUseEnableProjection instance = new TenantTermsOfUseEnableProjection();
   ...
   */
  public TenantTermsOfUseEnableProjection(final TenantTermsOfUse entity) {
