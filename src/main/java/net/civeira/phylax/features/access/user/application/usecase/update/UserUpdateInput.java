...
public class UserUpdateInput {
  ...
  public static class UserUpdateInputBuilder {
    ...
    /**
     * Append EmailVerified crud value and convert as value object.
     *
     * @autogenerated UpdateInputGenerator
     * @param emailVerified The EmailVerified value to wrap in a value object.
     * @return Self instance to continue with a flow build
     */
    public UserUpdateInputBuilder emailVerified(final Boolean emailVerified) {
      return emailVerified(Optional.of(EmailVerifiedVO.from(emailVerified)));
    }

    /**
     * Append EmailVerified value
     *
     * @autogenerated UpdateInputGenerator
     * @param emailVerified The value object with the information.
     * @return Self instance to continue with a flow build
     */
    public UserUpdateInputBuilder emailVerified(final Optional<EmailVerifiedVO> emailVerified) {
  ...
  static UserUpdateInput fromChangeSet(final UserChangeSet input) {
    return UserUpdateInput.builder().uid(input.getUidValue()).tenant(input.getTenantValue())
        ...
        .wellcomeAt(input.getWellcomeAtValue()).emailVerified(input.getEmailVerifiedValue())
        .enabled(input.getEnabledValue()).approve(input.getApproveValue())
        .temporalPassword(input.getTemporalPasswordValue())
  ...
  /**
   * Indicates whether the user has confirmed ownership of their email address by clicking the
   * verification link sent at registration. Used by the OIDC flow to emit the email_verified claim
   * and optionally block login until confirmed.
   *
   * @autogenerated UpdateInputGenerator
   */
  @Builder.Default
  private Optional<EmailVerifiedVO> emailVerified = Optional.empty();
  ...
  /**
   * Inform for a possible change propolsal in EmailVerified
   *
   * @autogenerated UpdateInputGenerator
   * @return empty if there is no change proposal for EmailVerified, otherwise the value for
   *         EmailVerified
   */
  public Optional<EmailVerifiedVO> getEmailVerified() {
  ...
  /**
   * Assigna change proposal for EmailVerified to be apply for the aggregate.
   *
   * @autogenerated UpdateInputGenerator
   * @param value The proposal value for UserUpdateInput
   * @return self instance to enable a flow code
   */
  public UserUpdateInput setEmailVerified(final Boolean value) {
    this.emailVerified = Optional.of(EmailVerifiedVO.from(value));
    return this;
  }
  ...
  UserChangeSet toChangeSet() {
    return new UserChangeSet().uid(uid).tenant(tenant).name(name).password(password).email(email)
        .wellcomeAt(wellcomeAt).emailVerified(emailVerified).enabled(enabled).approve(approve)
