...
public class RecoveryCodeExpirationVO {
   ...
   * @return An empty instance
   */
  public static <T extends AbstractFailList> RecoveryCodeExpirationVO tryFromString(
      final String recoveryCodeExpiration, final T fails) {
    return DateLoad.toOffsetDateTime(ZoneId.systemDefault(), "recoveryCodeExpiration",
        recoveryCodeExpiration, fails).map(value -> tryFrom(value, fails)).orElse(null);
  }
   ...
   * @param map
   */
  public void recoveryCodeExpirationToMap(final Map<String, String> map) {
    if (null != value) {
      map.put("recoveryCodeExpiration", String.valueOf(value));
    }
  }
