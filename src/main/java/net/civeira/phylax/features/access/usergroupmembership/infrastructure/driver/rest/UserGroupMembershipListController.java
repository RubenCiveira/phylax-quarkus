...
import net.civeira.phylax.features.access.usergroupmembership.application.usecase.list.UserGroupMembershipListCursor;
import net.civeira.phylax.features.access.usergroupmembership.application.usecase.list.UserGroupMembershipListFilter;
import net.civeira.phylax.features.access.usergroupmembership.application.usecase.list.UserGroupMembershipListProjection;
...
import net.civeira.phylax.generated.openapi.model.UserGroupMembershipApiDtoList;

@RequiredArgsConstructor
@ApplicationScoped
public class UserGroupMembershipListController {
   ...
   * @return
   */
  @ApiObserved("Api to list an entity of user group membership")
  public Response userGroupMembershipApiList(final List<String> uids, final String search,
    ...
    UserGroupMembershipListFilter.UserGroupMembershipListFilterBuilder filterBuilder =
        UserGroupMembershipListFilter.builder();
    UserGroupMembershipListCursor.UserGroupMembershipListCursorBuilder cursorBuilder =
        UserGroupMembershipListCursor.builder();
    ...
    UserGroupMembershipListFilter filter = filterBuilder.build();
    UserGroupMembershipListCursor cursor = cursorBuilder.build();
    List<UserGroupMembershipListProjection> listed =
    ...
    return currentRequest.cacheableResponse(listed, toListApiModel(listed, filter, cursor),
        "user-group-membership-" + ("" + filter + cursor).hashCode());
  }
   ...
   * @return
   */
  private UserGroupMembershipApiDto toApiModel(UserGroupMembershipListProjection dto) {
   ...
   * @return
   */
  private UserGroupMembershipApiDtoList toListApiModel(
      List<UserGroupMembershipListProjection> userGroupMemberships,
      UserGroupMembershipListFilter filter, UserGroupMembershipListCursor cursor) {
    Optional<UserGroupMembershipListProjection> last =
        userGroupMemberships.isEmpty() ? Optional.empty()
            : Optional.of(userGroupMemberships.get(userGroupMemberships.size() - 1));
    ...
    return new UserGroupMembershipApiDtoList()
        .items(userGroupMemberships.stream().map(this::toApiModel).toList())
