...
@Builder
@Data
public class TenantTermsOfUseUpdateTransition {
   ...
   * @return
   */
  public TenantTermsOfUseUpdateTransition map(final TenantTermsOfUseChangeProposal newData) {
    TenantTermsOfUseUpdateTransition transition =
        TenantTermsOfUseUpdateTransition.builder().data(newData).build();
