...
import net.civeira.phylax.features.access.platformidentity.application.visibility.PlatformIdentityVisibleProjection;
...
@Getter
public class PlatformIdentityRetrieveProjection {
   ...
   * @return
   */
  public static PlatformIdentityRetrieveProjection from(
      final PlatformIdentityVisibleProjection visible) {
    PlatformIdentityRetrieveProjection instance = new PlatformIdentityRetrieveProjection();
   ...
   */
  public PlatformIdentityRetrieveProjection(final PlatformIdentity entity) {
