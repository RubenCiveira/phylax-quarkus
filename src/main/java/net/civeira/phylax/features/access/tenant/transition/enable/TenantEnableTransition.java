...
@Builder
@Data
public class TenantEnableTransition {
   ...
   * @return
   */
  public TenantEnableTransition map(final TenantChangeProposal newData) {
    TenantEnableTransition transition = TenantEnableTransition.builder().data(newData).build();
