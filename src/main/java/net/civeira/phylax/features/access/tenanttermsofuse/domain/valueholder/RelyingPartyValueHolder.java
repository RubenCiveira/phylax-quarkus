...
public class RelyingPartyValueHolder<T> {
   ...
   * @return
   */
  public RelyingPartyVO readRelyingParty(final Optional<TenantTermsOfUse> original,
      final ConstraintFailList fails) {
    return value.orElse(
        original.map(TenantTermsOfUse::getRelyingPartyValue).orElseGet(RelyingPartyVO::nullValue));
  }
