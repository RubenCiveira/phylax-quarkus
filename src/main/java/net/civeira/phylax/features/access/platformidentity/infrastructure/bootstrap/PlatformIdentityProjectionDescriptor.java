...
@ApplicationScoped
public class PlatformIdentityProjectionDescriptor implements ProjectionDescriptor {

  /**
   * @autogenerated ProjectionDescriptorGeneratorGenerator
   */
  public static class PlatformIdentityExecutionPlanner {
     ...
     * @autogenerated ProjectionDescriptorGeneratorGenerator
     */
    public PlatformIdentityExecutionPlanner() {
      this.prefix = "";
    }
     ...
     * @param prefix
     */
    public PlatformIdentityExecutionPlanner(final String prefix) {
      this.prefix = prefix + ".";
    }
     ...
     * @return
     */
    public PlatformIdentityExecutionPlanner withRelyingParty() {
     ...
     * @return
     */
    public PlatformIdentityExecutionPlanner withRelyingParty(final String alias) {
     ...
     * @return
     */
    public PlatformIdentityExecutionPlanner withRoles() {
     ...
     * @return
     */
    public PlatformIdentityExecutionPlanner withRoles(final String alias) {
      aggregation.add(
     ...
     * @return
     */
    public PlatformIdentityExecutionPlanner withTrustedClient() {
     ...
     * @return
     */
    public PlatformIdentityExecutionPlanner withTrustedClient(final String alias) {
     ...
     * @return
     */
    public PlatformIdentityExecutionPlanner withUid() {
     ...
     * @return
     */
    public PlatformIdentityExecutionPlanner withUid(final String alias) {
      aggregation.add(
     ...
     * @return
     */
    public PlatformIdentityExecutionPlanner withUser() {
     ...
     * @return
     */
    public PlatformIdentityExecutionPlanner withUser(final String alias) {
     ...
     * @return
     */
    public PlatformIdentityExecutionPlanner withVersion() {
     ...
     * @return
     */
    public PlatformIdentityExecutionPlanner withVersion(final String alias) {
      aggregation.add(
  ...
  public List<ExecutionNode> baseNodes(final String baseServer) {
    ...
    return List.of(
        ExecutionNode.builder().server(baseServer).endpoint("/api/access/platform-identity")
            .method("GET").list(true).params(Map.of()).relations(relations).build(),
        ExecutionNode.builder().server(baseServer).endpoint("/api/access/platform-identity/{uid}")
