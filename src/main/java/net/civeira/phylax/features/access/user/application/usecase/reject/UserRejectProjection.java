...
@Getter
public class UserRejectProjection {
   ...
   * @return
   */
  public static UserRejectProjection from(final UserVisibleProjection visible) {
    UserRejectProjection instance = new UserRejectProjection();
   ...
   */
  public UserRejectProjection(final User entity) {
