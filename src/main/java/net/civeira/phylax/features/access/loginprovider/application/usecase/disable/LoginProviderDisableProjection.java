...
@Getter
public class LoginProviderDisableProjection {
   ...
   * @return
   */
  public static LoginProviderDisableProjection from(final LoginProviderVisibleProjection visible) {
    LoginProviderDisableProjection instance = new LoginProviderDisableProjection();
   ...
   */
  public LoginProviderDisableProjection(final LoginProvider entity) {
