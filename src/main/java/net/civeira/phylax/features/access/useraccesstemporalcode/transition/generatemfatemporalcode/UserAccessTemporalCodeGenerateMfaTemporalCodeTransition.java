...
@Builder
@Data
public class UserAccessTemporalCodeGenerateMfaTemporalCodeTransition {
   ...
   */
  @NonNull
  private final String tempSecondFactorSeed;

  /**
   * @autogenerated UpdateEntityRuleGenerator
   */
  @NonNull
  private final OffsetDateTime tempSecondFactorSeedExpiration;
   ...
   * @return
   */
  public UserAccessTemporalCodeGenerateMfaTemporalCodeTransition map(
      final UserAccessTemporalCodeChangeProposal newData) {
    UserAccessTemporalCodeGenerateMfaTemporalCodeTransition transition =
        UserAccessTemporalCodeGenerateMfaTemporalCodeTransition.builder().data(newData).build();
