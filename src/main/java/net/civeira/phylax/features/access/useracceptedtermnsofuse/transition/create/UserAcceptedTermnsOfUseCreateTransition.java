...
@Builder
@Data
public class UserAcceptedTermnsOfUseCreateTransition {

  /**
   * @autogenerated UpdateEntityRuleGenerator
   */
  private final UserAcceptedTermnsOfUseChangeProposal data;
   ...
   * @return
   */
  public UserAcceptedTermnsOfUseCreateTransition map(
      final UserAcceptedTermnsOfUseChangeProposal newData) {
    UserAcceptedTermnsOfUseCreateTransition transition =
        UserAcceptedTermnsOfUseCreateTransition.builder().data(newData).build();
