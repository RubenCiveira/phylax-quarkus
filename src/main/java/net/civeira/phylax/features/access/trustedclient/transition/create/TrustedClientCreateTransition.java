...
@Builder
@Data
public class TrustedClientCreateTransition {
   ...
   * @return
   */
  public TrustedClientCreateTransition map(final TrustedClientChangeProposal newData) {
    TrustedClientCreateTransition transition =
        TrustedClientCreateTransition.builder().data(newData).build();
