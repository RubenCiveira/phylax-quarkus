...
public class TenantTermsOfUseEnableController {
   ...
   * @return
   */
  @Observed("Api to enable on massive entity of tenant terms of use")
   ...
   * @return
   */
  @Observed("Api to check masive enable on entity of tenant terms of use")
  public Response tenantTermsOfUseApiBatchEnableQuery(final String batchId) {
    BatchProgress task = enable.checkProgress(
        TenantTermsOfUseEnableStatus.builder().taskId(batchId).build(currentRequest.interaction()));
