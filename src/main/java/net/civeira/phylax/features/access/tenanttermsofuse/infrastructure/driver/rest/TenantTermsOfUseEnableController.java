...
public class TenantTermsOfUseEnableController {
   ...
   * @return
   */
  @ApiObserved("Api to enable on massive entity of tenant terms of use")
   ...
   * @return
   */
  @ApiObserved("Api to check masive enable on entity of tenant terms of use")
  public Response tenantTermsOfUseApiBatchEnableQuery(final String batchId) {
    BatchProgress task = enable.checkProgress(currentRequest.interaction(),
        TenantTermsOfUseEnableStatus.builder().taskId(batchId).build());
   ...
   */
  @Transactional
  @ApiObserved("Api to enable an entity of tenant terms of use")
  ...
  private TenantTermsOfUseApiDto toApiModel(TenantTermsOfUseEnableProjection dto) {
    ...
    if (null != attached) {
      String url = currentRequest.getPublicHost() + "/api/access/tenants-terms-of-use/"
          + dto.getUidOrDefault("-") + "/attached";
      tenantTermsOfUseApiDto.setAttached(magicLink.create(url, currentRequest.interaction()));
    }
