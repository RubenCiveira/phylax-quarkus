...
public class SecurityDomain implements SecurityDomainRef {
  ...
  public static SecurityDomain create(final SecurityDomainWriteAttributes attributes,
      final SecurityDomainCreatePipeline pipeline) {
    return pipeline.create(attributes, attr -> {
      SecurityDomain instance = new SecurityDomain(attr, Optional.empty());
   ...
   * @return
   */
  public SecurityDomain delete(final SecurityDomainDeletePipeline pipeline) {
   ...
   * @return
   */
  public SecurityDomain disable(final SecurityDomainDisablePipeline pipeline) {
   ...
   * @return
   */
  public SecurityDomain enable(final SecurityDomainEnablePipeline pipeline) {
  ...
  public SecurityDomain update(final SecurityDomainWriteAttributes attributes,
      final SecurityDomainUpdatePipeline pipeline) {
