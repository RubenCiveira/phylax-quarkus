...
@Getter
public class TenantLoginProviderCreateProjection {
   ...
   * @return
   */
  public static TenantLoginProviderCreateProjection from(
      final TenantLoginProviderVisibleProjection visible) {
    TenantLoginProviderCreateProjection instance = new TenantLoginProviderCreateProjection();
   ...
   */
  public TenantLoginProviderCreateProjection(final TenantLoginProvider entity) {
