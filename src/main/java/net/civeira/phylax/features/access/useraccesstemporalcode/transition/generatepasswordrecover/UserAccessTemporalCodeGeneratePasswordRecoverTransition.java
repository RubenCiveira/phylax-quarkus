...
@Builder
@Data
public class UserAccessTemporalCodeGeneratePasswordRecoverTransition {
   ...
   */
  @NonNull
  private final OffsetDateTime recoveryCodeExpiration;
   ...
   * @return
   */
  public UserAccessTemporalCodeGeneratePasswordRecoverTransition map(
      final UserAccessTemporalCodeChangeProposal newData) {
    UserAccessTemporalCodeGeneratePasswordRecoverTransition transition =
        UserAccessTemporalCodeGeneratePasswordRecoverTransition.builder().data(newData).build();
