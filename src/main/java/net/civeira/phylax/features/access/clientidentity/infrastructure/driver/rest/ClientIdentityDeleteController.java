...
import net.civeira.phylax.features.access.clientidentity.application.usecase.delete.ClientIdentityCheckBatchDeleteStatus;
import net.civeira.phylax.features.access.clientidentity.application.usecase.delete.ClientIdentityDeleteFilter;
...
@ApplicationScoped
public class ClientIdentityDeleteController {
   ...
   * @return
   */
  @ApiObserved("Api to delete on massive entity of client identity")
  public Response clientIdentityApiBatchDelete(final List<String> uids, final String search,
    ...
    ClientIdentityDeleteFilter.ClientIdentityDeleteFilterBuilder filterBuilder =
        ClientIdentityDeleteFilter.builder();
    filterBuilder =
    ...
    ClientIdentityDeleteFilter filter = filterBuilder.build();
   ...
   */
  @Transactional
  @ApiObserved("Api to delete an entity of client identity")
  public Response clientIdentityApiDelete(final String uid) {
    Trace.setAttribute("ref", uid);
    delete.delete(currentRequest.interaction(), ClientIdentityReference.of(uid));
