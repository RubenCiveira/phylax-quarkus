...
public class RelyingPartyValueHolder<T> {
     ...
     * @return
     */
    public RelyingPartyVO readRelyingParty(final Optional<Role> original, final ConstraintFailList fails) {
        return value.orElse(original.map(Role::getRelyingPartyValue).orElseGet(RelyingPartyVO::nullValue));
    }
    ...
    public T relyingParty(RelyingPartyChangeSet relyingParty) {
        value = Optional.of(RelyingPartyVO.from(RelyingPartyReference.of(relyingParty.getUid().orElseThrow())));
        return holder;
    }
