...
@Getter
@AllArgsConstructor
public class UserPersonalApiKeyCreateEnrich {
   ...
   */
  @NonNull
  private UserPersonalApiKeyCreateInput input;

  /**
   * @autogenerated CreateEnrichGenerator
   * @param mapper
   */
  public void map(UnaryOperator<UserPersonalApiKeyCreateInput> mapper) {
