...
public class Role implements RoleRef {
  ...
  public static Role create(final RoleWriteAttributes attributes,
      final RoleCreatePipeline pipeline) {
    return pipeline.create(attributes, attr -> {
      Role instance = new Role(attr, Optional.empty());
   ...
   * @return
   */
  public Role delete(final RoleDeletePipeline pipeline) {
   ...
   * @return
   */
  public Role update(final RoleWriteAttributes attributes, final RoleUpdatePipeline pipeline) {
    return pipeline.update(attributes, this, attr -> {
      Role instance = new Role(attr, Optional.of(this));
