...
@Getter
public class UserRoleAssignamentCreateProjection {
   ...
   * @return
   */
  public static UserRoleAssignamentCreateProjection from(
      final UserRoleAssignamentVisibleProjection visible) {
    UserRoleAssignamentCreateProjection instance = new UserRoleAssignamentCreateProjection();
   ...
   */
  public UserRoleAssignamentCreateProjection(final UserRoleAssignament entity) {
