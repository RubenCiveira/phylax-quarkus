...
import net.civeira.phylax.features.access.usergroupmembership.application.usecase.delete.UserGroupMembershipCheckBatchDeleteStatus;
import net.civeira.phylax.features.access.usergroupmembership.application.usecase.delete.UserGroupMembershipDeleteFilter;
...
@ApplicationScoped
public class UserGroupMembershipDeleteController {
   ...
   * @return
   */
  @ApiObserved("Api to delete on massive entity of user group membership")
  public Response userGroupMembershipApiBatchDelete(final List<String> uids, final String search,
    ...
    UserGroupMembershipDeleteFilter.UserGroupMembershipDeleteFilterBuilder filterBuilder =
        UserGroupMembershipDeleteFilter.builder();
    filterBuilder =
    ...
    UserGroupMembershipDeleteFilter filter = filterBuilder.build();
   ...
   * @return
   */
  @ApiObserved("Api to check masive delete on entity of user group membership")
  public Response userGroupMembershipApiBatchDeleteQuery(final String batchId) {
    BatchProgress task = delete.checkProgress(currentRequest.interaction(),
        UserGroupMembershipCheckBatchDeleteStatus.builder().taskId(batchId).build());
   ...
   */
  @Transactional
  @ApiObserved("Api to delete an entity of user group membership")
  public Response userGroupMembershipApiDelete(final String uid) {
    Trace.setAttribute("ref", uid);
    delete.delete(currentRequest.interaction(), UserGroupMembershipReference.of(uid));
