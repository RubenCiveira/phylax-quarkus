...
import net.civeira.phylax.features.access.user.application.service.visibility.UserFixedFieldsProposal;
...
public class NonEditableTenant {
   ...
   * @param fixed
   */
  public void fixedFields(@Observes UserFixedFieldsProposal fixed) {
