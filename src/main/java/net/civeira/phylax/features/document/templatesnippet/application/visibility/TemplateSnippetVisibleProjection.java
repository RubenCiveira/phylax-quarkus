...
@AllArgsConstructor
@Builder
public class TemplateSnippetVisibleProjection {
   ...
   */
  public TemplateSnippetVisibleProjection(final TemplateSnippet entity) {
  ...
  /**
   * Create a reference for template snippet with his inner assigned value.
   *
   * @autogenerated VisibleProjectionGenerator
   ...
   *         will be thrown.
   */
  public TemplateSnippetReference asReference() throws NoSuchElementException {
    return uid.map(UidVO::getUid).map(TemplateSnippetReference::of).orElseThrow();
  }
   ...
   *
   * @autogenerated VisibleProjectionGenerator
   * @param value The proposal value for TemplateSnippetVisibleProjection
   * @return self instance to enable a flow code
   */
  public TemplateSnippetVisibleProjection setCode(final String value) {
   ...
   * @return self instance to enable a flow code
   */
  public TemplateSnippetVisibleProjection setContentHtml(final String value) {
   ...
   * @return self instance to enable a flow code
   */
  public TemplateSnippetVisibleProjection setEnabled(final Boolean value) {
   ...
   * @return self instance to enable a flow code
   */
  public TemplateSnippetVisibleProjection setTenant(final TenantRef value) {
   ...
   * @return self instance to enable a flow code
   */
  public TemplateSnippetVisibleProjection setUid(final String value) {
   ...
   * @return self instance to enable a flow code
   */
  public TemplateSnippetVisibleProjection setVersion(final Integer value) {
   ...
   * @return self instance to enable a flow code.
   */
  public TemplateSnippetVisibleProjection unsetCode() {
   ...
   * @return self instance to enable a flow code.
   */
  public TemplateSnippetVisibleProjection unsetContentHtml() {
   ...
   * @return self instance to enable a flow code.
   */
  public TemplateSnippetVisibleProjection unsetEnabled() {
   ...
   * @return self instance to enable a flow code.
   */
  public TemplateSnippetVisibleProjection unsetTenant() {
   ...
   * @return self instance to enable a flow code.
   */
  public TemplateSnippetVisibleProjection unsetUid() {
   ...
   * @return self instance to enable a flow code.
   */
  public TemplateSnippetVisibleProjection unsetVersion() {
