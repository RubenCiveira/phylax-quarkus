...
import net.civeira.phylax.generated.openapi.api.TemplateVersionAuditApi;
import net.civeira.phylax.generated.openapi.model.AuditEventDto;

@RequiredArgsConstructor
@ApplicationScoped
public class TemplateVersionAuditController implements TemplateVersionAuditApi {
  ...
  private AuditEventDto map(final AuditEvent event) {
    return new AuditEventDto().operation(event.getOperation()).usecase(event.getUsecase())
        .entityType("templateVersion").entityType(event.getEntityType())
