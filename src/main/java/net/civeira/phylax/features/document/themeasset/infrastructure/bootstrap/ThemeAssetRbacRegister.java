...
public class ThemeAssetRbacRegister {

  /**
   * @autogenerated RegisterGeneratorGenerator
   */
  private static final ResourceDescription RESOURCE =
      ResourceDescription.builder().name("theme-asset").description("theme-asset").build();
  ...
  void registerResource(@Observes @Priority(10) final StartupEvent ev) {
    ...
    rbac.registerResourceAction(RESOURCE,
        ScopeDescription.builder().kind(Kind.READ).name("retrieve-upload-content")
            .description("El content de theme asset").required(List.of()).build());
    rbac.registerResourceAction(RESOURCE,
        ScopeDescription.builder().kind(Kind.WRITE).name("temp-upload-content")
            .description("El content de theme asset").required(List.of()).build());
    rbac.registerResourceField(RESOURCE,
        FieldDescription.builder().name("uid").description("El uid de theme asset").build());
    rbac.registerResourceField(RESOURCE,
        FieldDescription.builder().name("theme").description("El theme de theme asset").build());
    rbac.registerResourceField(RESOURCE, FieldDescription.builder().name("code")
        .description("logo, corporate.css, banner...").build());
    rbac.registerResourceField(RESOURCE,
    ...
    rbac.registerResourceField(RESOURCE, FieldDescription.builder().name("content")
        .description("El content de theme asset").build());
    rbac.registerResourceField(RESOURCE, FieldDescription.builder().name("enabled")
        .description("El enabled de theme asset").build());
    rbac.registerResourceField(RESOURCE,
