...
public class ThemeImportationService {
  ...
  public ThemeChangeSet toChangeSet(final Map<String, String> row, final ConstraintFailList fails,
    ...
    change = readCustomCss(change, row, fails, resolver);
    return change;
  }
   ...
   * @return
   */
  private ThemeChangeSet readCustomCss(final ThemeChangeSet change, final Map<String, String> row,
      final ConstraintFailList fails, final ThemeImportationRelatedResolver resolver) {
    String customCss = row.get("customCss");
    if (customCss != null) {
      return change.customCss(customCss);
    } else {
      return change.unsetCustomCss();
    }
  }
