...
import net.civeira.phylax.generated.openapi.api.SnippetVersionAuditApi;
import net.civeira.phylax.generated.openapi.model.AuditEventDto;

@RequiredArgsConstructor
@ApplicationScoped
public class SnippetVersionAuditController implements SnippetVersionAuditApi {
  ...
  private AuditEventDto map(final AuditEvent event) {
    return new AuditEventDto().operation(event.getOperation()).usecase(event.getUsecase())
        .entityType("snippetVersion").entityType(event.getEntityType())
