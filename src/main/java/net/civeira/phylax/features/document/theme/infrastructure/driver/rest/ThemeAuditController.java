...
import net.civeira.phylax.generated.openapi.api.ThemeAuditApi;
import net.civeira.phylax.generated.openapi.model.AuditEventDto;

@RequiredArgsConstructor
@ApplicationScoped
public class ThemeAuditController implements ThemeAuditApi {
  ...
  private AuditEventDto map(final AuditEvent event) {
    return new AuditEventDto().operation(event.getOperation()).usecase(event.getUsecase())
        .entityType("theme").entityType(event.getEntityType()).entityId(event.getEntityId())
