...
import net.civeira.phylax.features.document.templatevariable.application.usecase.enable.TemplateVariableEnableFilter;
import net.civeira.phylax.features.document.templatevariable.application.usecase.enable.TemplateVariableEnableProjection;
import net.civeira.phylax.features.document.templatevariable.application.usecase.enable.TemplateVariableEnableStatus;
...
@ApplicationScoped
public class TemplateVariableEnableController {
   ...
   * @return
   */
  @ApiObserved("Api to enable on massive entity of template variable")
  public Response templateVariableApiBatchEnable(final List<String> uids, final String search,
    ...
    TemplateVariableEnableFilter.TemplateVariableEnableFilterBuilder filterBuilder =
        TemplateVariableEnableFilter.builder();
    filterBuilder =
    ...
    TemplateVariableEnableFilter filter = filterBuilder.build();
   ...
   * @return
   */
  @ApiObserved("Api to check masive enable on entity of template variable")
  public Response templateVariableApiBatchEnableQuery(final String batchId) {
    BatchProgress task = enable.checkProgress(currentRequest.interaction(),
        TemplateVariableEnableStatus.builder().taskId(batchId).build());
   ...
   */
  @Transactional
  @ApiObserved("Api to enable an entity of template variable")
  public Response templateVariableApiEnable(final String uid) {
    Trace.setAttribute("ref", uid);
    TemplateVariableEnableProjection updated =
        enable.enable(currentRequest.interaction(), TemplateVariableReference.of(uid));
   ...
   * @return
   */
  private TemplateVariableApiDto toApiModel(TemplateVariableEnableProjection dto) {
