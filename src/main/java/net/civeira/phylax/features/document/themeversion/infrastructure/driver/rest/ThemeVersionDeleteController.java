...
import net.civeira.phylax.features.document.themeversion.application.usecase.delete.ThemeVersionCheckBatchDeleteStatus;
import net.civeira.phylax.features.document.themeversion.application.usecase.delete.ThemeVersionDeleteFilter;
...
@ApplicationScoped
public class ThemeVersionDeleteController {
   ...
   * @return
   */
  @ApiObserved("Api to delete on massive entity of theme version")
  public Response themeVersionApiBatchDelete(final List<String> uids, final String search,
    ...
    ThemeVersionDeleteFilter.ThemeVersionDeleteFilterBuilder filterBuilder =
        ThemeVersionDeleteFilter.builder();
    filterBuilder =
    ...
    ThemeVersionDeleteFilter filter = filterBuilder.build();
   ...
   * @return
   */
  @ApiObserved("Api to check masive delete on entity of theme version")
  public Response themeVersionApiBatchDeleteQuery(final String batchId) {
    BatchProgress task = delete.checkProgress(currentRequest.interaction(),
        ThemeVersionCheckBatchDeleteStatus.builder().taskId(batchId).build());
   ...
   */
  @Transactional
  @ApiObserved("Api to delete an entity of theme version")
  public Response themeVersionApiDelete(final String uid) {
    Trace.setAttribute("ref", uid);
    delete.delete(currentRequest.interaction(), ThemeVersionReference.of(uid));
