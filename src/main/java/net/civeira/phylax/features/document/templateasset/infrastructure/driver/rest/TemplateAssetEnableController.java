...
@ApplicationScoped
public class TemplateAssetEnableController {
  ...
  public Response templateAssetApiBatchEnable(final List<String> uids, final String search,
    ...
    TemplateAssetEnableFilter filter = filterBuilder.build();
   ...
   * @return
   */
  @ApiObserved("Api to check masive enable on entity of template asset")
  public Response templateAssetApiBatchEnableQuery(final String batchId) {
    BatchProgress task = enable.checkProgress(currentRequest.interaction(),
        TemplateAssetEnableStatus.builder().taskId(batchId).build());
   ...
   */
  @Transactional
  @ApiObserved("Api to enable an entity of template asset")
  public Response templateAssetApiEnable(final String uid) {
    Trace.setAttribute("ref", uid);
    TemplateAssetEnableProjection updated =
        enable.enable(currentRequest.interaction(), TemplateAssetReference.of(uid));
