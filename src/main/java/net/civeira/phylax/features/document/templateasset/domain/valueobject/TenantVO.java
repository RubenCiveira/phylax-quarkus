...
/**
 * Value Object representing null = asset global del template. Valor = override por tenant (logo
 * distinto por tenant en template global). of templateAsset.
 * <p>
...
public class TenantVO {
  ...
  public Optional<String> getTenantUid() {
    return Optional.ofNullable(value).map(TenantRef::getUid);
  }
   ...
   * @param map
   */
  public void tenantToMap(final Map<String, String> map) {
    if (null != value) {
      String uid = value.getUid();
      if (null != uid) {
        map.put("tenant", String.valueOf(uid));
      }
    }
  }
