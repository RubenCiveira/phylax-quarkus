...
public class ThemeVisibleProjection {
  ...
  public ThemeVisibleProjection(final Theme entity) {
    ...
    customCss = Optional.of(entity.getCustomCssValue());
   ...
   */
  public ThemeVisibleProjection setCustomCss(final String value) {
  ...
  /**
   * Remove the change propolsal for CustomCss
   *
   * @autogenerated VisibleProjectionGenerator
   * @return self instance to enable a flow code.
   */
  public ThemeVisibleProjection unsetCustomCss() {
    this.customCss = Optional.empty();
    return this;
  }
