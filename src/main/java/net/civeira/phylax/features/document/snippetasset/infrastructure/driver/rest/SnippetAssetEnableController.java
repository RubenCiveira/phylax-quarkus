...
import net.civeira.phylax.features.document.snippetasset.application.usecase.enable.SnippetAssetEnableFilter;
import net.civeira.phylax.features.document.snippetasset.application.usecase.enable.SnippetAssetEnableProjection;
import net.civeira.phylax.features.document.snippetasset.application.usecase.enable.SnippetAssetEnableStatus;
...
@ApplicationScoped
public class SnippetAssetEnableController {
   ...
   * @return
   */
  @ApiObserved("Api to enable on massive entity of snippet asset")
  public Response snippetAssetApiBatchEnable(final List<String> uids, final String search,
    ...
    SnippetAssetEnableFilter.SnippetAssetEnableFilterBuilder filterBuilder =
        SnippetAssetEnableFilter.builder();
    filterBuilder =
    ...
    SnippetAssetEnableFilter filter = filterBuilder.build();
   ...
   * @return
   */
  @ApiObserved("Api to check masive enable on entity of snippet asset")
  public Response snippetAssetApiBatchEnableQuery(final String batchId) {
    BatchProgress task = enable.checkProgress(currentRequest.interaction(),
        SnippetAssetEnableStatus.builder().taskId(batchId).build());
   ...
   */
  @Transactional
  @ApiObserved("Api to enable an entity of snippet asset")
  public Response snippetAssetApiEnable(final String uid) {
    Trace.setAttribute("ref", uid);
    SnippetAssetEnableProjection updated =
        enable.enable(currentRequest.interaction(), SnippetAssetReference.of(uid));
   ...
   * @return
   */
  private SnippetAssetApiDto toApiModel(SnippetAssetEnableProjection dto) {
