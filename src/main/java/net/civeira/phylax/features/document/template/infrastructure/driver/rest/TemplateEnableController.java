...
import net.civeira.phylax.features.document.template.application.usecase.enable.TemplateEnableFilter;
import net.civeira.phylax.features.document.template.application.usecase.enable.TemplateEnableProjection;
import net.civeira.phylax.features.document.template.application.usecase.enable.TemplateEnableStatus;
...
@ApplicationScoped
public class TemplateEnableController {
   ...
   * @return
   */
  @ApiObserved("Api to enable on massive entity of template")
  public Response templateApiBatchEnable(final List<String> uids, final String search,
    ...
    TemplateEnableFilter.TemplateEnableFilterBuilder filterBuilder = TemplateEnableFilter.builder();
    filterBuilder =
    ...
    TemplateEnableFilter filter = filterBuilder.build();
   ...
   * @return
   */
  @ApiObserved("Api to check masive enable on entity of template")
  public Response templateApiBatchEnableQuery(final String batchId) {
    BatchProgress task = enable.checkProgress(currentRequest.interaction(),
        TemplateEnableStatus.builder().taskId(batchId).build());
   ...
   */
  @Transactional
  @ApiObserved("Api to enable an entity of template")
  public Response templateApiEnable(final String uid) {
    Trace.setAttribute("ref", uid);
    TemplateEnableProjection updated =
        enable.enable(currentRequest.interaction(), TemplateReference.of(uid));
   ...
   * @return
   */
  private TemplateApiDto toApiModel(TemplateEnableProjection dto) {
