...
@Getter
public class TemplateVariableEnableProjection {
   ...
   * @return
   */
  public static TemplateVariableEnableProjection from(
      final TemplateVariableVisibleProjection visible) {
    TemplateVariableEnableProjection instance = new TemplateVariableEnableProjection();
   ...
   */
  public TemplateVariableEnableProjection(final TemplateVariable entity) {
