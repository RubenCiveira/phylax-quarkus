...
import net.civeira.phylax.features.document.templatesnippet.application.usecase.enable.TemplateSnippetEnableFilter;
import net.civeira.phylax.features.document.templatesnippet.application.usecase.enable.TemplateSnippetEnableProjection;
import net.civeira.phylax.features.document.templatesnippet.application.usecase.enable.TemplateSnippetEnableStatus;
...
@ApplicationScoped
public class TemplateSnippetEnableController {
   ...
   * @return
   */
  @ApiObserved("Api to enable on massive entity of template snippet")
  public Response templateSnippetApiBatchEnable(final List<String> uids, final String search,
    ...
    TemplateSnippetEnableFilter.TemplateSnippetEnableFilterBuilder filterBuilder =
        TemplateSnippetEnableFilter.builder();
    filterBuilder =
    ...
    TemplateSnippetEnableFilter filter = filterBuilder.build();
   ...
   * @return
   */
  @ApiObserved("Api to check masive enable on entity of template snippet")
  public Response templateSnippetApiBatchEnableQuery(final String batchId) {
    BatchProgress task = enable.checkProgress(currentRequest.interaction(),
        TemplateSnippetEnableStatus.builder().taskId(batchId).build());
   ...
   */
  @Transactional
  @ApiObserved("Api to enable an entity of template snippet")
  public Response templateSnippetApiEnable(final String uid) {
    Trace.setAttribute("ref", uid);
    TemplateSnippetEnableProjection updated =
        enable.enable(currentRequest.interaction(), TemplateSnippetReference.of(uid));
   ...
   * @return
   */
  private TemplateSnippetApiDto toApiModel(TemplateSnippetEnableProjection dto) {
