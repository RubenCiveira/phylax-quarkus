...
public class TemplateSnippetRbacRegister {
  ...
  void registerResource(@Observes @Priority(10) final StartupEvent ev) {
    ...
    rbac.registerResourceField(RESOURCE,
        FieldDescription.builder().name("uid").description("El uid de template snippet").build());
    rbac.registerResourceField(RESOURCE,
        FieldDescription.builder().name("code").description("HEADER, FOOTER...").build());
    rbac.registerResourceField(RESOURCE, FieldDescription.builder().name("tenant")
        .description("El tenant de template snippet").build());
    rbac.registerResourceField(RESOURCE, FieldDescription.builder().name("contentHtml")
        .description("El content html de template snippet").build());
    rbac.registerResourceField(RESOURCE, FieldDescription.builder().name("enabled")
        .description("El enabled de template snippet").build());
    rbac.registerResourceField(RESOURCE,
