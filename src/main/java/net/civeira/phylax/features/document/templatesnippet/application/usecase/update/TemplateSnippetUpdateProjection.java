...
@Getter
public class TemplateSnippetUpdateProjection {
   ...
   * @return
   */
  public static TemplateSnippetUpdateProjection from(
      final TemplateSnippetVisibleProjection visible) {
    TemplateSnippetUpdateProjection instance = new TemplateSnippetUpdateProjection();
   ...
   */
  public TemplateSnippetUpdateProjection(final TemplateSnippet entity) {
