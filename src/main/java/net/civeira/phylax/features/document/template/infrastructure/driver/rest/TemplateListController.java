...
public class TemplateListController {
  ...
  public Response templateApiList(final List<String> uids, final String search, final String code,
      final String tenant, final List<String> tenants, final String theme,
      final List<String> themes, final Integer limit, final String sinceUid, final String sinceCode,
      final String order) {
