...
@Getter
public class TemplateSnippetRetrieveProjection {
   ...
   * @return
   */
  public static TemplateSnippetRetrieveProjection from(
      final TemplateSnippetVisibleProjection visible) {
    TemplateSnippetRetrieveProjection instance = new TemplateSnippetRetrieveProjection();
   ...
   */
  public TemplateSnippetRetrieveProjection(final TemplateSnippet entity) {
