...
@Getter
public class ThemeDisableProjection {
   ...
   * @return
   */
  public static ThemeDisableProjection from(final ThemeVisibleProjection visible) {
    ThemeDisableProjection instance = new ThemeDisableProjection();
   ...
   */
  public ThemeDisableProjection(final Theme entity) {
