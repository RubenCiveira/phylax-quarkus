...
@Getter
public class TemplateVariableListProjection {
   ...
   * @return
   */
  public static TemplateVariableListProjection from(
      final TemplateVariableVisibleProjection visible) {
    TemplateVariableListProjection instance = new TemplateVariableListProjection();
   ...
   */
  public TemplateVariableListProjection(final TemplateVariable entity) {
