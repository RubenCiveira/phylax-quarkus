...
public class SnippetAssetRbacRegister {

  /**
   * @autogenerated RegisterGeneratorGenerator
   */
  private static final ResourceDescription RESOURCE =
      ResourceDescription.builder().name("snippet-asset").description("snippet-asset").build();
  ...
  void registerResource(@Observes @Priority(10) final StartupEvent ev) {
    ...
    rbac.registerResourceAction(RESOURCE,
        ScopeDescription.builder().kind(Kind.READ).name("retrieve-upload-content")
            .description("El content de snippet asset").required(List.of()).build());
    rbac.registerResourceAction(RESOURCE,
        ScopeDescription.builder().kind(Kind.WRITE).name("temp-upload-content")
            .description("El content de snippet asset").required(List.of()).build());
    rbac.registerResourceField(RESOURCE,
        FieldDescription.builder().name("uid").description("El uid de snippet asset").build());
    rbac.registerResourceField(RESOURCE, FieldDescription.builder().name("snippet")
        .description("El snippet de snippet asset").build());
    rbac.registerResourceField(RESOURCE,
        FieldDescription.builder().name("code").description("icon, separator...").build());
    rbac.registerResourceField(RESOURCE,
    ...
    rbac.registerResourceField(RESOURCE, FieldDescription.builder().name("content")
        .description("El content de snippet asset").build());
    rbac.registerResourceField(RESOURCE, FieldDescription.builder().name("enabled")
        .description("El enabled de snippet asset").build());
    rbac.registerResourceField(RESOURCE,
