...
import net.civeira.phylax.features.document.snippet.application.usecase.disable.SnippetDisableFilter;
import net.civeira.phylax.features.document.snippet.application.usecase.disable.SnippetDisableProjection;
import net.civeira.phylax.features.document.snippet.application.usecase.disable.SnippetDisableStatus;
...
@ApplicationScoped
public class SnippetDisableController {
   ...
   * @return
   */
  @ApiObserved("Api to disable on massive entity of snippet")
  public Response snippetApiBatchDisable(final List<String> uids, final String search,
    ...
    SnippetDisableFilter.SnippetDisableFilterBuilder filterBuilder = SnippetDisableFilter.builder();
    filterBuilder =
    ...
    SnippetDisableFilter filter = filterBuilder.build();
   ...
   * @return
   */
  @ApiObserved("Api to check masive disable on entity of snippet")
  public Response snippetApiBatchDisableQuery(final String batchId) {
    BatchProgress task = disable.checkProgress(currentRequest.interaction(),
        SnippetDisableStatus.builder().taskId(batchId).build());
   ...
   */
  @Transactional
  @ApiObserved("Api to disable an entity of snippet")
  public Response snippetApiDisable(final String uid) {
    Trace.setAttribute("ref", uid);
    SnippetDisableProjection updated =
        disable.disable(currentRequest.interaction(), SnippetReference.of(uid));
   ...
   * @return
   */
  private SnippetApiDto toApiModel(SnippetDisableProjection dto) {
