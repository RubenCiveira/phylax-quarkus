...
@Getter
public class SnippetDisableProjection {
   ...
   * @return
   */
  public static SnippetDisableProjection from(final SnippetVisibleProjection visible) {
    SnippetDisableProjection instance = new SnippetDisableProjection();
   ...
   */
  public SnippetDisableProjection(final Snippet entity) {
