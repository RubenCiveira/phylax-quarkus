...
import net.civeira.phylax.features.document.snippetasset.application.usecase.delete.SnippetAssetCheckBatchDeleteStatus;
import net.civeira.phylax.features.document.snippetasset.application.usecase.delete.SnippetAssetDeleteFilter;
...
@ApplicationScoped
public class SnippetAssetDeleteController {
   ...
   * @return
   */
  @ApiObserved("Api to delete on massive entity of snippet asset")
  public Response snippetAssetApiBatchDelete(final List<String> uids, final String search,
    ...
    SnippetAssetDeleteFilter.SnippetAssetDeleteFilterBuilder filterBuilder =
        SnippetAssetDeleteFilter.builder();
    filterBuilder =
    ...
    SnippetAssetDeleteFilter filter = filterBuilder.build();
   ...
   * @return
   */
  @ApiObserved("Api to check masive delete on entity of snippet asset")
  public Response snippetAssetApiBatchDeleteQuery(final String batchId) {
    BatchProgress task = delete.checkProgress(currentRequest.interaction(),
        SnippetAssetCheckBatchDeleteStatus.builder().taskId(batchId).build());
   ...
   */
  @Transactional
  @ApiObserved("Api to delete an entity of snippet asset")
  public Response snippetAssetApiDelete(final String uid) {
    Trace.setAttribute("ref", uid);
    delete.delete(currentRequest.interaction(), SnippetAssetReference.of(uid));
