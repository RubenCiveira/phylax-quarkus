...
import net.civeira.phylax.features.document.templatevariable.application.usecase.disable.TemplateVariableDisableFilter;
import net.civeira.phylax.features.document.templatevariable.application.usecase.disable.TemplateVariableDisableProjection;
import net.civeira.phylax.features.document.templatevariable.application.usecase.disable.TemplateVariableDisableStatus;
...
@ApplicationScoped
public class TemplateVariableDisableController {
   ...
   * @return
   */
  @ApiObserved("Api to disable on massive entity of template variable")
  public Response templateVariableApiBatchDisable(final List<String> uids, final String search,
    ...
    TemplateVariableDisableFilter.TemplateVariableDisableFilterBuilder filterBuilder =
        TemplateVariableDisableFilter.builder();
    filterBuilder =
    ...
    TemplateVariableDisableFilter filter = filterBuilder.build();
   ...
   * @return
   */
  @ApiObserved("Api to check masive disable on entity of template variable")
  public Response templateVariableApiBatchDisableQuery(final String batchId) {
    BatchProgress task = disable.checkProgress(currentRequest.interaction(),
        TemplateVariableDisableStatus.builder().taskId(batchId).build());
   ...
   */
  @Transactional
  @ApiObserved("Api to disable an entity of template variable")
  public Response templateVariableApiDisable(final String uid) {
    Trace.setAttribute("ref", uid);
    TemplateVariableDisableProjection updated =
        disable.disable(currentRequest.interaction(), TemplateVariableReference.of(uid));
   ...
   * @return
   */
  private TemplateVariableApiDto toApiModel(TemplateVariableDisableProjection dto) {
