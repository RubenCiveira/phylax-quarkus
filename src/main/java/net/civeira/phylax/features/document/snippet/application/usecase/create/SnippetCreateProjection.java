...
@Getter
public class SnippetCreateProjection {
   ...
   * @return
   */
  public static SnippetCreateProjection from(final SnippetVisibleProjection visible) {
    SnippetCreateProjection instance = new SnippetCreateProjection();
   ...
   */
  public SnippetCreateProjection(final Snippet entity) {
