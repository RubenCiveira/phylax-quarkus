...
@ApplicationScoped
public class TemplateAssetDeleteController {
  ...
  public Response templateAssetApiBatchDelete(final List<String> uids, final String search,
    ...
    TemplateAssetDeleteFilter filter = filterBuilder.build();
   ...
   * @return
   */
  @ApiObserved("Api to check masive delete on entity of template asset")
  public Response templateAssetApiBatchDeleteQuery(final String batchId) {
    BatchProgress task = delete.checkProgress(currentRequest.interaction(),
        TemplateAssetCheckBatchDeleteStatus.builder().taskId(batchId).build());
   ...
   */
  @Transactional
  @ApiObserved("Api to delete an entity of template asset")
  public Response templateAssetApiDelete(final String uid) {
    Trace.setAttribute("ref", uid);
    delete.delete(currentRequest.interaction(), TemplateAssetReference.of(uid));
