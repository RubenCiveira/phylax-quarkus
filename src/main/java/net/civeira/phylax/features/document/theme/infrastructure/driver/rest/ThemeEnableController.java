...
import net.civeira.phylax.features.document.theme.application.usecase.enable.ThemeEnableFilter;
import net.civeira.phylax.features.document.theme.application.usecase.enable.ThemeEnableProjection;
import net.civeira.phylax.features.document.theme.application.usecase.enable.ThemeEnableStatus;
...
@ApplicationScoped
public class ThemeEnableController {
   ...
   * @return
   */
  @ApiObserved("Api to enable on massive entity of theme")
  public Response themeApiBatchEnable(final List<String> uids, final String search,
    ...
    ThemeEnableFilter.ThemeEnableFilterBuilder filterBuilder = ThemeEnableFilter.builder();
    filterBuilder =
    ...
    ThemeEnableFilter filter = filterBuilder.build();
   ...
   * @return
   */
  @ApiObserved("Api to check masive enable on entity of theme")
  public Response themeApiBatchEnableQuery(final String batchId) {
    BatchProgress task = enable.checkProgress(currentRequest.interaction(),
        ThemeEnableStatus.builder().taskId(batchId).build());
   ...
   */
  @Transactional
  @ApiObserved("Api to enable an entity of theme")
  public Response themeApiEnable(final String uid) {
    Trace.setAttribute("ref", uid);
    ThemeEnableProjection updated =
        enable.enable(currentRequest.interaction(), ThemeReference.of(uid));
   ...
   * @return
   */
  private ThemeApiDto toApiModel(ThemeEnableProjection dto) {
