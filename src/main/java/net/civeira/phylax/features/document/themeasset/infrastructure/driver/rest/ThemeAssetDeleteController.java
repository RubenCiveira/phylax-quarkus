...
import net.civeira.phylax.features.document.themeasset.application.usecase.delete.ThemeAssetCheckBatchDeleteStatus;
import net.civeira.phylax.features.document.themeasset.application.usecase.delete.ThemeAssetDeleteFilter;
...
@ApplicationScoped
public class ThemeAssetDeleteController {
   ...
   * @return
   */
  @ApiObserved("Api to delete on massive entity of theme asset")
  public Response themeAssetApiBatchDelete(final List<String> uids, final String search,
    ...
    ThemeAssetDeleteFilter.ThemeAssetDeleteFilterBuilder filterBuilder =
        ThemeAssetDeleteFilter.builder();
    filterBuilder =
    ...
    ThemeAssetDeleteFilter filter = filterBuilder.build();
   ...
   * @return
   */
  @ApiObserved("Api to check masive delete on entity of theme asset")
  public Response themeAssetApiBatchDeleteQuery(final String batchId) {
    BatchProgress task = delete.checkProgress(currentRequest.interaction(),
        ThemeAssetCheckBatchDeleteStatus.builder().taskId(batchId).build());
   ...
   */
  @Transactional
  @ApiObserved("Api to delete an entity of theme asset")
  public Response themeAssetApiDelete(final String uid) {
    Trace.setAttribute("ref", uid);
    delete.delete(currentRequest.interaction(), ThemeAssetReference.of(uid));
