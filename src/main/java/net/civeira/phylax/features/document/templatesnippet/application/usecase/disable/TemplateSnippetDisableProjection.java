...
@Getter
public class TemplateSnippetDisableProjection {
   ...
   * @return
   */
  public static TemplateSnippetDisableProjection from(
      final TemplateSnippetVisibleProjection visible) {
    TemplateSnippetDisableProjection instance = new TemplateSnippetDisableProjection();
   ...
   */
  public TemplateSnippetDisableProjection(final TemplateSnippet entity) {
