...
import net.civeira.phylax.features.document.snippetversion.application.usecase.delete.SnippetVersionCheckBatchDeleteStatus;
import net.civeira.phylax.features.document.snippetversion.application.usecase.delete.SnippetVersionDeleteFilter;
...
@ApplicationScoped
public class SnippetVersionDeleteController {
   ...
   * @return
   */
  @ApiObserved("Api to delete on massive entity of snippet version")
  public Response snippetVersionApiBatchDelete(final List<String> uids, final String search,
    ...
    SnippetVersionDeleteFilter.SnippetVersionDeleteFilterBuilder filterBuilder =
        SnippetVersionDeleteFilter.builder();
    filterBuilder =
    ...
    SnippetVersionDeleteFilter filter = filterBuilder.build();
   ...
   * @return
   */
  @ApiObserved("Api to check masive delete on entity of snippet version")
  public Response snippetVersionApiBatchDeleteQuery(final String batchId) {
    BatchProgress task = delete.checkProgress(currentRequest.interaction(),
        SnippetVersionCheckBatchDeleteStatus.builder().taskId(batchId).build());
   ...
   */
  @Transactional
  @ApiObserved("Api to delete an entity of snippet version")
  public Response snippetVersionApiDelete(final String uid) {
    Trace.setAttribute("ref", uid);
    delete.delete(currentRequest.interaction(), SnippetVersionReference.of(uid));
