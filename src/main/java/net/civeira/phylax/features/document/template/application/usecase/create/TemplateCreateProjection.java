...
@Getter
public class TemplateCreateProjection {
   ...
   * @return
   */
  public static TemplateCreateProjection from(final TemplateVisibleProjection visible) {
    TemplateCreateProjection instance = new TemplateCreateProjection();
   ...
   */
  public TemplateCreateProjection(final Template entity) {
