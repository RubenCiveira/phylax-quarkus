...
@Getter
public class ThemeEnableProjection {
   ...
   * @return
   */
  public static ThemeEnableProjection from(final ThemeVisibleProjection visible) {
    ThemeEnableProjection instance = new ThemeEnableProjection();
   ...
   */
  public ThemeEnableProjection(final Theme entity) {
