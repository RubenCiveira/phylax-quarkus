...
import net.civeira.phylax.features.document.templateasset.application.usecase.disable.TemplateAssetDisableFilter;
import net.civeira.phylax.features.document.templateasset.application.usecase.disable.TemplateAssetDisableProjection;
import net.civeira.phylax.features.document.templateasset.application.usecase.disable.TemplateAssetDisableStatus;
...
@ApplicationScoped
public class TemplateAssetDisableController {
   ...
   * @return
   */
  @ApiObserved("Api to disable on massive entity of template asset")
  public Response templateAssetApiBatchDisable(final List<String> uids, final String search,
    ...
    TemplateAssetDisableFilter.TemplateAssetDisableFilterBuilder filterBuilder =
        TemplateAssetDisableFilter.builder();
    filterBuilder =
    ...
    TemplateAssetDisableFilter filter = filterBuilder.build();
   ...
   * @return
   */
  @ApiObserved("Api to check masive disable on entity of template asset")
  public Response templateAssetApiBatchDisableQuery(final String batchId) {
    BatchProgress task = disable.checkProgress(currentRequest.interaction(),
        TemplateAssetDisableStatus.builder().taskId(batchId).build());
   ...
   */
  @Transactional
  @ApiObserved("Api to disable an entity of template asset")
  public Response templateAssetApiDisable(final String uid) {
    Trace.setAttribute("ref", uid);
    TemplateAssetDisableProjection updated =
        disable.disable(currentRequest.interaction(), TemplateAssetReference.of(uid));
   ...
   * @return
   */
  private TemplateAssetApiDto toApiModel(TemplateAssetDisableProjection dto) {
