...
import net.civeira.phylax.features.document.templatesnippet.application.usecase.disable.TemplateSnippetDisableFilter;
import net.civeira.phylax.features.document.templatesnippet.application.usecase.disable.TemplateSnippetDisableProjection;
import net.civeira.phylax.features.document.templatesnippet.application.usecase.disable.TemplateSnippetDisableStatus;
...
@ApplicationScoped
public class TemplateSnippetDisableController {
   ...
   * @return
   */
  @ApiObserved("Api to disable on massive entity of template snippet")
  public Response templateSnippetApiBatchDisable(final List<String> uids, final String search,
    ...
    TemplateSnippetDisableFilter.TemplateSnippetDisableFilterBuilder filterBuilder =
        TemplateSnippetDisableFilter.builder();
    filterBuilder =
    ...
    TemplateSnippetDisableFilter filter = filterBuilder.build();
   ...
   * @return
   */
  @ApiObserved("Api to check masive disable on entity of template snippet")
  public Response templateSnippetApiBatchDisableQuery(final String batchId) {
    BatchProgress task = disable.checkProgress(currentRequest.interaction(),
        TemplateSnippetDisableStatus.builder().taskId(batchId).build());
   ...
   */
  @Transactional
  @ApiObserved("Api to disable an entity of template snippet")
  public Response templateSnippetApiDisable(final String uid) {
    Trace.setAttribute("ref", uid);
    TemplateSnippetDisableProjection updated =
        disable.disable(currentRequest.interaction(), TemplateSnippetReference.of(uid));
   ...
   * @return
   */
  private TemplateSnippetApiDto toApiModel(TemplateSnippetDisableProjection dto) {
