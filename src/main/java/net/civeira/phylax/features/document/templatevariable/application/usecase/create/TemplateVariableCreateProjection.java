...
@Getter
public class TemplateVariableCreateProjection {
   ...
   * @return
   */
  public static TemplateVariableCreateProjection from(
      final TemplateVariableVisibleProjection visible) {
    TemplateVariableCreateProjection instance = new TemplateVariableCreateProjection();
   ...
   */
  public TemplateVariableCreateProjection(final TemplateVariable entity) {
