...
@Getter
public class SnippetRetrieveProjection {
   ...
   * @return
   */
  public static SnippetRetrieveProjection from(final SnippetVisibleProjection visible) {
    SnippetRetrieveProjection instance = new SnippetRetrieveProjection();
   ...
   */
  public SnippetRetrieveProjection(final Snippet entity) {
