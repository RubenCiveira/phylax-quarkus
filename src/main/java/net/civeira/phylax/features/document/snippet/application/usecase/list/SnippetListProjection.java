...
@Getter
public class SnippetListProjection {
   ...
   * @return
   */
  public static SnippetListProjection from(final SnippetVisibleProjection visible) {
    SnippetListProjection instance = new SnippetListProjection();
   ...
   */
  public SnippetListProjection(final Snippet entity) {
