...
@Getter
public class TemplateEnableProjection {
   ...
   * @return
   */
  public static TemplateEnableProjection from(final TemplateVisibleProjection visible) {
    TemplateEnableProjection instance = new TemplateEnableProjection();
   ...
   */
  public TemplateEnableProjection(final Template entity) {
