...
import net.civeira.phylax.features.document.templatevariable.application.usecase.delete.TemplateVariableCheckBatchDeleteStatus;
import net.civeira.phylax.features.document.templatevariable.application.usecase.delete.TemplateVariableDeleteFilter;
...
@ApplicationScoped
public class TemplateVariableDeleteController {
   ...
   * @return
   */
  @ApiObserved("Api to delete on massive entity of template variable")
  public Response templateVariableApiBatchDelete(final List<String> uids, final String search,
    ...
    TemplateVariableDeleteFilter.TemplateVariableDeleteFilterBuilder filterBuilder =
        TemplateVariableDeleteFilter.builder();
    filterBuilder =
    ...
    TemplateVariableDeleteFilter filter = filterBuilder.build();
   ...
   * @return
   */
  @ApiObserved("Api to check masive delete on entity of template variable")
  public Response templateVariableApiBatchDeleteQuery(final String batchId) {
    BatchProgress task = delete.checkProgress(currentRequest.interaction(),
        TemplateVariableCheckBatchDeleteStatus.builder().taskId(batchId).build());
   ...
   */
  @Transactional
  @ApiObserved("Api to delete an entity of template variable")
  public Response templateVariableApiDelete(final String uid) {
    Trace.setAttribute("ref", uid);
    delete.delete(currentRequest.interaction(), TemplateVariableReference.of(uid));
