...
@Getter
public class TemplateRetrieveProjection {
   ...
   * @return
   */
  public static TemplateRetrieveProjection from(final TemplateVisibleProjection visible) {
    TemplateRetrieveProjection instance = new TemplateRetrieveProjection();
   ...
   */
  public TemplateRetrieveProjection(final Template entity) {
