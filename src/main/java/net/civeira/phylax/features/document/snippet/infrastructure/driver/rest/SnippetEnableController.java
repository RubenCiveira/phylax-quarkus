...
import net.civeira.phylax.features.document.snippet.application.usecase.enable.SnippetEnableFilter;
import net.civeira.phylax.features.document.snippet.application.usecase.enable.SnippetEnableProjection;
import net.civeira.phylax.features.document.snippet.application.usecase.enable.SnippetEnableStatus;
...
@ApplicationScoped
public class SnippetEnableController {
   ...
   * @return
   */
  @ApiObserved("Api to enable on massive entity of snippet")
  public Response snippetApiBatchEnable(final List<String> uids, final String search,
    ...
    SnippetEnableFilter.SnippetEnableFilterBuilder filterBuilder = SnippetEnableFilter.builder();
    filterBuilder =
    ...
    SnippetEnableFilter filter = filterBuilder.build();
   ...
   * @return
   */
  @ApiObserved("Api to check masive enable on entity of snippet")
  public Response snippetApiBatchEnableQuery(final String batchId) {
    BatchProgress task = enable.checkProgress(currentRequest.interaction(),
        SnippetEnableStatus.builder().taskId(batchId).build());
   ...
   */
  @Transactional
  @ApiObserved("Api to enable an entity of snippet")
  public Response snippetApiEnable(final String uid) {
    Trace.setAttribute("ref", uid);
    SnippetEnableProjection updated =
        enable.enable(currentRequest.interaction(), SnippetReference.of(uid));
   ...
   * @return
   */
  private SnippetApiDto toApiModel(SnippetEnableProjection dto) {
