...
import net.civeira.phylax.features.document.templateversion.application.usecase.delete.TemplateVersionCheckBatchDeleteStatus;
import net.civeira.phylax.features.document.templateversion.application.usecase.delete.TemplateVersionDeleteFilter;
...
@ApplicationScoped
public class TemplateVersionDeleteController {
   ...
   * @return
   */
  @ApiObserved("Api to delete on massive entity of template version")
  public Response templateVersionApiBatchDelete(final List<String> uids, final String search,
    ...
    TemplateVersionDeleteFilter.TemplateVersionDeleteFilterBuilder filterBuilder =
        TemplateVersionDeleteFilter.builder();
    filterBuilder =
    ...
    TemplateVersionDeleteFilter filter = filterBuilder.build();
   ...
   * @return
   */
  @ApiObserved("Api to check masive delete on entity of template version")
  public Response templateVersionApiBatchDeleteQuery(final String batchId) {
    BatchProgress task = delete.checkProgress(currentRequest.interaction(),
        TemplateVersionCheckBatchDeleteStatus.builder().taskId(batchId).build());
   ...
   */
  @Transactional
  @ApiObserved("Api to delete an entity of template version")
  public Response templateVersionApiDelete(final String uid) {
    Trace.setAttribute("ref", uid);
    delete.delete(currentRequest.interaction(), TemplateVersionReference.of(uid));
