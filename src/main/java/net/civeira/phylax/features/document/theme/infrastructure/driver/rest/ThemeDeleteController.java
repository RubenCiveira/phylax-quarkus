...
import net.civeira.phylax.features.document.theme.application.usecase.delete.ThemeCheckBatchDeleteStatus;
import net.civeira.phylax.features.document.theme.application.usecase.delete.ThemeDeleteFilter;
...
public class ThemeDeleteController {
   ...
   * @return
   */
  @ApiObserved("Api to delete on massive entity of theme")
  public Response themeApiBatchDelete(final List<String> uids, final String search,
    ...
    ThemeDeleteFilter.ThemeDeleteFilterBuilder filterBuilder = ThemeDeleteFilter.builder();
    filterBuilder =
    ...
    ThemeDeleteFilter filter = filterBuilder.build();
   ...
   * @return
   */
  @ApiObserved("Api to check masive delete on entity of theme")
  public Response themeApiBatchDeleteQuery(final String batchId) {
    BatchProgress task = delete.checkProgress(currentRequest.interaction(),
        ThemeCheckBatchDeleteStatus.builder().taskId(batchId).build());
   ...
   */
  @Transactional
  @ApiObserved("Api to delete an entity of theme")
  public Response themeApiDelete(final String uid) {
    Trace.setAttribute("ref", uid);
    delete.delete(currentRequest.interaction(), ThemeReference.of(uid));
