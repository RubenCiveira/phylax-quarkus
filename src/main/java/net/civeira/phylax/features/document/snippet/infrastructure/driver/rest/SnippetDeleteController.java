...
import net.civeira.phylax.features.document.snippet.application.usecase.delete.SnippetCheckBatchDeleteStatus;
import net.civeira.phylax.features.document.snippet.application.usecase.delete.SnippetDeleteFilter;
...
@ApplicationScoped
public class SnippetDeleteController {
   ...
   * @return
   */
  @ApiObserved("Api to delete on massive entity of snippet")
  public Response snippetApiBatchDelete(final List<String> uids, final String search,
    ...
    SnippetDeleteFilter.SnippetDeleteFilterBuilder filterBuilder = SnippetDeleteFilter.builder();
    filterBuilder =
    ...
    SnippetDeleteFilter filter = filterBuilder.build();
   ...
   * @return
   */
  @ApiObserved("Api to check masive delete on entity of snippet")
  public Response snippetApiBatchDeleteQuery(final String batchId) {
    BatchProgress task = delete.checkProgress(currentRequest.interaction(),
        SnippetCheckBatchDeleteStatus.builder().taskId(batchId).build());
   ...
   */
  @Transactional
  @ApiObserved("Api to delete an entity of snippet")
  public Response snippetApiDelete(final String uid) {
    Trace.setAttribute("ref", uid);
    delete.delete(currentRequest.interaction(), SnippetReference.of(uid));
