...
import net.civeira.phylax.features.document.templatesnippet.application.usecase.delete.TemplateSnippetCheckBatchDeleteStatus;
import net.civeira.phylax.features.document.templatesnippet.application.usecase.delete.TemplateSnippetDeleteFilter;
...
@ApplicationScoped
public class TemplateSnippetDeleteController {
   ...
   * @return
   */
  @ApiObserved("Api to delete on massive entity of template snippet")
  public Response templateSnippetApiBatchDelete(final List<String> uids, final String search,
    ...
    TemplateSnippetDeleteFilter.TemplateSnippetDeleteFilterBuilder filterBuilder =
        TemplateSnippetDeleteFilter.builder();
    filterBuilder =
    ...
    TemplateSnippetDeleteFilter filter = filterBuilder.build();
   ...
   * @return
   */
  @ApiObserved("Api to check masive delete on entity of template snippet")
  public Response templateSnippetApiBatchDeleteQuery(final String batchId) {
    BatchProgress task = delete.checkProgress(currentRequest.interaction(),
        TemplateSnippetCheckBatchDeleteStatus.builder().taskId(batchId).build());
   ...
   */
  @Transactional
  @ApiObserved("Api to delete an entity of template snippet")
  public Response templateSnippetApiDelete(final String uid) {
    Trace.setAttribute("ref", uid);
    delete.delete(currentRequest.interaction(), TemplateSnippetReference.of(uid));
