...
public final class SqlSchematicQuery<T> extends AbstractSqlQuery<T, SqlSchematicQuery<T>> {
  ...
  /* default */ SqlSchematicQuery(SqlTemplate template, String table) {
    super(template);
    this.query = new SchematicQuery(template, "SELECT", table, this);
  }
  ...
  public SqlResult<T> query(SqlConverter<T> converter) {
    String sql = this.query.buildQuery();
    log.info("QUERY:" + sql);
  ...
  public SqlSchematicQuery<T> forUpdate() {
    this.query.forUpdate();
    return this;
  }

  public SqlSchematicQuery<T> forQuery() {
    this.query.forQuery();
    return this;
  }
